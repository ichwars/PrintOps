export default {
  ...
  printers: {
    ...
    camWall: {
      ...
      page: {
        tokenRejected: 'Dieses Kamera-Wand-Token wurde abgelehnt oder ist abgelaufen.',
        loadFailed: 'Kamera-Wand konnte nicht geladen werden.',
      },
    },
    // Controls
    ...
    expectedSlot: {
      ...
      label: '{{ams}} · Fach {{slot}}',
      title: 'Der pausierte Druck erwartet hier Filament',
      ariaLabel: 'Erwarteter Ersatz-Slot {{n}}',
    },
    // Filaments section
    filaments: 'Filamente',
    // Camera
    ...
    localControlUnavailable: 'Lokale Steuerung nicht verfügbar. Bitte Entwickler-LAN-Modus am Drucker aktivieren und IP-Adresse sowie Zugangscode prüfen.',
    localControlBadge: 'LAN-Steuerung aus',
    localControlBadgeTitle: 'Lokale Druckersteuerung ist deaktiviert. PrintOps zeigt Statusdaten, sperrt aber lokale Steuerbefehle.',
    localControlUnavailableCloudCandidate: '{{action}} wird bei fehlender LAN-Steuerung über Bambu Cloud gesendet.',
    localControlUnavailableCloudNotImplemented: '{{action}} ist über Bambu Cloud grundsätzlich möglich, ist in PrintOps aber noch nicht als Cloud-Steuerung umgesetzt. Bitte Entwickler-LAN-Modus am Drucker aktivieren.',
    localControlUnavailableCloudUncertain: '{{action}} benötigt in PrintOps aktuell lokale Steuerung. Cloud-Unterstützung ist für diese Funktion noch nicht belastbar bestätigt.',
    localControlUnavailableLocalOnly: '{{action}} benötigt lokale Steuerung. Bitte Entwickler-LAN-Modus am Drucker aktivieren und IP-Adresse sowie Zugangscode prüfen.',
    cloudControlActionTitle: '{{action}} wird über Bambu Cloud gesendet, weil die lokale LAN-Steuerung nicht verfügbar ist.',
    cloudControlConfigured: 'Cloud bereit',
    cloudControlConfiguredTitle: 'Bambu Cloud ist konfiguriert und kann für unterstützte Fallback-Aktionen genutzt werden.',
    controlPathTitle: 'Aktiver Steuerweg: {{path}}',
    controlPath: {
      local: 'Lokal',
      cloud: 'Cloud',
      none: 'keine Steuerung',
    },
    controlMatrix: {
      title: 'Steuerwege',
      toggle: 'Steuerwege anzeigen',
      action: 'Aktion',
      local: 'LAN',
      cloud: 'Cloud',
      printops: 'PrintOps',
      ...
      cloudNotImplemented: 'Cloud möglich, PrintOps lokal',
      localOnly: 'nur LAN',
      available: 'möglich',
      uncertain: 'unklar',
    },
    controlCapabilities: {
      ...
      temperature: 'Temperatursteuerung',
      fan: 'Lüftersteuerung',
      light: 'Lichtsteuerung',
      camera: 'Kamera',
      fileManagement: 'Dateiverwaltung',
      amsSlot: 'AMS Slot-Steuerung',
    },
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedNotice: 'Von den {{owed}} noch offenen Durchläufen lassen sich {{runs}} nicht einreihen: Für diese Platte gibt es keinen Durchlauf mehr, von dem sich die Einstellungen kopieren lassen. Reihe die Platte einmal aus der Datei ein oder brich den Batch ab.',
    ...
    cancelBatchConfirmMessage: 'Diesen Batch schließen? Noch eingereihte Durchläufe werden abgebrochen; offene, nicht produzierte Mengen werden verworfen.',
    batch: {
      defaultName: 'Stapel',
      label: '{{count}} Eintrag',
    ...
    toast: {
      ...
      keptForOrder: 'Nicht entfernt: „{{name}}“ braucht diesen Lauf als einzige wiederverwendbare Vorlage für die Platte',
      historyKeptForOrders: '{{kept}} Vorlagen behalten, die offene Batches noch brauchen.',
  ...
  stats: {
    ...
    energySource: {
      smartPlugLive: 'Live-Zähler der Steckdosen',
      smartPlugSnapshots: 'Steckdosen-Snapshots',
      printLogs: 'Druckprotokolle',
    },
  ...
  settings: {
    ...
    tabs: {
      ...
      orderManagementFormatPreview: 'Format & Vorschau',
      filament: 'Filament',
      network: 'Netzwerk',
    ...
    orderManagementSubTabDescriptions: {
      formatPreview: 'Versionierte PDF-Layouts gestalten, echte Vorschauen prüfen und die Freigabebereitschaft steuern.',
    ...
    documentLayout: {
      title: 'Format & Vorschau',
      description: 'Versionierte PDF-Layouts gestalten, echte Dokumente prüfen und nur validierte Konfigurationen freigeben.',
      loadingDescription: 'Der Layout-Arbeitsbereich lädt Katalog, Berechtigungen und Dokumentkontext.',
      context: {
        title: 'Layoutkontext', profile: 'Unternehmensprofil', scope: 'Geltungsbereich', profileDefault: 'Profilstandard',
        documentType: 'Dokumenttyp', language: 'Sprache', version: 'Version', sample: 'Vorschauquelle',
        sampleData: 'Beispieldaten', realDocument: 'Echtes Dokument', realDocumentHint: 'Es wird ausschließlich die Dokument-ID übertragen; jede Vorschau wird protokolliert.',
      },
      access: {
        readOnly: 'Nur Lesezugriff', readOnlyHint: 'Layouts und Vorschauen können geprüft werden. Änderungen und Freigaben sind Administratoren vorbehalten.',
        unavailable: 'Die Layouteinstellungen sind ohne Leseberechtigung nicht verfügbar.',
      },
      statuses: {
        draft: 'Entwurf', scheduled: 'Geplant', active: 'Aktiv', superseded: 'Abgelöst', withdrawn: 'Zurückgezogen',
        saved: 'Gespeichert', saving: 'Wird gespeichert...', pending: 'Änderungen ausstehend', failed: 'Speichern fehlgeschlagen',
        ready: 'Bereit', warnings: 'Warnungen', blocked: 'Blockiert', checking: 'Wird geprüft',
      },
      actions: {
        retry: 'Erneut versuchen', refresh: 'Aktualisieren', download: 'Herunterladen', clone: 'Layout klonen', publish: 'Freigeben',
        schedule: 'Freigabe planen', withdraw: 'Freigabe zurückziehen', history: 'Verlauf', close: 'Schließen',
        save: 'Speichern', cancel: 'Abbrechen', confirm: 'Bestätigen', removeOverride: 'Überschreibung entfernen',
        upload: 'Asset hochladen', replace: 'Ersetzen', delete: 'Löschen', previousPage: 'Vorherige Seite', nextPage: 'Nächste Seite',
      },
      lifecycle: {
        title: 'Lebenszyklus', autosave: 'Automatisches Speichern', preview: 'Vorschau', readiness: 'Freigabebereitschaft',
        pdfa: 'PDF/A-Nachweis', einvoice: 'E-Rechnung', unchecked: 'Nicht geprüft', current: 'Aktuell', updating: 'Wird aktualisiert',
        publishBlocked: 'Die Freigabe bleibt gesperrt, bis der neueste gespeicherte Stand geprüft und frei von Blockern ist.',
        scheduledFor: 'Geplant für {{date}}', effectiveSince: 'Gültig seit {{date}}',
      },
      sections: {
        basic: 'Basislayout', page: 'Seite und Ränder', typography: 'Typografie und Farben',
        header: 'Kopf und Tabelle', title: 'Titel und Metadaten', positions: 'Positionen und technische Daten',
        totals: 'Summen, Steuer und Zahlung', notes: 'Dokumenthinweise und Textbausteine', footer: 'Fußzeile',
        assets: 'Assets und Schriften', compliance: 'PDF/A und E-Rechnung', changed: '{{count}} geänderte Werte',
        inherited: 'Geerbt', blockers: '{{count}} Blocker', warnings: '{{count}} Warnungen',
      },
      templates: {
        label: 'Vorlage', classic: 'Klassisch', modern: 'Modernes Layout', compact: 'Kompakt',
        classicHint: 'Traditionelles Geschäftsbrief-Layout mit kompakter Tabelle.',
        modernHint: 'Großzügiges Layout mit klarer typografischer Hierarchie.',
        compactHint: 'Platzsparendes Layout für Dokumente mit vielen Positionen.',
      },
      page: {
        format: 'Papierformat', orientation: 'Ausrichtung', portrait: 'Hochformat',
        marginTop: 'Rand oben', marginRight: 'Rand rechts', marginBottom: 'Rand unten', marginLeft: 'Rand links',
        firstPageTop: 'Inhaltsbeginn auf der ersten Seite', followingPageTop: 'Inhaltsbeginn auf Folgeseiten',
        firstLetterhead: 'Briefpapier auf der ersten Seite verwenden', followingLetterhead: 'Briefpapier auf Folgeseiten verwenden',
        reuseFirstLetterhead: 'Briefpapier der ersten Seite wiederverwenden', marginHint: 'Bedruckbarer Seitenrand in Millimetern.',
        letterheadHint: 'Briefpapier-Assets werden für erste Seite und Folgeseiten getrennt verwaltet.',
      },
      typography: {
        fontFamily: 'Schriftfamilie', baseSize: 'Basisschriftgröße', tableSize: 'Tabellenschriftgröße',
        metadataSize: 'Metadatenschriftgröße', headingScale: 'Überschriftenskalierung', lineHeight: 'Zeilenhöhe',
        paragraphSpacing: 'Absatzabstand', accentColor: 'Akzentfarbe', textColor: 'Textfarbe',
        mutedColor: 'Gedämpfte Textfarbe', embeddingHint: 'Nur Schriften mit bestätigten Einbettungsrechten dürfen freigegeben werden.',
      },
      header: {
        showLogo: 'Logo anzeigen', logoWidth: 'Logobreite', logoAlignment: 'Logoausrichtung',
        showCompanyDetails: 'Unternehmensdaten anzeigen', showSenderLine: 'Absenderzeile über der Empfängeradresse',
        recipientWindow: 'Empfängerfenster', recipientTop: 'Empfängerposition von oben',
        left: 'Links', center: 'Zentriert', right: 'Rechts',
      },
      titleBlock: {
        showTitle: 'Dokumenttitel anzeigen', showDocumentNumber: 'Dokumentnummer anzeigen',
        showIssueDate: 'Belegdatum anzeigen', showServiceDate: 'Leistungsdatum anzeigen', showDueDate: 'Fälligkeitsdatum anzeigen',
        showCustomerNumber: 'Kundennummer anzeigen', metadataAlignment: 'Ausrichtung der Metadaten',
        titleSpacing: 'Abstand unter dem Titel',
      },
      positions: {
        tableStyle: 'Tabellendichte', compact: 'Kompakt', standard: 'Standard', spacious: 'Großzügig',
        showPositionNumber: 'Positionsnummer', showDescription: 'Bezeichnung', showQuantity: 'Menge',
        showUnit: 'Einheit', showUnitPrice: 'Einzelpreis', showNetAmount: 'Nettobetrag', showTaxRate: 'Steuersatz',
        showTotal: 'Positionssumme', showSecondaryDescription: 'Zusatzbeschreibung', repeatHeader: 'Tabellenkopf wiederholen',
      },
      technical: {
        enabled: 'Technische Druckdaten anzeigen', showPrinter: 'Drucker', showPlate: 'Druckplatte', showMaterial: 'Material',
        showPrintTime: 'Druckzeit', showWeight: 'Gewicht', showFileName: 'Dateiname', placement: 'Platzierung',
        atPosition: 'An der Position', inNotes: 'Im Hinweisbereich',
      },
      totals: {
        showSubtotal: 'Zwischensumme', showDiscount: 'Rabatt', showTaxBreakdown: 'Steueraufschlüsselung',
        showGrossTotal: 'Bruttosumme', showPrepayments: 'Vorauszahlungen', showPaymentTerms: 'Zahlungsbedingungen',
        showBankDetails: 'Bankverbindung', alignment: 'Ausrichtung der Summen',
      },
      notes: {
        showIntro: 'Einleitungstext', showOutro: 'Schlusstext', showPaymentNote: 'Zahlungshinweis',
        showLegalNote: 'Rechts- und Steuerhinweis', introPlacement: 'Position der Einleitung',
        beforeTitle: 'Vor dem Titel', beforePositions: 'Vor den Positionen', outroPlacement: 'Position des Schlusstexts',
        afterPositions: 'Nach den Positionen', afterTotals: 'Nach den Summen', keepWithNext: 'Überschrift mit Folgeinhalt zusammenhalten',
      },
      footer: {
        enabled: 'Fußzeile verwenden', columnLayout: 'Fußzeilenlayout', oneColumn: 'Eine Spalte', twoColumns: 'Zwei Spalten',
        threeColumns: 'Drei Spalten', showCompanyData: 'Firmendaten', showTaxData: 'Steuerangaben',
        showBankData: 'Bankverbindung', showAlternativePayment: 'Alternative Zahlungsdaten',
        showAdditionalNotes: 'Zusätzliche Hinweise', showPageNumbers: 'Seitennummern', pageNumberFormat: 'Seitennummernformat',
        pageNumberHint: '{page} und {pages} als Platzhalter verwenden.',
      },
      inheritance: {
      ...
      assets: {
        ...
        logo: 'Firmenlogo', letterheadFirst: 'Briefpapier erste Seite', letterheadFollowing: 'Briefpapier Folgeseiten',
        fontRegular: 'Grundschrift', fontBold: 'Fettschrift', fontItalic: 'Kursivschrift', fontBoldItalic: 'Fett-kursive Schrift',
        allowed: 'SVG, PNG, JPEG, PDF-Briefpapier, WOFF2 oder TTF; maximal 10 MiB.',
        uploading: 'Upload {{percent}} %', sha: 'SHA-256-Prüfsumme {{hash}}', usedBy: 'Verwendet als {{role}}',
        deleteBlocked: 'Dieses Asset ist noch zugewiesen und kann nicht gelöscht werden.',
        preflight: { pending: 'Vorprüfung ausstehend', valid: 'Vorprüfung bestanden', invalid: 'Vorprüfung fehlgeschlagen', details: 'Details der Vorprüfung' },
      },
      preview: {
        title: 'PDF-Vorschau', empty: 'Entwurf auswählen oder anlegen, um eine Vorschau zu erzeugen.',
        unchecked: 'Aktuellen Entwurf speichern und prüfen, bevor eine Vorschau erzeugt wird.',
        loading: 'PDF-Vorschau wird erzeugt...', updating: 'Vorschau wird aktualisiert; der vorherige Stand bleibt sichtbar.',
        failed: 'Die PDF-Vorschau konnte nicht erzeugt werden.', page: 'Seite {{page}} von {{pages}}', zoom: 'Vergrößerung',
        fit: 'Seite einpassen', download: 'Vorschau-PDF herunterladen', paper: '{{format}} Hochformat',
        directDownload: 'Die Canvas-Anzeige ist fehlgeschlagen. Der autorisierte PDF-Download bleibt verfügbar.',
      },
      findings: {
        title: 'Prüfbefunde', none: 'Keine Befunde für den neuesten gespeicherten Stand.', blocker: 'Freigabeblocker', warning: 'Warnung',
        info: 'Hinweis', field: 'Betroffenes Feld', rule: 'Externe Regel', correction: 'Korrekturhinweis',
        goToField: 'Zum Feld', stale: 'Die Befunde gehören zu einem älteren Entwurf und müssen aktualisiert werden.',
      },
      compliance: {
        title: 'Konformitätsnachweise', pdfa: 'Standard PDF/A-3u', pdfaValid: 'PDF/A-Validierung bestanden',
        pdfaInvalid: 'PDF/A-Validierung fehlgeschlagen', renderer: 'PDF-Renderer {{version}}', validator: 'Prüfwerkzeug {{version}}',
        einvoice: 'Elektronische Rechnung', zugferd: 'Standard ZUGFeRD / Factur-X', xrechnung: 'Standard XRechnung',
        pdfOriginal: 'Das PDF ist das Original; validiertes Rechnungs-XML ist eingebettet.',
        xmlOriginal: 'Das XML ist das Original; das PDF ist eine separate Sichtkopie.',
        xmlProfile: 'XML-Profil {{profile}}', xmlHash: 'XML-SHA-256-Prüfsumme {{hash}}',
        notApplicable: 'Für diesen Dokumenttyp nicht relevant.',
      },
      history: {
        title: 'Layoutverlauf', version: 'Version {{version}}', validFrom: 'Gültig ab',
        validUntil: 'Gültig bis', actor: 'Geändert von', reason: 'Grund', session: 'Bearbeitungssitzung',
        changedFields: 'Geänderte Felder', auditRestricted: 'Detaillierte Prüfdaten erfordern die Berechtigung für Auftragsprotokolle.',
        empty: 'Für diesen Geltungsbereich sind noch keine Layoutversionen vorhanden.',
      },
      dialogs: {
        cloneTitle: 'Layout klonen', cloneReason: 'Grund für den neuen Entwurf',
        publishTitle: 'Layout freigeben', publishReason: 'Freigabegrund', effectiveFrom: 'Gültig ab',
        publishNow: 'Jetzt freigeben', publishLater: 'Freigabe planen', withdrawTitle: 'Freigabe zurückziehen',
        withdrawReason: 'Grund für die Rücknahme', reasonRequired: 'Einen Grund mit mindestens drei Zeichen eingeben.',
        dateRequired: 'Ein zukünftiges Freigabedatum auswählen.',
      },
      mobile: {
        previewFirst: 'Vorschau zuerst', controlsAfterPreview: 'Die Layoutsteuerung folgt unterhalb der Vorschau.',
        openControls: 'Layoutsteuerung öffnen', closeControls: 'Layoutsteuerung schließen',
      },
      errors: {
        load: 'Der Layout-Arbeitsbereich konnte nicht geladen werden.', save: 'Der Entwurf konnte nicht gespeichert werden.',
        conflict: 'Dieser Entwurf wurde in einer anderen Sitzung geändert.', reload: 'Neueste Version laden',
        preview: 'Die Vorschauerzeugung ist fehlgeschlagen.', readiness: 'Die Bereitschaft konnte nicht geprüft werden.',
        permission: 'Für diese Aktion fehlt die Berechtigung.', unknown: 'Ein unerwarteter Layoutfehler ist aufgetreten.',
      },
    },
    documents: {
      ...
      readOnlyHint: 'Sie haben Lesezugriff. Bearbeitungsaktionen sind deaktiviert.',
      permissionDenied: 'Sie haben keine Berechtigung, Dokumenteinstellungen anzuzeigen.',
      loading: 'Dokumentkonfiguration wird geladen...',
      loadError: 'Dokumenteinstellungen konnten nicht geladen werden.',
      actions: { create: 'Entwurf anlegen', check: 'Bereitschaft prüfen', save: 'Entwurf speichern', publish: 'Freigeben', withdraw: 'Planung zurückziehen', clone: 'Neue Version anlegen' },
      messages: { createSuccess: 'Entwurf angelegt.', saveSuccess: 'Entwurf gespeichert.', checkSuccess: 'Bereitschaft aktualisiert.', publishSuccess: 'Konfiguration freigegeben.', cloneSuccess: 'Neue Entwurfsversion angelegt.', withdrawSuccess: 'Geplante Freigabe zurückgezogen.', actionFailed: 'Die Aktion ist fehlgeschlagen.' },
      policy: { title: 'Konfiguration', hint: 'Die folgenden Richtlinien werden als versionierter Entwurf gespeichert. Freigegebene Versionen bleiben unveränderlich.' },
      inheritance: { system: 'Systemvorgabe', businessProfile: 'Unternehmensprofil', customer: 'Vom Kunden übernommen', configuration: 'Konfiguration', document: 'Dokumentüberschreibung', reset: 'Vorgabe wiederherstellen' },
      basic: { title: 'Dokumentregeln', description: 'Datumsbezug, Referenzen, Folgedokumente, Rundung und technische Inhalte.', subject: 'Betreff', validityDays: 'Gültigkeit in Tagen', dateRule: 'Maßgebliches Datum', dates: { issue: 'Belegdatum', service: 'Leistungsdatum', delivery: 'Lieferdatum' }, rounding: 'Rundungsverfahren', roundingModes: { commercial: 'Kaufmännisch', bankers: 'Bankkaufmännisch (Half Even)', down: 'Immer abrunden' }, references: 'Erforderliche Referenzen', reference: { customer_reference: 'Kundenreferenz', order_reference: 'Bestellreferenz', service_period: 'Leistungszeitraum' }, successors: 'Zulässige Folgedokumente', technicalContent: 'Technische Inhalte', includeCalculation: 'Kalkulations- und Druckdaten übernehmen', content: { print_time: 'Druckzeit', material: 'Material', plate_notes: 'Plattenhinweise' } },
      payment: { title: 'Zahlung und Mahnwesen', description: 'Fälligkeit, Skonto, Raten, Bankzuordnung und Eskalationsstufen.', termDays: 'Zahlungsziel in Tagen', currency: 'Währung', dueBasis: 'Fälligkeit berechnen ab', bankAccount: 'Bankkonto-ID', discountDays: 'Skontofrist', discountPercent: 'Skontosatz', prepayment: 'Vorauszahlung', methods: { bank_transfer: 'Überweisung', cash: 'Barzahlung', card: 'Kartenzahlung', direct_debit: 'Lastschrift', paypal: 'PayPal' }, useTermInText: 'Zahlungsziel im Rechnungstext verwenden', installments: 'Ratenplan', installmentPercent: 'Anteil', installmentDue: 'Fällig nach Tagen', removeInstallment: 'Rate entfernen', installmentTotalError: 'Die Raten müssen zusammen 100 % ergeben.', addInstallment: 'Rate hinzufügen', dunningEnabled: 'Mahnwesen aktivieren', interest: 'Verzugszins p. a.', flatFee: 'Grundgebühr', stage: 'Stufe {{level}}', removeStage: 'Mahnstufe entfernen', waitDays: 'Wartezeit in Tagen', stageFee: 'Mahngebühr', newDueDays: 'Neue Zahlungsfrist', stageText: 'Mahntext', chargeInterest: 'Verzugszins berechnen', addStage: 'Mahnstufe hinzufügen' },
      textBlocks: { title: 'Textbausteine', description: 'Wiederverwendbare Formulierungen mit dokumenttypspezifischen Platzhaltern.', insertPlaceholder: 'Platzhalter einfügen', choosePlaceholder: 'Platzhalter auswählen', purposes: { intro: 'Einleitung', closing: 'Schlusstext', payment_terms: 'Zahlungsbedingungen', delivery_terms: 'Lieferbedingungen', tax_note: 'Steuerhinweis', footer: 'Fußzeile', dunning_notice: 'Mahnhinweis' } },
      placeholders: { company_name: 'Unternehmensname', company_address: 'Unternehmensanschrift', company_tax_id: 'Steuernummer', company_vat_id: 'USt-IdNr.', customer_name: 'Kundenname', customer_number: 'Kundennummer', customer_address: 'Kundenanschrift', customer_email: 'Kunden-E-Mail', customer_vat_id: 'Kunden-USt-IdNr.', document_number: 'Dokumentnummer', document_issue_date: 'Belegdatum', document_due_date: 'Fälligkeitsdatum', document_service_date: 'Lieferdatum', document_currency: 'Währung', payment_term_days: 'Zahlungsziel', payment_discount_deadline: 'Skontofrist', payment_discount_percent: 'Skontosatz', dunning_stage: 'Mahnstufe', dunning_fee: 'Mahngebühr', dunning_new_due_date: 'Neue Zahlungsfrist', DOCUMENT_NUMBER: 'Dokumentnummer', VALID_UNTIL: 'Gültig bis', ORDER_REFERENCE: 'Bestellreferenz', DUE_DATE: 'Fälligkeitsdatum', SERVICE_DATE: 'Leistungsdatum', ORIGINAL_DOCUMENT_NUMBER: 'Ursprungsbelegnummer', OPEN_AMOUNT: 'Offener Betrag', CURRENCY: 'Währung', DUNNING_LEVEL: 'Mahnstufe' },
      tax: { title: 'Steuerermittlung', description: 'Zulässige Steuerfälle und kontrollierte manuelle Abweichungen.', ruleVersion: 'Steuerregeln {{version}}', allowedCases: 'Zulässige Steuerfälle', allowOverride: 'Begründete Steuerabweichungen auf Dokumenten zulassen', recordedOverride: 'Protokollierte manuelle Abweichung', manualOverride: 'Steuerfall manuell abweichend festlegen', treatment: 'Steuerliche Behandlung', taxCountry: 'Steuerland', placeOfSupply: 'Leistungsort', category: 'USt-Kategorie', rate: 'Steuersatz', legalReasonCode: 'Rechtsgrund-Code', legalReasonText: 'Rechtsgrund', sellerVatId: 'USt-IdNr. des Verkäufers', buyerVatId: 'USt-IdNr. des Käufers', evidence: 'Prüfnachweis', overrideReason: 'Begründung', applyOverride: 'Abweichung übernehmen', cases: { domestic_standard: 'Inland, Regelsteuersatz', small_business_exempt: 'Kleinunternehmerbefreiung', intra_community_supply: 'Innergemeinschaftliche Lieferung', eu_reverse_charge: 'EU Reverse Charge', eu_b2c_oss: 'EU B2C / OSS', third_country: 'Drittland', explicit_exemption: 'Explizite Steuerbefreiung' } },
      einvoice: { title: 'E-Rechnung', description: 'Vorgaben für EN 16931, XRechnung und ZUGFeRD.', requirement: 'Erfordernis', optional: 'Optional', ruleRequired: 'Regelbasiert erforderlich', syntax: 'Syntax', pinned: 'Durch den installierten Validator fest vorgegeben', zugferdProfile: 'ZUGFeRD-Profil', processId: 'Geschäftsprozess-ID', sellerEndpoint: 'Elektronische Adresse des Verkäufers', endpointScheme: 'Schema der elektronischen Adresse', buyerEndpoint: 'Empfängerkennung', buyerReference: 'Buyer Reference / Leitweg-ID', defaultPaymentMethod: 'Standard-Zahlungsart', bankAccount: 'Bankkonto-ID', validationLayers: 'Validierungsebenen', layers: { xsd: 'XML-Schema (XSD)', en16931: 'EN 16931 Geschäftsregeln', cius: 'CIUS / XRechnung' }, validationStatus: 'Validierung', downloadXml: 'XML herunterladen', downloadReport: 'Validierungsbericht herunterladen', findingCount: '{{count}} Befunde' },
      empty: { title: 'Keine Konfiguration für diesen Kontext', description: 'Einen Entwurf aus den Systemstandards anlegen und vor der Freigabe prüfen.' },
      history: { title: 'Versionsverlauf', empty: 'Für diesen Kontext sind noch keine Versionen vorhanden.', version: 'Version', status: 'Status', effectiveFrom: 'Gültig ab', reason: 'Änderungsgrund', actor: 'Erstellt / freigegeben von', rules: 'Regelstände', publishedAt: 'Freigegeben', auditTitle: 'Prüfprotokoll', auditEmpty: 'Noch keine protokollierten Änderungen vorhanden.', correlation: 'Korrelations-ID', actions: { create: 'Entwurf erstellt', update: 'Entwurf geändert', clone: 'Version geklont', publication: 'Version freigegeben', withdraw: 'Freigabe zurückgezogen' } },
      unsaved: { title: 'Ungespeicherte Änderungen', message: 'Beim Wechsel des Dokumentkontexts werden die aktuellen Änderungen verworfen.', discard: 'Änderungen verwerfen' },
      publish: { title: 'Konfiguration freigeben', description: 'Die freigegebene Version ist unveränderlich und gilt ab dem gewählten Datum.', effectiveFrom: 'Gültig ab', reason: 'Grund: {{reason}}' },
      documentTypes: { quotation: 'Angebot', order_confirmation: 'Auftragsbestätigung', delivery_note: 'Lieferschein', advance_invoice: 'Abschlagsrechnung', progress_invoice: 'Teilrechnung', final_invoice: 'Schlussrechnung', invoice: 'Rechnung', cancellation_invoice: 'Stornorechnung', invoice_correction: 'Rechnungskorrektur', commercial_credit_note: 'Gutschrift', payment_reminder: 'Zahlungserinnerung', dunning_notice: 'Mahnung', self_billing: 'Abrechnungsgutschrift' },
    },
    spoolbuddy: {
    ...
    progressInTitle: 'Druckfortschritt im Browser-Tab anzeigen',
    progressInTitleHint: 'Wenn ein Drucker läuft, zeigen Tab-Titel und Favicon den Fortschritt des aktiven Drucks.',
    // Archive
    ...
    cameraUrlBuilderToggle: 'URL aus Host, Port und Pfad zusammensetzen',
    cameraUrlBuilderHost: 'Host oder IP',
    cameraUrlBuilderPort: 'Port',
    cameraUrlBuilderPath: 'Pfad (z. B. /stream)',
    cameraUrlBuilderUsername: 'Benutzername (optional)',
    cameraUrlBuilderPassword: 'Passwort (optional)',
    cameraUrlBuilderHelp: 'Füllt das Kamera-URL-Feld oben aus. Die URL wird weiterhin genauso validiert und getestet wie eine manuell eingegebene.',
  ...
  hmsErrors: {
    ...
    runoutExpectedSlot: 'Filament ist in {{ranOut}} leer. Der Druck erwartet jetzt Filament in {{expected}}.',
    runoutExpectedSlotOnly: 'Filament ist leer. Der Druck erwartet jetzt Filament in {{expected}}.',
    runoutSlotUnknown: 'Filament ist leer. Bitte prüfen Sie am Drucker, welcher AMS-Slot erwartet wird.',
  ...
  camera: {
    ...
    diagnose: {
      ...
      info: {
        ...
        notActive: 'Für diesen Drucker läuft aktuell kein Stream.',
        pipelineName: {
          go2rtc: 'go2rtc (RTSP-Quelle, bedient MSE + MJPEG)',
          go2rtc_chamber_bridge: 'go2rtc (Chamber-Image-Bridge, nur MJPEG)',
          chamber_binary: 'Chamber-Image-Protokoll (proprietär, binär)',
          external_mjpeg: 'Externe Kamera (MJPEG, über go2rtc)',
          external_rtsp: 'Externe Kamera (RTSP, über go2rtc)',
  ...
  users: {
    ...
    form: {
      ...
      groups: 'Gruppen',
      printerScope: 'Druckerzugriff',
      allPrinters: 'Alle Drucker',
      printerScopeCount: '{{count}} Drucker',
      optional: 'optional',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      device: {
        title: 'PrintOps in Orca Cloud genehmigen',
        instruction: 'Öffnen Sie Orca Cloud und genehmigen Sie diesen Code. PrintOps verbindet sich automatisch, sobald Sie genehmigt haben.',
    ...
    connectedAs: 'Verbunden als',
    signInExpired: 'Deine Bambu-Cloud-Anmeldung ist abgelaufen. Melde dich erneut an, um Cloud-Profile wieder zu verwenden.',
    logout: 'Abmelden',
  ...
  slice: {
    ...
    filamentColourAuto: 'Automatisch',
...
useEmbedded: 'Datei-eigene Einstellungen verwenden',
    useEmbeddedHint: 'Slice mit den Einstellungen des Designers (Wände, Infill, Filament) statt mit den Profilen oben. Verfügbar, weil dein Drucker zur Datei passt.',
  ...
  inventory: {
    ...
    bulk: {
      ...
      mergeTargetPrompt: 'Ziel-Spulen-ID aus den ausgewählten IDs ({{ids}})',
      mergeInvalidTarget: 'Wählen Sie eine der ausgewählten Spulen-IDs als Ziel',
      mergeSuccess: '{{count}} doppelte Spulen zusammengeführt',
    ...
    refill: 'Nachfüllen',
    refillPrompt: 'Nachfüllgewicht in Gramm für Spule #{{id}}',
    refillInvalidWeight: 'Geben Sie ein Gewicht größer als 0 g ein',
    refillSuccess: 'Spulen-Nachfüllung erfasst',
    refillFailed: 'Spulen-Nachfüllung fehlgeschlagen',
  ...
  haSensors: {
    ...
    blockPrintHint: 'Aufträge bleiben in der Warteschlange und starten, sobald der Sensor wieder frei ist. Ist Home Assistant nicht erreichbar, gilt die gewählte Ausfallstrategie.',
    safeState: 'Sicherer Zustand: {{state}}',
    failureStrategyLabel: 'Wenn Home Assistant nicht erreichbar ist',
    failureAuto: 'Automatisch (kritische Sicherheitssensoren sperren)',
    failureOpen: 'Drucken erlauben (fail-open)',
    failureClosed: 'Drucken zurückhalten (fail-closed)',
    failureStrategyHint: 'Rauch-, Gas-, Feuchte-, Problem- und Sicherheitssensoren halten die Warteschlange standardmäßig zurück, wenn kein frischer Messwert verfügbar ist.',
    primarySafetyWarning: 'PrintOps-Interlocks sind nur sekundäre Kontrollen. Eine unabhängige physische Brand-, Gas- und Maschinenschutzfunktion bleibt erforderlich.',
    failure: {
      auto: 'Ausfall: automatisch',
      fail_open: 'Ausfall: Drucken erlauben',
      fail_closed: 'Ausfall: Drucken zurückhalten',
    },
    override: {
      unavailable: 'Fail-closed-Interlock nicht erreichbar: {{sensors}}',
      open: 'Vorübergehend übersteuern',
      reasonLabel: 'Grund für die vorübergehende Übersteuerung',
      confirm: 'Übersteuerung bestätigen',
      clear: 'Interlock wiederherstellen',
      active: 'Übersteuerung durch {{user}} aktiv: {{reason}}',
      unknownUser: 'unbekannter Benutzer',
      error: 'Die Interlock-Übersteuerung konnte nicht geändert werden.',
    },
    toast: {
  ...
  smartPlugs: {
    ...
    linkTarget: 'Ziel verbinden',
    noTarget: 'Kein Ziel (nur manuelle Steuerung)',
    targetPrinter: 'Drucker',
    targetDryer: 'Filament-Trockner',
    selectPrinter: 'Drucker auswählen',
    selectDryer: 'Filament-Trockner auswählen',
    ...
    restEnergyTotalPath: 'JSON-Pfad Gesamtenergie',
    restEnergyTotalMultiplier: 'Gesamtenergie Multiplikator',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      bark: 'Account-freie iOS-Push-Benachrichtigungen über Bark',
    ...
    telegramThreadIdInvalid: 'Forum-Topic-ID muss eine Zahl sein',
    barkDeviceKey: 'Geräteschlüssel',
    barkGroup: 'Gruppe',
    barkSound: 'Ton',
    barkLevel: 'Unterbrechungsstufe',
    barkLevelDefault: 'Standard',
    barkLevelPassive: 'Passiv',
    barkLevelActive: 'Aktiv',
    barkLevelTimeSensitive: 'Zeitkritisch',
    barkLevelCritical: 'Kritisch',
  ...
  bugReport: {
    ...
    manualReportTitle: 'Über GitHub melden',
    manualReportDescription: 'PrintOps verwendet für Fehlerberichte das öffentliche GitHub-Issue-Formular. So ist kein Relay pro Installation nötig und Sie behalten die Kontrolle über die eingereichten Angaben.',
    openIssueForm: 'GitHub-Issue öffnen',
  ...
  failureDetection: {
    ...
    mlTokenHint: 'Muss dem ML_API_TOKEN deines Obico-ml_api-Containers entsprechen. Leer lassen, wenn der Container ohne Token läuft.',
    test: 'Testen',
    testSuccess: 'ML-API erreichbar und funktionsfähig.',
    testSuccessTokenUnknown: 'ML-API erreichbar und funktionsfähig. Der Token konnte nicht geprüft werden.',
