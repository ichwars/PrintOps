export default {
  ...
  bugReport: {
    ...
    manualFallbackTitle: 'Automatische Übermittlung ist nicht eingerichtet',
    manualFallbackDescription: 'Diese Installation kann Fehlerberichte nicht direkt an GitHub senden. Öffnen Sie stattdessen das GitHub-Issue-Formular und fügen Sie Ihre Beschreibung dort ein.',
