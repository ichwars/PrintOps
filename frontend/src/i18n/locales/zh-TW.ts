export default {
  ...
  nav: {
    ...
    logout: '登出',
    installApp: '安裝應用程式',
    installAppSuccess: 'PrintOps 已安裝',
  },
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldLabel: '維護模式',
      editFieldHelp: '啟用後，此印表機將從 MQTT、佇列調度和通知中暫停 — 適用於維修、並行 PrintOps 安裝或暫時停用。',
    },
    // Chamber light
  ...
  archives: {
    ...
    no3mfBanner: {
      ...
      body: '切片機沒有在印表機的 SD 卡上留下 .gcode.3mf 檔案，因此 PrintOps 無法取得縮圖或切片機中繼資料。這通常是因為切片機 (Bambu Studio / OrcaSlicer 的裝置分頁) 中「將傳送的檔案儲存在外部儲存中」已關閉。',
      docsLink: '檢視安裝步驟 4',
      dismissLabel: '關閉此通知',
    },
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedNotice: '仍欠的 {{owed}} 次列印中有 {{runs}} 次無法加入佇列：該板已沒有可複製設定的記錄。請從檔案將該板加入佇列一次，或取消批次。',
    ...
    cancelBatchConfirmMessage: '結束此批次？佇列中的列印將被取消，未生產的數量將被捨棄。',
    batch: {
      defaultName: '批次',
      label: '{{count}} 項',
    ...
    toast: {
      ...
      cancelFailed: '取消項目失敗',
      removed: '佇列項目已移除',
      keptForOrder: '未移除：「{{name}}」仍需要此列印作為該板唯一可重用的設定',
      historyKeptForOrders: '保留了開放批次仍需要的 {{kept}} 個設定。',
      removeFailed: '移除項目失敗',
      stopped: '列印已停止',
      stopFailed: '停止列印失敗',
      released: '列印已加入佇列',
  ...
  stats: {
    ...
    energySource: {
      smartPlugLive: '智慧插座即時總量',
      smartPlugSnapshots: '智慧插座快照',
      printLogs: '列印記錄',
    },
  ...
  settings: {
    ...
    tabs: {
      general: '通用',
      usersSecurity: '使用者與安全',
      printersProduction: '印表機與生產',
      projectsFiles: '專案與檔案',
      warehouseMaterial: '倉庫與材料',
      ordersCalculation: '訂單與計算',
      integrations: '整合',
      operations: '營運',
      smartPlugs: '智慧插座',
      notifications: '通知',
    ...
    documents: {
      ...
      status: { draft: 'Draft', scheduled: 'Scheduled', active: 'Active', superseded: 'Superseded', missingDraft: '無草稿' },
    ...
    ldap: {
      ...
      feature3: '登入時 LDAP 群組對應到 PrintOps 群組',
    ...
    localLogin: {
      ...
      disableHint: '啟用後，只能透過SSO提供者登入。LDAP不受影響。在伺服器上設定 PRINTOPS_LOCAL_LOGIN=true 可保留復原途徑。',
    },
    // Queue
    enableRetry: '啟用重試',
    // Home Assistant
    ...
    preheatFilamentTargetsHint: 'PrintOps 在已裝入的 AMS 槽位中挑選最高目標；只有 PLA 的列印推導為 0，並自動跳過腔體階段。',
    ...
    authDisabledMessage: '啟用身份驗證以建立使用者帳戶、管理權限並保護您的 PrintOps 實例。',
    ...
    disableAuthenticationMessage: '確定要停用身份驗證嗎？這將使您的 PrintOps 實例無需登入即可存取。所有使用者將保留在資料庫中但身份驗證將被停用。',
    disableAuthentication: '停用身份驗證',
    // Additional settings
    configurePrintOps: '設定 PrintOps',
    systemDefault: '系統預設',
    ...
    noticePreferences: '提示',
    showDeveloperLanWarning: '顯示 Developer LAN 警告',
    showDeveloperLanWarningDesc: '當已連線的印表機未啟用 Developer LAN 模式時，在應用程式頂部顯示警告。',
    showSponsorPrompts: '顯示支持者提示',
    showSponsorPromptsDesc: '偶爾顯示關於支持者和 PrintOps 社群資助的提示。',
    ...
    progressInTitle: '在瀏覽器分頁顯示列印進度',
    progressInTitleHint: '印表機執行時，分頁標題與 favicon 會顯示目前列印百分比。',
    autoArchivePrints: '自動歸檔列印',
    autoArchiveDescription: '列印完成時自動儲存3MF檔案',
    saveThumbnailsDescription: '從3MF檔案中提取並儲存預覽影像',
    captureFinishPhotoDescription: '列印完成時從印表機攝影機拍照。PrintOps 會在列印期間錄製一段短縮時攝影，以便從熱床下降前的瞬間取得照片；如果您為本次列印啟用了縮時攝影，檔案將保留，否則會在拍照完成後自動刪除。',
    ...
    cameraUrlBuilderToggle: '透過主機、連接埠和路徑產生URL',
    cameraUrlBuilderHost: '主機或IP',
    cameraUrlBuilderPort: '連接埠',
    cameraUrlBuilderPath: '路徑（例如 /stream）',
    cameraUrlBuilderUsername: '使用者名稱（選填）',
    cameraUrlBuilderPassword: '密碼（選填）',
    cameraUrlBuilderHelp: '將填入上方的攝影機URL欄位，驗證與測試方式與手動輸入的URL相同。',
    ...
    printopsSoftware: 'PrintOps 軟體',
    autoCheckDescription: '啟動時自動檢查新版本',
    checkNow: '立即檢查',
    updateAvailableVersion: '可用更新：v{{version}}',
    releaseNotes: '發布說明',
    updateViaDocker: '透過 Docker Compose 更新：',
    updateViaHomeAssistant: '更新由 Home Assistant Supervisor 管理。請在 Home Assistant 中開啟 設定 → 附加元件 → PrintOps 以安裝新版本。',
    ...
    goToBackup: '前往備份',
    externalUrl: '外部URL',
    externalUrlDescription: 'PrintOps可存取的外部URL。用於通知影像和外部整合。',
    ...
    mqttDescription: '將PrintOps事件發布到外部MQTT代理，用於與Node-RED、Home Assistant和其他自動化系統整合。',
    ...
    oidc: {
      ...
      form: {
        ...
        iconUrl: '圖示 URL（可選）',
        enabled: '已啟用',
        allowPrivateNetwork: '允許私人網路 IdP',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'TOTP 機密和 OIDC client_secrets 以明文儲存。請設定 MFA_ENCRYPTION_KEY 或使用可寫資料目錄重新啟動 PrintOps 以自動產生。',
      ...
      migrationErrorWarning: '{{count}} 行舊資料在啟動時未能重新加密。請檢查伺服器日誌並重新啟動 PrintOps 以重試。',
    },
  ...
  hmsErrors: {
    ...
    runoutExpectedSlot: '{{ranOut}} 中的耗材已用盡。列印現在需要 {{expected}} 中的耗材。',
    runoutExpectedSlotOnly: '耗材已用盡。列印現在需要 {{expected}} 中的耗材。',
    runoutSlotUnknown: '耗材已用盡。請在印表機上查看目前需要哪個 AMS 料槽。',
  ...
  login: {
    ...
    twoFA: {
      ...
      methodEmail: '信箱驗證碼',
      methodBackup: '備用恢復碼',
      instructionsTotp: '請開啟您的身份驗證器 App，輸入 PrintOps 的 6 位驗證碼。',
  ...
  setup: {
    title: 'PrintOps 設定',
    subtitle: '為您的 PrintOps 實例設定身份驗證',
    enableAuth: '啟用身份驗證',
    adminAccount: '管理員帳戶',
  ...
  camera: {
    ...
    diagnose: {
      ...
      info: {
        ...
        uptime: '串流執行時間',
        tlsProxy: 'TLS 代理',
        go2rtcStream: 'go2rtc 串流',
        notActive: '此印表機目前沒有作用中的串流。',
        pipelineName: {
          go2rtc: 'go2rtc（RTSP 來源，提供 MSE + MJPEG）',
          go2rtc_chamber_bridge: 'go2rtc（艙內影像橋接，僅 MJPEG）',
          chamber_binary: '艙內影像協定（專有二進位）',
          external_mjpeg: '外部攝影機（MJPEG，透過 go2rtc）',
          external_rtsp: '外部攝影機（RTSP，透過 go2rtc）',
          external_snapshot: '外部攝影機（HTTP 快照，透過 go2rtc）',
          external_usb: '外部攝影機（USB/v4l2，直連）',
        },
        player: '播放器',
        playerName: {
          mse: 'MSE（H.264，無需重新編碼）',
          mjpeg: 'MJPEG（備援）',
          connecting: '連線中…',
        },
      },
  ...
  users: {
    title: '使用者管理',
    subtitle: '管理使用者及其對 PrintOps 實例的存取',
    backToSettings: '返回設定',
    createUser: '建立使用者',
    noPermission: '您沒有存取此頁面的權限。',
    admin: '管理員',
    ...
    form: {
      ...
      groups: '群組',
      printerScope: '印表機存取權限',
      allPrinters: '所有印表機',
      printerScopeCount: '{{count}} 台印表機',
      optional: '可選',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: '登入您的 Orca Cloud 帳號,將切片機設定檔同步到 PrintOps。',
      },
      device: {
        title: '在 Orca Cloud 中核准 PrintOps',
        instruction: '開啟 Orca Cloud 並核准此代碼。核准後 PrintOps 會自動連接。',
        codeLabel: '您的配對代碼',
    ...
    connectedAs: '已連線為',
    signInExpired: '你的 Bambu Cloud 登入已過期。請重新登入以使用雲端預設。',
    logout: '登出',
  ...
  sponsors: {
    ...
    tagline: 'PrintOps 完全免費，並將持續免費——感謝主動支持的使用者。沒有創投，也沒有雲端綁定。',
    viewSupporters: '查看支持者',
    toastPrints: '你已經用 PrintOps 完成了 {{count}} 次列印。PrintOps 之所以免費，要感謝支持者。',
    toastCost: '你已經用 PrintOps 追蹤了 {{total}} 的耗材。看看是誰讓專案保持獨立。',
    toastArchives: '用 PrintOps 封存了 {{count}} 次列印。看看是誰讓它保持獨立。',
    toastAnniversary: '與 PrintOps 相伴一年了！看看是誰讓專案保持獨立。',
    toastVersionUpdate: '已更新至 v{{version}}。PrintOps 之所以免費，要感謝支持者。',
  },
  ...
  slice: {
    title: '切片模型',
    stepUnsupported: '不支援切片',
    stepUnsupportedHint: 'STEP/STP 檔案無法在伺服器端切片 - 切片軟體無法匯入這些格式。請將模型轉換為 STL 或 3MF 後再切片。',
    action: '切片',
...
useEmbedded: '使用檔案內建設定',
    useEmbeddedHint: '依照設計者設定的方式切片（壁數、填充、耗材），而不是使用上方設定檔。因為你的印表機與檔案相符，所以可用。',
    autoOrient: '自動擺正模型',
  ...
  inventory: {
    ...
    bulk: {
      ...
      mergeTargetPrompt: '從已選 ID 中選擇目標線軸 ID ({{ids}})',
      mergeInvalidTarget: '請選擇其中一個已選線軸 ID 作為目標',
      mergeSuccess: '已合併 {{count}} 個重複線軸',
      mergeFailed: '合併失敗',
      invalidHex: '請輸入 6 位十六進位字元 (RRGGBB) 或 8 位 (RRGGBBAA)，否則此欄位不會套用。',
    },
    refill: '補充',
    refillPrompt: '線軸 #{{id}} 的補充重量，單位為克',
    refillInvalidWeight: '請輸入大於 0 g 的重量',
    refillSuccess: '已記錄線軸補充',
    refillFailed: '線軸補充失敗',
    spoolmanMixedContentTitle: 'Spoolman 無法透過 HTTPS 載入 — 瀏覽器已封鎖混合內容',
    spoolmanMixedContentBody: 'PrintOps 透過您的反向代理以 HTTPS 提供服務，但您的 Spoolman 位址仍為 HTTP。基於安全考量，瀏覽器會封鎖混合內容，因此內嵌的 Spoolman 介面無法載入。Spoolman 也必須可透過 HTTPS 存取。',
    spoolmanMixedContentFixReverseProxy: '請將 Spoolman 置於與 PrintOps 相同的反向代理（Traefik / Nginx / Caddy）之後並啟用 HTTPS，然後在設定中將 Spoolman URL 更新為新的 HTTPS 位址。',
  ...
  backup: {
    ...
    repoIsPublicWarning: '儲存庫為公開（PUBLIC）。PrintOps 備份包含 MQTT 認證、Home Assistant 權杖、Prometheus 權杖、您的 Bambu Cloud 電子郵件，以及透過 K-profile 暴露的印表機存取碼。在您於服務商設定中將儲存庫改為私有之前，儲存將被阻擋。',
    repoVisibilityUnknown: '無法確認儲存庫的可見性。PrintOps 拒絕向任何未確認為私有的目標進行備份；儲存將被阻擋。',
    ...
    appSettings: '應用程式設定',
    appSettingsDescription: 'PrintOps 設定（完整資料庫）',
    spoolInventory: '耗材庫存',
    ...
    // Local Backup
    localBackup: '本機備份',
    localBackupDescription: '建立 PrintOps 資料的完整備份，包括資料庫、檔案、上傳和所有檔案。',
    ...
    backupRestoredRestart: '備份已恢復。請重新啟動 PrintOps。',
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: '備註儲存在 PrintOps 中，不在印表機上',
      syncing: '與印表機同步中...',
  ...
  virtualPrinter: {
    ...
    enable: {
      title: '啟用虛擬印表機',
      visibleInSlicer: '在切片軟體發現中顯示為"PrintOps"',
      proxyingTo: '代理到 {{name}}',
      notActive: '未啟用',
    },
    model: {
    ...
    remoteInterface: {
      ...
      placeholder: '自動檢測（預設）...',
      hint: '覆蓋透過 SSDP 廣播並在 TLS 憑證中使用的 IP 位址。在 PrintOps 有多個網路介面時很有用。',
    },
    mode: {
      title: '模式',
      archive: '歸檔',
    ...
    caCert: {
      title: '切片軟體憑證',
      description: '虛擬印表機使用由 PrintOps CA 簽發的 TLS 憑證。將此 CA 憑證匯入切片軟體的信任庫一次，切片軟體即可接受連線 — 無需再透過命令列取得。',
      copy: '複製',
      copied: '已複製',
      download: '下載',
      fingerprint: 'SHA-256',
    ...
    howItWorks: {
      ...
      step2: '在歸檔、審核和佇列模式下，使用切片軟體中的"傳送"按鈕將 3MF 檔案上傳到 PrintOps。切片軟體會顯示"列印成功"— 檔案已儲存，未列印。',
  ...
  haSensors: {
    ...
    blockPrintHint: '工作會留在佇列中直到感測器恢復。Home Assistant 無法連線時會套用所選故障策略。',
    safeState: '安全狀態：{{state}}',
    failureStrategyLabel: 'Home Assistant 無法使用時',
    failureAuto: '自動（關鍵安全感測器會阻止列印）',
    failureOpen: '允許列印（fail-open）',
    failureClosed: '暫停列印（fail-closed）',
    failureStrategyHint: '關鍵安全感測器在沒有最新讀數時會暫停佇列。',
    primarySafetyWarning: 'PrintOps 聯鎖僅為輔助控制。請保留獨立的實體安全防護。',
    failure: {
      auto: '故障策略：自動',
      fail_open: '故障策略：允許列印',
      fail_closed: '故障策略：暫停列印',
    },
    override: {
      unavailable: 'fail-closed 聯鎖無法使用：{{sensors}}',
      open: '暫時略過',
      reasonLabel: '暫時略過原因',
      confirm: '確認略過',
      clear: '恢復聯鎖',
      active: '{{user}} 已啟用略過：{{reason}}',
      unknownUser: '未知使用者',
      error: '無法變更聯鎖略過狀態。',
    },
    toast: {
  ...
  smartPlugs: {
    ...
    restEnergyTotalPath: '總能耗 JSON 路徑',
    restEnergyTotalMultiplier: '總能耗乘數',
  ...
  notifications: {
    ...
    barkLevelPassive: '被動',
    barkLevelActive: '主動',
    barkLevelTimeSensitive: '時間敏感',
    barkLevelCritical: '緊急',
    smtpServer: 'SMTP 伺服器',
    smtpPort: 'SMTP 連接埠',
    security: '安全',
    authentication: '認證',
  ...
  externalLinks: {
    ...
    mainPage: '主頁面',
    childPageOf: '{{parent}} 的子頁面',
    hiddenByParent: '透過 {{parent}} 隱藏',
    showParentFirst: '先顯示 {{parent}}',
    hidePage: '隱藏頁面',
    showPage: '顯示頁面',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'PrintOps 正在以 Docker bridge 網路執行。印表機探索與虛擬印表機需要 host 網路模式 — 請使用 "network_mode: host" 重新建立容器。',
        skip: '未在 Docker 中執行 — 不適用。',
      },
      subnet: {
        title: '網路子網路',
        pass: '印表機與 PrintOps 位於同一子網路。',
        warn: '印表機（{{printer_ip}}）與 PrintOps（{{host_ip}}）位於不同的子網路。除非設定了子網路之間的路由，否則它們可能無法互相連線。',
        skip: '無法判定子網路 — 已略過。',
      },
      mqtt_auth: {
        title: '印表機認證資訊',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: '從印表機螢幕（區域網路設定）重新複製存取碼，並在 PrintOps 的印表機設定中更新。',
      },
      'ftp-connection-timeout': {
        name: '檔案傳輸連線逾時',
        cause: 'PrintOps 無法連線印表機的檔案傳輸連接埠（FTPS 990）。該連接埠被封鎖，或印表機已關機或位於其他子網路。',
        fix: '請確認 PrintOps 與印表機之間的 990 連接埠未被封鎖，且兩者位於同一網路。',
      },
      'ftp-ssl-error': {
        name: '安全檔案傳輸交握失敗',
      ...
      'database-locked': {
        ...
        fix: '請將 PrintOps 切換到外部 PostgreSQL 資料庫。參見文件中的 PostgreSQL 指南。',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        title: '服務正在執行',
        fail: '虛擬印表機已啟用，但其服務未執行。請檢查 PrintOps 記錄 — 通常是繫結 IP 衝突或權限錯誤使其停止。',
      },
      bind_interface: {
        title: '繫結網路介面',
      ...
      certificate: {
        title: 'TLS 憑證',
        pass: '憑證已就緒。請確保已將 PrintOps CA 憑證（上方）匯入切片軟體的信任庫。',
        fail: '此虛擬印表機的 TLS 憑證遺失。請檢查 PrintOps 資料目錄是否可寫入。',
      },
    },
  },
  ...
  bugReport: {
    ...
    submit: '提交',
    startLogging: '開始偵錯日誌',
    manualReportTitle: '透過 GitHub 回報',
    manualReportDescription: 'PrintOps 使用公開的 GitHub issue 表單處理錯誤回報。這樣不需要為每個安裝設定 relay，送出的內容也由你掌控。',
    openIssueForm: '開啟 GitHub issue',
  ...
  failureDetection: {
    ...
    mlTokenPlaceholder: '如果伺服器未使用 ML_API_TOKEN，請留空',
    mlTokenHint: '必須與 Obico ml_api 容器的 ML_API_TOKEN 環境變數一致。如果容器未使用權杖，請留空。',
    test: '測試',
    testSuccess: 'ML API 可存取且正常。',
    testSuccessTokenUnknown: 'ML API 可連線且狀態正常。無法檢查權杖。',
    ...
    externalUrlHint: 'ML API 透過 URL 擷取攝影機快照。請在一般設定中設定外部 URL，讓 ML API 容器可以連線到 PrintOps。',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: '貼上 MakerWorld 模型連結，即可直接在 PrintOps 中匯入並列印 —— 無需切換至 Bambu Handy 應用程式。',
    ...
    disclaimer: 'MakerWorld 整合使用由社群記錄的 API 介面。PrintOps 與 MakerWorld 或 Bambu Lab 無從屬或認可關係。',
  ...
  libraryPurge: {
    ...
    effect4: '外部（連結）資料夾中的檔案將被略過 — PrintOps 從不刪除不屬於自己的位元組。',    previewLoading: '正在檢查符合的檔案數量…',
