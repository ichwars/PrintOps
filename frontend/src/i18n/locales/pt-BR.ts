export default {
  orderUiNotFound: 'Registro não encontrado.',
  ...
  nav: {
    ...
    installAppSuccess: 'PrintOps foi instalado',
  },
  ...
  printers: {
    ...
    camWall: {
      ...
      page: {
        tokenRejected: 'Este token do mural de câmeras foi rejeitado ou expirou.',
        loadFailed: 'Não foi possível carregar o mural de câmeras.',
      },
    },
    // Controls
    ...
    maintenance: {
      ...
      editFieldHelp: 'Quando ativado, esta impressora é pausada do MQTT, despacho de fila e notificações — útil para reparos, instalações paralelas do PrintOps ou suspensão temporária.',
    },
    // Chamber light
    ...
    expectedSlot: {
      ...
      label: '{{ams}} · Compartimento {{slot}}',
      title: 'A impressão pausada espera filamento aqui',
      ariaLabel: 'Slot de substituição esperado {{n}}',
    },
    // Filaments section
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedNotice: 'Não é possível enfileirar {{runs}} das {{owed}} impressões devidas: não resta uma execução da qual copiar as configurações. Enfileire a placa pelo arquivo ou cancele o lote.',
    ...
    cancelBatchConfirmMessage: 'Encerrar este lote? As impressões na fila serão canceladas e as quantidades não produzidas serão descartadas.',
    batch: {
      defaultName: 'Lote',
      label: '{{count}} item',
    ...
    toast: {
      ...
      keptForOrder: 'Não removido: “{{name}}” ainda precisa desta impressão como única configuração reutilizável da placa',
      historyKeptForOrders: '{{kept}} configurações necessárias para lotes abertos foram mantidas.',
  ...
  stats: {
    ...
    energySource: {
      smartPlugLive: 'Total ao vivo da tomada inteligente',
      smartPlugSnapshots: 'Snapshots da tomada inteligente',
      printLogs: 'Registros de impressão',
    },
  ...
  settings: {
    ...
    tabs: {
      general: 'Geral',
      usersSecurity: 'Usuários e segurança',
      printersProduction: 'Impressoras e produção',
      projectsFiles: 'Projetos e arquivos',
      warehouseMaterial: 'Armazém e materiais',
      ordersCalculation: 'Pedidos e cálculo',
    ...
    ldap: {
      ...
      feature3: 'Grupos LDAP são mapeados para grupos PrintOps no login',
      ...
      autoProvisionHint: 'Criar automaticamente uma conta PrintOps no primeiro login LDAP',
      ...
      groupMappingHint: 'Mapear DNs de grupos LDAP para grupos PrintOps. Grupos disponíveis: ',
    ...
    localLogin: {
      ...
      disableHint: 'Quando ativado, somente provedores SSO podem fazer login. O LDAP não é afetado. Defina PRINTOPS_LOCAL_LOGIN=true no servidor para manter um caminho de recuperação.',
    },
    // Queue
    ...
    preheatFilamentTargetsHint: 'PrintOps escolhe o alvo mais alto entre os slots AMS carregados; impressões apenas com PLA derivam 0 e pulam a fase da câmara automaticamente.',
    ...
    authDisabledMessage: 'Ative a autenticação para criar contas de usuário, gerenciar permissões e proteger sua instância do PrintOps.',
    ...
    disableAuthenticationMessage: 'Tem certeza de que deseja desativar a autenticação? Isso tornará sua instância do PrintOps acessível sem login. Todos os usuários permanecerão no banco de dados, mas a autenticação será desativada.',
    ...
    showDeveloperLanWarningDesc: 'Avisar no topo do app quando uma impressora conectada nao estiver com o modo Developer LAN ativo.',
    showSponsorPrompts: 'Mostrar avisos de apoiadores',
    showSponsorPromptsDesc: 'Mostrar avisos ocasionais sobre apoiadores e financiamento comunitario do PrintOps.',
    ...
    progressInTitle: 'Mostrar progresso da impressão na aba',
    progressInTitleHint: 'Quando uma impressora estiver imprimindo, o título da aba e o favicon mostram a porcentagem ativa.',
    ...
    captureFinishPhotoDescription: 'Tirar foto da câmera da impressora quando a impressão for concluída. PrintOps grava um timelapse curto durante a impressão para que a foto possa ser obtida do momento antes da mesa descer; o arquivo do timelapse é mantido se você habilitou o timelapse para esta impressão, caso contrário ele é excluído automaticamente após a captura da foto.',
    ...
    cameraUrlBuilderToggle: 'Montar URL a partir de host, porta e caminho',
    cameraUrlBuilderHost: 'Host ou IP',
    cameraUrlBuilderPort: 'Porta',
    cameraUrlBuilderPath: 'Caminho (ex.: /stream)',
    cameraUrlBuilderUsername: 'Usuário (opcional)',
    cameraUrlBuilderPassword: 'Senha (opcional)',
    cameraUrlBuilderHelp: 'Preenche o campo de URL da câmera acima. Continua sendo validada e testada da mesma forma que uma URL digitada manualmente.',
    ...
    updateViaHomeAssistant: 'As atualizações são gerenciadas pelo Supervisor do Home Assistant. Abra Configurações → Complementos → PrintOps no Home Assistant para instalar a nova versão.',
    ...
    externalUrlDescription: 'A URL externa onde o PrintOps está acessível. Usada para imagens de notificação e integrações externas.',
    printopsUrl: 'URL do PrintOps',
    ...
    mqttDescription: 'Publique eventos do PrintOps para um broker MQTT externo para integração com Node-RED, Home Assistant e outros sistemas de automação.',
    ...
    oidc: {
      ...
      form: {
        ...
        enabled: 'Ativado',
        allowPrivateNetwork: 'Permitir IdP na rede privada',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'Os segredos TOTP e client_secrets OIDC são armazenados em texto plano. Defina MFA_ENCRYPTION_KEY ou reinicie o PrintOps com um diretório de dados gravável para gerar automaticamente.',
      ...
      migrationErrorWarning: '{{count}} linha(s) antiga(s) não puderam ser recriptografadas na inicialização. Verifique os logs do servidor e reinicie o PrintOps para tentar novamente.',
    },
    ...
    documents: {
      ...
      status: { draft: 'Draft', scheduled: 'Scheduled', active: 'Active', superseded: 'Superseded', missingDraft: 'Sem rascunho' },
  ...
  hmsErrors: {
    ...
    runoutExpectedSlot: 'O filamento acabou em {{ranOut}}. A impressão agora espera filamento em {{expected}}.',
    runoutExpectedSlotOnly: 'O filamento acabou. A impressão agora espera filamento em {{expected}}.',
    runoutSlotUnknown: 'O filamento acabou. Verifique na impressora qual slot AMS é esperado.',
  ...
  login: {
    ...
    resetStep1: 'Entre em contato com o administrador do PrintOps',
    ...
    twoFA: {
      ...
      instructionsTotp: 'Abra seu aplicativo autenticador e insira o código de 6 dígitos gerado para o PrintOps.',
  ...
  // Setup page
  setup: {
    title: 'PrintOps Configuração',
    subtitle: 'Configure a autenticação para sua instância do PrintOps',
  ...
  camera: {
    ...
    diagnose: {
      ...
      info: {
        title: 'Detalhes da transmissão ao vivo',
        pipeline: 'Pipeline',
        codec: 'Codec de vídeo',
        resolution: 'Resolução',
        fps: 'FPS (alvo / medido)',
        bitrate: 'Taxa de bits',
        uptime: 'Tempo de atividade da transmissão',
        tlsProxy: 'Proxy TLS',
        go2rtcStream: 'Transmissão go2rtc',
        notActive: 'Nenhuma transmissão está ativa no momento para esta impressora.',
        pipelineName: {
          go2rtc: 'go2rtc (fonte RTSP, fornece MSE + MJPEG)',
          go2rtc_chamber_bridge: 'go2rtc (ponte de imagem da câmara, apenas MJPEG)',
          chamber_binary: 'Protocolo de imagem da câmara (binário proprietário)',
          external_mjpeg: 'Câmera externa (MJPEG, via go2rtc)',
          external_rtsp: 'Câmera externa (RTSP, via go2rtc)',
          external_snapshot: 'Câmera externa (captura HTTP, via go2rtc)',
          external_usb: 'Câmera externa (USB/v4l2, direta)',
        },
        player: 'Reprodutor',
        playerName: {
          mse: 'MSE (H.264, sem recodificação)',
  ...
  users: {
    ...
    subtitle: 'Gerenciar usuários e seu acesso à sua instância do PrintOps',
    backToSettings: 'Voltar para Configurações',
    createUser: 'Criar Usuário',
    noPermission: 'Você não tem permissão para acessar esta página.',
    admin: 'Administrador',
    ...
    form: {
      ...
      groups: 'Grupos',
      printerScope: 'Acesso às impressoras',
      allPrinters: 'Todas as impressoras',
      printerScopeCount: '{{count}} impressoras',
      optional: 'opcional',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Entre na sua conta Orca Cloud para sincronizar seus perfis de slicer no PrintOps.',
      },
      device: {
        title: 'Aprovar o PrintOps no Orca Cloud',
        instruction: 'Abra o Orca Cloud e aprove este código. O PrintOps se conecta automaticamente assim que você aprovar.',
    ...
    connectedAs: 'Conectado como',
    signInExpired: 'Seu login no Bambu Cloud expirou. Faça login novamente para usar predefinições da nuvem.',
    logout: 'Sair',
  ...
  support: {
    ...
    bugReportDestination: 'Destino do relatório de bugs',
    bugReportRelayConfigured: 'A criação automática de issues no GitHub está configurada',
    bugReportManualFallback: 'O formulário manual de issue do GitHub será usado',
    bugReportStatusLoading: 'Verificando a configuração de relatório de bugs...',
    bugReportStatusUnavailable: 'A configuração de relatório de bugs está indisponível no momento',
    openIssueForm: 'Abrir formulário de issue',
  ...
  sponsors: {
    ...
    tagline: 'O PrintOps é gratuito e continua assim porque há quem escolha apoiá-lo. Sem VC, sem dependência de nuvem.',
    viewSupporters: 'Ver apoiadores',
    toastPrints: 'Você concluiu {{count}} impressões com o PrintOps. O PrintOps continua gratuito graças a quem o apoia.',
    toastCost: 'Você acompanhou {{total}} de filamento com o PrintOps. Veja quem mantém o projeto independente.',
    toastArchives: '{{count}} impressões arquivadas com o PrintOps. Veja quem o mantém independente.',
    toastAnniversary: 'Um ano com o PrintOps! Veja quem mantém o projeto independente.',
    toastVersionUpdate: 'Atualizado para v{{version}}. O PrintOps continua gratuito graças a quem o apoia.',
  },
...
useEmbedded: 'Usar as configurações internas do arquivo',
    useEmbeddedHint: 'Fatia como o designer configurou (paredes, preenchimento, filamento), em vez dos perfis acima. Disponível porque sua impressora corresponde ao arquivo.',
  ...
  inventory: {
    ...
    bulk: {
      ...
      mergeTargetPrompt: 'ID da bobina de destino entre os IDs selecionados ({{ids}})',
      mergeInvalidTarget: 'Escolha um dos IDs de bobina selecionados como destino',
      mergeSuccess: '{{count}} bobinas duplicadas mescladas',
    ...
    refill: 'Reabastecer',
    refillPrompt: 'Peso reabastecido em gramas para a bobina #{{id}}',
    refillInvalidWeight: 'Digite um peso maior que 0 g',
    refillSuccess: 'Reabastecimento da bobina registrado',
    refillFailed: 'Falha ao registrar reabastecimento da bobina',
    spoolmanMixedContentTitle: 'Spoolman não pode carregar em HTTPS — conteúdo misto bloqueado pelo navegador',
    spoolmanMixedContentBody: 'O PrintOps é servido via HTTPS (pelo seu reverse proxy), mas a URL do Spoolman ainda é HTTP. Os navegadores bloqueiam conteúdo misto por segurança, então a interface embutida do Spoolman não consegue carregar. O Spoolman também precisa estar acessível via HTTPS.',
    spoolmanMixedContentFixReverseProxy: 'Coloque o Spoolman atrás do mesmo reverse proxy do PrintOps (Traefik / Nginx / Caddy) com HTTPS e atualize a URL do Spoolman em Configurações com o novo endereço HTTPS.',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'O repositório está PÚBLICO. Os backups do PrintOps incluem credenciais MQTT, tokens do Home Assistant, tokens do Prometheus, seu e-mail do Bambu Cloud e os códigos de acesso das impressoras via K-profiles. Salvar está bloqueado até que você torne o repositório privado nas configurações do seu provedor.',
    repoVisibilityUnknown: 'Não foi possível determinar a visibilidade do repositório. O PrintOps se recusa a fazer backup em qualquer destino não confirmado como privado; salvar será bloqueado.',
    ...
    appSettingsDescription: 'Configuração do PrintOps (banco de dados completo)',
    ...
    localBackupDescription: 'Crie um backup completo dos seus dados do PrintOps incluindo banco de dados, arquivos, uploads e todos os ficheiros.',
    ...
    backupRestoredRestart: 'Backup restaurado. Por favor, reinicie o PrintOps.',
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'As notas são salvas no PrintOps, não na impressora',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visível como "PrintOps" na descoberta do slicer',
    ...
    remoteInterface: {
      ...
      hint: 'Substitua o endereço IP anunciado via SSDP e usado no certificado TLS. Útil quando o PrintOps possui várias interfaces de rede.',
    },
    mode: {
      title: 'Modo',
      archive: 'Arquivar',
    ...
    caCert: {
      ...
      description: 'As impressoras virtuais usam um certificado TLS assinado pela CA do PrintOps. Importe este certificado CA para o armazenamento de confiança do seu slicer uma única vez para que ele aceite a conexão — sem precisar copiá-lo pela linha de comando.',
      copy: 'Copiar',
      copied: 'Copiado',
      download: 'Baixar',
      fingerprint: 'SHA-256',
  ...
  haSensors: {
    ...
    blockPrintHint: 'Os trabalhos permanecem na fila até o sensor normalizar. Se o Home Assistant estiver inacessível, vale a estratégia de falha escolhida.',
    safeState: 'Estado seguro: {{state}}',
    failureStrategyLabel: 'Quando o Home Assistant está indisponível',
    failureAuto: 'Automático (sensores críticos bloqueiam)',
    failureOpen: 'Permitir impressão (fail-open)',
    failureClosed: 'Reter impressão (fail-closed)',
    failureStrategyHint: 'Sensores de segurança críticos retêm a fila sem uma leitura recente.',
    primarySafetyWarning: 'Os interlocks do PrintOps são controles secundários. Mantenha proteção física independente.',
    failure: {
      auto: 'Falha: automática',
      fail_open: 'Falha: permitir impressão',
      fail_closed: 'Falha: reter impressão',
    },
    override: {
      unavailable: 'Interlock fail-closed indisponível: {{sensors}}',
      open: 'Ignorar temporariamente',
      reasonLabel: 'Motivo da substituição temporária',
      confirm: 'Confirmar substituição',
      clear: 'Restaurar interlock',
      active: 'Substituição ativa por {{user}}: {{reason}}',
      unknownUser: 'usuário desconhecido',
      error: 'Não foi possível alterar a substituição do interlock.',
    },
    toast: {
  ...
  smartPlugs: {
    ...
    linkTarget: 'Destino do vínculo',
    noTarget: 'Sem destino (apenas controle manual)',
    targetPrinter: 'Impressora',
    targetDryer: 'Secador de filamento',
    selectPrinter: 'Selecionar impressora',
    selectDryer: 'Selecionar secador de filamento',
    ...
    restEnergyTotalPath: 'Caminho JSON de energia total',
    restEnergyTotalMultiplier: 'Multiplicador de energia total',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      bark: 'Notificações push iOS sem conta via Bark',
    ...
    barkGroup: 'Grupo',
    barkSound: 'Som',
    barkLevel: 'Nível de interrupção',
    barkLevelDefault: 'Padrão',
    barkLevelPassive: 'Passivo',
    barkLevelActive: 'Ativo',
    barkLevelTimeSensitive: 'Sensível ao tempo',
  ...
  externalLinks: {
    ...
    systemPages: 'Páginas do PrintOps',
    ...
    showParentFirst: 'Mostrar {{parent}} primeiro',
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      backendUrl: 'URL do backend PrintOps',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'O PrintOps está sendo executado em rede Docker bridge. A descoberta de impressoras e a impressora virtual precisam do modo de rede host — recrie o contêiner com "network_mode: host".',
        skip: 'Não está sendo executado no Docker — não aplicável.',
      },
      subnet: {
        title: 'Sub-rede',
        pass: 'A impressora e o PrintOps estão na mesma sub-rede.',
        warn: 'A impressora ({{printer_ip}}) e o PrintOps ({{host_ip}}) estão em sub-redes diferentes. Eles podem não se alcançar, a menos que o roteamento entre as sub-redes esteja configurado.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Copie novamente o código de acesso da tela da impressora (configurações de LAN) e atualize-o nas configurações da impressora no PrintOps.',
      },
      'ftp-connection-timeout': {
        name: 'Tempo limite da conexão de transferência de arquivos',
        cause: 'O PrintOps não conseguiu acessar a porta de transferência de arquivos da impressora (FTPS 990). A porta está bloqueada, ou a impressora está desligada ou em outra sub-rede.',
        fix: 'Verifique se nada bloqueia a porta 990 entre o PrintOps e a impressora e se ambos estão na mesma rede.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Migre o PrintOps para um banco de dados PostgreSQL externo. Consulte o guia do PostgreSQL na documentação.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'A impressora virtual está habilitada, mas seus serviços não estão em execução. Verifique o log do PrintOps — geralmente um conflito de IP de vínculo ou um erro de permissão os interrompe.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificado pronto. Verifique se o certificado CA do PrintOps (acima) está importado no armazenamento de confiança do seu slicer.',
        fail: 'O certificado TLS desta impressora virtual está ausente. Verifique se o diretório de dados do PrintOps tem permissão de escrita.',
      },
    },
  },
  ...
  bugReport: {
    ...
    manualReportTitle: 'Relatar pelo GitHub',
    manualReportDescription: 'O PrintOps usa o formulário público de issues do GitHub para relatórios de erro. Isso evita configurar um relay por instalação e mantém você no controle dos dados enviados.',
    openIssueForm: 'Abrir issue no GitHub',
  ...
  failureDetection: {
    ...
    mlTokenPlaceholder: 'Deixe vazio se o servidor rodar sem ML_API_TOKEN',
    mlTokenHint: 'Deve corresponder à variável ML_API_TOKEN do contêiner Obico ml_api. Deixe vazio quando o contêiner não usar uma.',
    test: 'Testar',
    testSuccess: 'API ML acessível e operacional.',
    testSuccessTokenUnknown: 'A API ML está acessível e saudável. O token não pôde ser verificado.',
    ...
    externalUrlHint: 'A API ML busca a captura da câmera por URL. Defina a URL externa nas configurações gerais para que o contêiner da API ML possa alcançar o PrintOps.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Cole uma URL de modelo do MakerWorld para importar e imprimir diretamente do PrintOps — sem precisar abrir o app Bambu Handy.',
    ...
    disclaimer: 'A integração com o MakerWorld usa endpoints de API documentados pela comunidade. PrintOps não é afiliado nem endossado pelo MakerWorld ou pela Bambu Lab.',
  ...
  libraryPurge: {
    ...
    effect4: 'Arquivos em pastas externas (vinculadas) são ignorados — PrintOps nunca exclui bytes que não possui.',    previewLoading: 'Verificando quantos arquivos correspondem…',
