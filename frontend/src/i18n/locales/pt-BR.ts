export default {
  ...
  bugReport: {
    ...
    manualFallbackTitle: 'O envio automático não está configurado',
    manualFallbackDescription: 'Esta instalação não consegue enviar relatórios de erro diretamente ao GitHub. Abra o formulário de issue do GitHub e cole sua descrição lá.',
