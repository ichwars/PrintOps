export default {
  orderUiNotFound: 'The record was not found.',
  ...
  orders: {
    ...
    customers: {
      title: 'Customers',
      subtitle: 'Customer master data for the selected business profile.',
      businessProfile: 'Business profile',
      loading: 'Loading customers...',
      error: 'Unable to load customers.',
      noBusinessProfile: 'No active business profile is available.',
      empty: 'No customers yet.',
      customer: 'Customer',
      discount: 'Discount',
      permissionDenied: 'You do not have permission to view customers.',
      configureProfiles: 'Configure business profiles', add: 'Add customer', search: 'Search customers', statusFilter: 'Customer status', kindFilter: 'Customer kind', emptyFiltered: 'No customers match the current filters.',
      number: 'Number', name: 'Name', primaryContact: 'Primary contact', billingAddress: 'Billing address', actions: 'Actions',
      view: 'View details', viewAria: 'View {{name}}', editCustomer: 'Edit customer', editAria: 'Edit {{name}}', deleteCustomer: 'Delete customer', deleteAria: 'Delete {{name}}', deleteTitle: 'Delete {{name}}?', deleteConfirm: 'This customer will be permanently deleted.',
      pagination: '{{start}}-{{end}} of {{total}}', previous: 'Previous page', next: 'Next page',
    },
    customerEditor: {
      title: 'Customer editor', loading: 'Loading customer editor', loadError: 'Unable to load the customer editor.',
      createTitle: 'Add customer', editTitle: 'Edit customer', kind: 'Customer kind',
      company: 'Company',
      person: 'Person',
      identity: 'Identity', displayName: 'Display name', companyName: 'Company name', firstName: 'First name', lastName: 'Last name',
      accounts: 'Profile accounts', addAccount: 'Add account', removeAccount: 'Remove account {{number}}', accountProfile: 'Account profile', customerNumber: 'Customer number', currency: 'Currency', paymentDays: 'Payment days', deliveryTerms: 'Delivery terms', discount: 'Discount', activeAccount: 'Active account',
      contacts: 'Contacts', addContact: 'Add contact', removeContact: 'Remove contact {{number}}', salutation: 'Salutation', contactFirstName: 'Contact first name', contactLastName: 'Contact last name', contactRole: 'Contact role', contactEmail: 'Contact email', contactPhone: 'Contact phone', primaryContact: 'Primary contact', includeContact: 'Include contact', onDocuments: 'on documents', includeDocuments: 'Include on documents',
      addresses: 'Addresses', addAddress: 'Add address', removeAddress: 'Remove address {{number}}', addressKindLabel: 'Address kind', addressKind: { billing: 'Billing', delivery: 'Delivery', other: 'Other' }, addressLabel: 'Address label', additional: 'Additional', street: 'Street', street2: 'Street 2', postalCode: 'Postal code', city: 'City', region: 'Region', country: 'Country', defaultAddress: 'Default address',
      taxIdentifiers: 'Tax identifiers', addTax: 'Add tax identifier', removeTax: 'Remove tax identifier {{number}}', taxKind: 'Tax identifier kind', taxValue: 'Tax identifier value', taxCountry: 'Tax country', validationStatus: 'Validation status',
      preferences: 'Preferences', locale: 'Locale', tags: 'Tags', notes: 'Notes', required: 'Required', reload: 'Reload current data', save: 'Save customer',
    },
    customerDetails: { title: 'Customer details', loading: 'Loading customer details', loadError: 'Unable to load customer details.', paymentDays: '{{count}} payment days', created: 'Created {{date}}', updated: 'Updated {{date}}' },
  ...
  printers: {
    ...
    camWall: {
      ...
      page: {
        tokenRejected: 'This Cam Wall token was rejected or has expired.',
        loadFailed: 'Failed to load the Cam Wall.',
      },
    },
    // Controls
    ...
    maintenance: {
      ...
      editFieldHelp: 'When on, this printer is paused from MQTT, queue dispatch and notifications — useful for repair, parallel PrintOps installs, or temporary suspension.',
    },
    // Chamber light
    ...
    expectedSlot: {
      ...
      label: '{{ams}} · Slot {{slot}}',
      title: 'The paused print expects filament here',
      ariaLabel: 'Expected replacement slot {{n}}',
    },
    // Filaments section
    filaments: 'Filaments',
    // Camera
  ...
  archives: {
    ...
    no3mfBanner: {
      ...
      body: 'The slicer didn\'t leave the .gcode.3mf on the printer\'s SD card, so PrintOps couldn\'t pull the thumbnail or slicer metadata. This is usually because "Store sent files on external storage" is off in the slicer (Bambu Studio / OrcaSlicer Device tab).',
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedNotice: 'Cannot queue {{runs}} of the {{owed}} runs still owed: that plate has no run left to copy settings from. Queue the plate once from the file, or cancel the batch.',
    ...
    cancelBatchConfirmMessage: 'Close this batch? Any runs still queued are cancelled and its unproduced quantities are discarded.',
    batch: {
      defaultName: 'Batch',
      label: '{{count}} item',
    ...
    toast: {
      ...
      keptForOrder: 'Not removed: “{{name}}” still needs this run as its only reusable plate template',
      historyKeptForOrders: 'Kept {{kept}} templates that open batches still need.',
  ...
  stats: {
    title: 'Dashboard',
    subtitle: 'Operational overview for printers, throughput, filament, costs, and print quality.',
    overview: 'Overview',
    ...
    energySource: {
      smartPlugLive: 'Smart plug live total',
      smartPlugSnapshots: 'Smart plug snapshots',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'LDAP groups are mapped to PrintOps groups on login',
      ...
      autoProvisionHint: 'Automatically create a PrintOps account on first LDAP login',
      ...
      groupMappingHint: 'Map LDAP group DNs to PrintOps groups. Available groups: ',
    ...
    localLogin: {
      ...
      disableHint: 'When enabled, only SSO providers can sign in. LDAP is unaffected. Set PRINTOPS_LOCAL_LOGIN=true on the server to keep a recovery path.',
    },
    // Queue
    ...
    preheatFilamentTargetsHint: 'PrintOps picks the highest target across the loaded AMS slots; PLA-only prints derive 0 and skip the chamber phase automatically.',
    ...
    authDisabledMessage: 'Enable authentication to create user accounts, manage permissions, and secure your PrintOps instance.',
    ...
    disableAuthenticationMessage: 'Are you sure you want to disable authentication? This will make your PrintOps instance accessible without login. All users will remain in the database but authentication will be disabled.',
    disableAuthentication: 'Disable Authentication',
    // Additional settings
    configurePrintOps: 'Configure PrintOps',
    ...
    progressInTitle: 'Show print progress in browser tab',
    progressInTitleHint: 'When a printer is running, the tab title and favicon show the active print percentage.',
    // Archive
    ...
    cameraUrlBuilderToggle: 'Build URL from host, port and path',
    cameraUrlBuilderHost: 'Host or IP',
    cameraUrlBuilderPort: 'Port',
    cameraUrlBuilderPath: 'Path (e.g. /stream)',
    cameraUrlBuilderUsername: 'Username (optional)',
    cameraUrlBuilderPassword: 'Password (optional)',
    cameraUrlBuilderHelp: 'Fills in the camera URL field above. It is still validated and tested the same way as a manually entered URL.',
    ...
    updateViaHomeAssistant: 'Updates are managed by the Home Assistant Supervisor. Open Settings → Add-ons → PrintOps in Home Assistant to install the new version.',
    ...
    mqttDescription: 'Publish PrintOps events to an external MQTT broker for integration with Node-RED, Home Assistant, and other automation systems.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'TOTP secrets and OIDC client_secrets are stored in plaintext. Set MFA_ENCRYPTION_KEY or restart PrintOps with a writable data directory to auto-generate one.',
      ...
      migrationErrorWarning: '{{count}} legacy row(s) failed to re-encrypt at startup. Check server logs and restart PrintOps to retry.',
    },
  ...
  hmsErrors: {
    ...
    runoutExpectedSlot: 'Filament ran out in {{ranOut}}. The print now expects filament in {{expected}}.',
    runoutExpectedSlotOnly: 'Filament ran out. The print now expects filament in {{expected}}.',
    runoutSlotUnknown: 'Filament ran out. Check the printer to see which AMS slot is expected.',
  ...
  camera: {
    ...
    overlayToggle: 'Toggle temperature overlay',
    ...
    diagnose: {
      ...
      info: {
        ...
        fps: 'FPS (target / measured)',
        bitrate: 'Bitrate',
        uptime: 'Stream uptime',
        tlsProxy: 'TLS proxy',
        go2rtcStream: 'go2rtc stream',
        notActive: 'No stream is currently active for this printer.',
        pipelineName: {
          go2rtc: 'go2rtc (RTSP source, serves MSE + MJPEG)',
          go2rtc_chamber_bridge: 'go2rtc (chamber-image bridge, MJPEG only)',
          chamber_binary: 'Chamber-image protocol (proprietary binary)',
          external_mjpeg: 'External camera (MJPEG, via go2rtc)',
          external_rtsp: 'External camera (RTSP, via go2rtc)',
          external_snapshot: 'External camera (HTTP snapshot, via go2rtc)',
          external_usb: 'External camera (USB/v4l2, direct)',
        },
        player: 'Player',
        playerName: {
          mse: 'MSE (H.264, no re-encode)',
  ...
  users: {
    ...
    subtitle: 'Manage users and their access to your PrintOps instance',
    backToSettings: 'Back to Settings',
    createUser: 'Create User',
    noPermission: 'You do not have permission to access this page.',
    admin: 'Admin',
    ...
    form: {
      ...
      groups: 'Groups',
      printerScope: 'Printer access',
      allPrinters: 'All printers',
      printerScopeCount: '{{count}} printers',
      optional: 'optional',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Sign in to your Orca Cloud account to sync your slicer profiles into PrintOps.',
      },
      device: {
        title: 'Approve PrintOps in Orca Cloud',
        instruction: 'Open Orca Cloud and approve this code. PrintOps connects automatically once you approve.',
    ...
    connectedAs: 'Connected as',
    signInExpired: 'Your Bambu Cloud sign-in has expired. Sign in again to use cloud presets.',
    logout: 'Logout',
  ...
  sponsors: {
    ...
    tagline: 'PrintOps is free and stays that way because people choose to support it. No VC, no cloud lock-in.',
    viewSupporters: 'View supporters',
    toastPrints: "You've completed {{count}} prints with PrintOps. PrintOps stays free thanks to its supporters.",
    toastCost: "You've tracked {{total}} in filament with PrintOps. See who keeps the project independent.",
    toastArchives: '{{count}} prints archived with PrintOps. See who keeps it independent.',
    toastAnniversary: 'One year with PrintOps! See who keeps the project independent.',
    toastVersionUpdate: 'Updated to v{{version}}. PrintOps stays free thanks to its supporters.',
  },
  ...
  slice: {
    title: 'Slice model',
    stepUnsupported: 'Slicing not supported',
    stepUnsupportedHint: 'STEP/STP files cannot be sliced on the server - the slicer cannot import them. Convert the model to STL or 3MF to slice it here.',
    action: 'Slice',
  ...
  inventory: {
    ...
    bulk: {
      ...
      mergeTargetPrompt: 'Target spool ID from selected IDs ({{ids}})',
      mergeInvalidTarget: 'Choose one of the selected spool IDs as target',
      mergeSuccess: '{{count}} duplicate spools merged',
      mergeFailed: 'Merge failed',
      invalidHex: 'Enter 6 hex characters (RRGGBB) or 8 (RRGGBBAA). The field will not be applied otherwise.',
    },
    refill: 'Refill',
    refillPrompt: 'Added refill weight in grams for spool #{{id}}',
    refillInvalidWeight: 'Enter a weight greater than 0g',
    refillSuccess: 'Spool refill recorded',
    refillFailed: 'Spool refill failed',
    spoolmanMixedContentTitle: 'Spoolman can\'t load over HTTPS — mixed-content blocked by your browser',
    spoolmanMixedContentBody: 'PrintOps is served over HTTPS (via your reverse proxy), but your Spoolman URL is still plain HTTP. Browsers block mixed content for security, so the embedded Spoolman UI can\'t render. Spoolman needs to be reachable over HTTPS for this to work.',
    spoolmanMixedContentFixReverseProxy: 'Put Spoolman behind the same reverse proxy as PrintOps (Traefik / Nginx / Caddy) with HTTPS, then update the Spoolman URL in Settings to the new HTTPS address.',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'Repository is PUBLIC. PrintOps backups include MQTT credentials, Home Assistant tokens, Prometheus tokens, your Bambu Cloud email, and printer access codes via K-profiles. Saving is blocked until you make the repository private in your provider\'s settings.',
    repoVisibilityUnknown: 'Could not determine repository visibility. PrintOps refuses to back up to anything not confirmed private; saving will be blocked.',
    ...
    appSettingsDescription: 'PrintOps configuration (complete database)',
    ...
    localBackupDescription: 'Create a complete backup of your PrintOps data including the database, archives, uploads, and all files.',
    ...
    backupRestoredRestart: 'Backup restored. Please restart PrintOps.',
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Notes are saved in PrintOps, not on the printer',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visible as "PrintOps" in slicer discovery',
    ...
    remoteInterface: {
      ...
      hint: 'Override the IP address advertised via SSDP and used in the TLS certificate. Useful when PrintOps has multiple network interfaces.',
    },
    mode: {
      title: 'Mode',
      archive: 'Archive',
    ...
    caCert: {
      ...
      description: 'Virtual printers use a TLS certificate signed by the PrintOps CA. Import this CA certificate into your slicer\'s trust store once so it accepts the connection — no need to copy it from the command line.',
      copy: 'Copy',
      copied: 'Copied',
      download: 'Download',
      fingerprint: 'SHA-256',
    ...
    howItWorks: {
      ...
      step2: 'In Archive, Review, and Queue modes, use the "Send" button in your slicer to upload 3MF files to PrintOps. The slicer will show "Print success" — the file is stored, not printed.',
  ...
  smartPlugs: {
    ...
    noTarget: 'No target (manual control only)',
    targetPrinter: 'Printer',
    targetDryer: 'Filament dryer',
    selectPrinter: 'Select printer',
    selectDryer: 'Select filament dryer',
    ...
    restEnergyTotalPath: 'Total Energy JSON Path',
    restEnergyTotalMultiplier: 'Total Energy Multiplier',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      bark: 'Account-free iOS push notifications via Bark',
  ...
  externalLinks: {
    ...
    mainPage: 'Main page',
    childPageOf: 'Child page of {{parent}}',
    hiddenByParent: 'Hidden through {{parent}}',
    showParentFirst: 'Show {{parent}} first',
    hidePage: 'Hide page',
    showPage: 'Show page',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'PrintOps is running in Docker bridge networking. Printer discovery and the Virtual Printer need host network mode — recreate the container with "network_mode: host".',
        skip: 'Not running in Docker — not applicable.',
      },
      subnet: {
        title: 'Network subnet',
        pass: 'The printer and PrintOps are on the same subnet.',
        warn: 'The printer ({{printer_ip}}) and PrintOps ({{host_ip}}) are on different subnets. They may not reach each other unless routing between the subnets is configured.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Re-copy the access code from the printer screen (LAN settings) and update it in the printer\'s settings in PrintOps.',
      },
      'ftp-connection-timeout': {
        name: 'File-transfer connection timed out',
        cause: 'PrintOps could not reach the printer\'s file-transfer port (FTPS 990). The port is blocked, or the printer is off or on another subnet.',
        fix: 'Make sure nothing blocks port 990 between PrintOps and the printer, and that both are on the same network.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Switch PrintOps to an external PostgreSQL database. See the PostgreSQL guide in the documentation.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'The virtual printer is enabled but its services are not running. Check the PrintOps log — a bind IP conflict or a permission error usually stops them.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificate ready. Make sure the PrintOps CA certificate (above) is imported into your slicer\'s trust store.',
        fail: 'The TLS certificate for this virtual printer is missing. Check that the PrintOps data directory is writable.',
      },
    },
  },
  ...
  bugReport: {
    ...
    manualReportTitle: 'Report through GitHub',
    manualReportDescription: 'PrintOps uses the public GitHub issue form for bug reports. This avoids per-installation relay setup and keeps the submitted details under your control.',
    openIssueForm: 'Open GitHub issue',
  ...
  failureDetection: {
    ...
    externalUrlHint: 'The ML API fetches the camera snapshot by URL. Set the External URL in General settings so the ML API container can reach PrintOps.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Paste a MakerWorld model URL to import and print it directly from PrintOps — without leaving for the Bambu Handy app.',
    ...
    disclaimer: 'MakerWorld integration uses community-documented API endpoints. PrintOps is not affiliated with or endorsed by MakerWorld or Bambu Lab.',
  ...
  libraryPurge: {
    ...
    effect4: 'Files in external (linked) folders are skipped — PrintOps never deletes bytes it does not own.',
