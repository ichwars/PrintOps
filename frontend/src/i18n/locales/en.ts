export default {
  ...
  bugReport: {
    ...
    manualFallbackTitle: 'Automatic reporting is not configured',
    manualFallbackDescription: 'This installation cannot send bug reports directly to GitHub. Open the GitHub issue form instead and paste your description there.',
