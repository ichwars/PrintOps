export default {
  orderUiNotFound: 'Enregistrement introuvable.',
  ...
  nav: {
    ...
    installAppSuccess: 'PrintOps a été installé',
  },
  ...
  printers: {
    ...
    camWall: {
      ...
      page: {
        tokenRejected: 'Ce jeton de mur de caméras a été refusé ou a expiré.',
        loadFailed: 'Impossible de charger le mur de caméras.',
      },
    },
    // Controls
    ...
    maintenance: {
      ...
      editFieldHelp: "Quand activé, cette imprimante est mise en pause de MQTT, de la file d'attente et des notifications — utile pour les réparations, les installations PrintOps parallèles ou une suspension temporaire.",
    },
    // Chamber light
    ...
    expectedSlot: {
      ...
      title: 'L\'impression en pause attend le filament ici',
      ariaLabel: 'Emplacement de remplacement attendu {{n}}',
    },
    // Filaments section
    filaments: 'Filaments',
    // Camera
  ...
  archives: {
    ...
    no3mfBanner: {
      ...
      body: 'Le slicer n\'a pas laissé le fichier .gcode.3mf sur la carte SD de l\'imprimante, donc PrintOps n\'a pas pu récupérer la miniature ni les métadonnées slicer. C\'est généralement parce que « Stocker les fichiers envoyés sur stockage externe » est désactivé dans le slicer (onglet Périphérique de Bambu Studio / OrcaSlicer).',
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedNotice: 'Impossible de mettre en file {{runs}} des {{owed}} impressions dues : cette plaque n’a plus d’exécution dont copier les réglages. Ajoutez-la depuis le fichier ou annulez le lot.',
    ...
    cancelBatchConfirmMessage: 'Clôturer ce lot ? Les impressions en file seront annulées et les quantités non produites seront abandonnées.',
    batch: {
      defaultName: 'Lot',
      label: '{{count}} élément',
    ...
    toast: {
      ...
      keptForOrder: 'Non retiré : « {{name}} » a encore besoin de cette impression comme unique modèle réutilisable de la plaque',
      historyKeptForOrders: '{{kept}} modèles requis par des lots ouverts ont été conservés.',
  ...
  stats: {
    ...
    energySource: {
      smartPlugLive: 'Total en direct de la prise connectée',
      smartPlugSnapshots: 'Instantanés de la prise connectée',
      printLogs: 'Journaux des impressions',
    },
  ...
  settings: {
    ...
    tabs: {
      general: 'Général',
      usersSecurity: 'Utilisateurs et sécurité',
      printersProduction: 'Imprimantes et production',
      projectsFiles: 'Projets et fichiers',
      warehouseMaterial: 'Entrepôt et matériaux',
      ordersCalculation: 'Commandes et calcul',
    ...
    ldap: {
      ...
      feature3: 'Les groupes LDAP sont associés aux groupes PrintOps à la connexion',
      ...
      autoProvisionHint: 'Créer automatiquement un compte PrintOps lors de la première connexion LDAP',
      ...
      groupMappingHint: 'Associer les DN de groupes LDAP aux groupes PrintOps. Groupes disponibles : ',
    ...
    localLogin: {
      ...
      disableHint: 'Quand activée, seuls les fournisseurs SSO peuvent se connecter. LDAP n\'est pas affecté. Définissez PRINTOPS_LOCAL_LOGIN=true sur le serveur pour conserver une voie de récupération.',
    },
    // Queue
    ...
    preheatFilamentTargetsHint: 'PrintOps choisit la cible la plus haute parmi les slots AMS chargés ; les impressions PLA uniquement dérivent 0 et sautent la phase chambre automatiquement.',
    ...
    // Additional settings
    configurePrintOps: 'Configurer PrintOps',
    ...
    noticePreferences: 'Avis',
    showDeveloperLanWarning: 'Afficher avertissement Developer LAN',
    showDeveloperLanWarningDesc: 'Afficher un avertissement en haut de app quand une imprimante connectee n a pas le mode Developer LAN actif.',
    showSponsorPrompts: 'Afficher les avis de soutien',
    showSponsorPromptsDesc: 'Afficher des avis occasionnels sur les soutiens et le financement communautaire de PrintOps.',
    ...
    progressInTitle: 'Afficher la progression dans l\'onglet',
    progressInTitleHint: 'Lorsqu\'une imprimante fonctionne, le titre de l\'onglet et le favicon affichent le pourcentage actif.',
    ...
    cameraUrlBuilderToggle: 'Construire l’URL à partir de l’hôte, du port et du chemin',
    cameraUrlBuilderHost: 'Hôte ou IP',
    cameraUrlBuilderPort: 'Port',
    cameraUrlBuilderPath: 'Chemin (ex. /stream)',
    cameraUrlBuilderUsername: 'Nom d’utilisateur (optionnel)',
    cameraUrlBuilderPassword: 'Mot de passe (optionnel)',
    cameraUrlBuilderHelp: 'Remplit le champ URL caméra ci-dessus. Elle est validée et testée de la même façon qu’une URL saisie manuellement.',
    ...
    printopsSoftware: 'Logiciel PrintOps',
    ...
    updateViaHomeAssistant: 'Les mises à jour sont gérées par le superviseur Home Assistant. Ouvrez Paramètres → Modules complémentaires → PrintOps dans Home Assistant pour installer la nouvelle version.',
    ...
    externalUrlDescription: 'L\'URL externe où PrintOps est accessible. Utilisée pour les images de notification et les intégrations externes.',
    ...
    mqttDescription: 'Publier les événements PrintOps vers un broker MQTT externe pour l\'intégration avec Node-RED, Home Assistant et d\'autres systèmes d\'automatisation.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'Les secrets TOTP et client_secrets OIDC sont stockés en clair. Définissez MFA_ENCRYPTION_KEY ou redémarrez PrintOps avec un répertoire de données accessible en écriture pour en générer un automatiquement.',
      ...
      migrationErrorWarning: "{{count}} ligne(s) ancienne(s) n'ont pas pu être rechiffrée(s) au démarrage. Vérifiez les journaux du serveur et redémarrez PrintOps pour réessayer.",
    },
    ...
    documents: {
      ...
      status: { draft: 'Draft', scheduled: 'Scheduled', active: 'Active', superseded: 'Superseded', missingDraft: 'Aucun brouillon' },
  ...
  hmsErrors: {
    ...
    runoutExpectedSlot: 'Le filament est épuisé dans {{ranOut}}. L\'impression attend maintenant le filament dans {{expected}}.',
    runoutExpectedSlotOnly: 'Le filament est épuisé. L\'impression attend maintenant le filament dans {{expected}}.',
    runoutSlotUnknown: 'Le filament est épuisé. Vérifiez sur l\'imprimante quel emplacement AMS est attendu.',
  ...
  login: {
    ...
    resetStep1: 'Contactez votre admin PrintOps',
    ...
    twoFA: {
      ...
      instructionsTotp: "Ouvrez votre application d'authentification et saisissez le code à 6 chiffres pour PrintOps.",
  ...
  camera: {
    ...
    diagnose: {
      ...
      info: {
        ...
        fps: 'FPS (cible / mesuré)',
        bitrate: 'Débit binaire',
        uptime: 'Durée du flux',
        tlsProxy: 'Proxy TLS',
        go2rtcStream: 'Flux go2rtc',
        notActive: "Aucun flux n'est actuellement actif pour cette imprimante.",
        pipelineName: {
          go2rtc: 'go2rtc (source RTSP, sert MSE + MJPEG)',
          go2rtc_chamber_bridge: 'go2rtc (pont image de chambre, MJPEG uniquement)',
          chamber_binary: 'Protocole image de chambre (binaire propriétaire)',
          external_mjpeg: 'Caméra externe (MJPEG, via go2rtc)',
          external_rtsp: 'Caméra externe (RTSP, via go2rtc)',
          external_snapshot: 'Caméra externe (instantané HTTP, via go2rtc)',
          external_usb: 'Caméra externe (USB/v4l2, directe)',
        },
        player: 'Lecteur',
        playerName: {
          mse: 'MSE (H.264, sans réencodage)',
          mjpeg: 'MJPEG (repli)',
  ...
  users: {
    ...
    subtitle: 'Gérez les accès à PrintOps',
    backToSettings: 'Retour aux paramètres',
    createUser: 'Créer un utilisateur',
    noPermission: 'Accès refusé.',
    admin: 'Administrateur',
    ...
    form: {
      ...
      groups: 'Groupes',
      printerScope: 'Accès aux imprimantes',
      allPrinters: 'Toutes les imprimantes',
      printerScopeCount: '{{count}} imprimantes',
      optional: 'optionnel',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Connectez-vous à votre compte Orca Cloud pour synchroniser vos profils de slicer dans PrintOps.',
      },
      device: {
        title: 'Approuver PrintOps dans Orca Cloud',
        instruction: 'Ouvrez Orca Cloud et approuvez ce code. PrintOps se connecte automatiquement dès que vous l\'approuvez.',
    ...
    connectedAs: 'Connecté en tant que',
    signInExpired: 'Votre connexion Bambu Cloud a expiré. Reconnectez-vous pour utiliser les préréglages cloud.',
    logout: 'Déconnexion',
  ...
  sponsors: {
    ...
    tagline: 'PrintOps est gratuit et le reste parce que des personnes choisissent de le soutenir. Pas de VC, pas de verrouillage cloud.',
    viewSupporters: 'Voir les soutiens',
    toastPrints: 'Tu as terminé {{count}} impressions avec PrintOps. PrintOps reste gratuit grâce à ceux qui le soutiennent.',
    toastCost: 'Tu as suivi {{total}} de filament avec PrintOps. Vois qui garde le projet indépendant.',
    toastArchives: '{{count}} impressions archivées avec PrintOps. Vois qui le garde indépendant.',
    toastAnniversary: 'Un an avec PrintOps ! Vois qui garde le projet indépendant.',
    toastVersionUpdate: 'Mis à jour vers v{{version}}. PrintOps reste gratuit grâce à ceux qui le soutiennent.',
  },
...
useEmbeddedHint: 'Découpe comme le concepteur l\'a configuré (parois, remplissage, filament) au lieu des profils ci-dessus. Disponible car votre imprimante correspond au fichier.',
  ...
  inventory: {
    ...
    bulk: {
      ...
      mergeTargetPrompt: 'ID de bobine cible parmi les ID sélectionnés ({{ids}})',
      mergeInvalidTarget: 'Choisissez une des bobines sélectionnées comme cible',
      mergeSuccess: '{{count}} bobines en double fusionnées',
    ...
    refill: 'Recharger',
    refillPrompt: 'Poids ajouté en grammes pour la bobine #{{id}}',
    refillInvalidWeight: 'Saisissez un poids supérieur à 0 g',
    refillSuccess: 'Recharge de bobine enregistrée',
    refillFailed: 'Échec de la recharge de bobine',
    spoolmanMixedContentTitle: 'Spoolman ne peut pas se charger en HTTPS — contenu mixte bloqué par votre navigateur',
    spoolmanMixedContentBody: 'PrintOps est servi en HTTPS (via votre reverse proxy), mais votre URL Spoolman est encore en HTTP. Les navigateurs bloquent le contenu mixte pour des raisons de sécurité, donc l\'interface Spoolman intégrée ne peut pas s\'afficher. Spoolman doit être accessible en HTTPS.',
    spoolmanMixedContentFixReverseProxy: 'Placez Spoolman derrière le même reverse proxy que PrintOps (Traefik / Nginx / Caddy) en HTTPS, puis mettez à jour l\'URL Spoolman dans les Paramètres avec la nouvelle adresse HTTPS.',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'Le dépôt est PUBLIC. Les sauvegardes PrintOps contiennent les identifiants MQTT, les jetons Home Assistant, les jetons Prometheus, votre adresse Bambu Cloud, et les codes d\'accès des imprimantes via les K-profils. L\'enregistrement est bloqué tant que le dépôt n\'est pas passé en privé dans les paramètres de votre hébergeur.',
    repoVisibilityUnknown: 'Impossible de déterminer la visibilité du dépôt. PrintOps refuse toute sauvegarde vers un dépôt non confirmé privé ; l\'enregistrement sera bloqué.',
    ...
    appSettingsDescription: 'Configuration PrintOps (base de données complète)',
    ...
    localBackupDescription: 'Créez une sauvegarde complète de vos données PrintOps incluant la base de données, les archives, les téléchargements et tous les fichiers.',
    ...
    backupRestoredRestart: 'Sauvegarde restaurée. Veuillez redémarrer PrintOps.',
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Enregistré dans PrintOps, pas sur l\'imprimante',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visible comme "PrintOps" dans le Slicer',
    ...
    howItWorks: {
      ...
      step2: 'En mode Archive, Revue et File d\'attente, utilisez le bouton "Envoyer" dans votre slicer pour envoyer des fichiers 3MF à PrintOps. Le slicer affichera "Impression réussie" — le fichier est stocké, pas imprimé.',
    ...
    caCert: {
      ...
      description: 'Les imprimantes virtuelles utilisent un certificat TLS signé par l\'autorité de certification PrintOps. Importez ce certificat CA dans le magasin de confiance de votre slicer une seule fois pour qu\'il accepte la connexion — plus besoin de le copier depuis la ligne de commande.',
      copy: 'Copier',
      copied: 'Copié',
      download: 'Télécharger',
      fingerprint: 'SHA-256',
  ...
  haSensors: {
    ...
    blockPrintHint: 'Les travaux restent en file jusqu\'au retour à la normale. Si Home Assistant est injoignable, la stratégie de panne choisie s\'applique.',
    safeState: 'État sûr : {{state}}',
    failureStrategyLabel: 'Lorsque Home Assistant est indisponible',
    failureAuto: 'Automatique (les capteurs critiques bloquent)',
    failureOpen: 'Autoriser l’impression (fail-open)',
    failureClosed: 'Suspendre l’impression (fail-closed)',
    failureStrategyHint: 'Les capteurs de sécurité critiques suspendent la file sans mesure récente.',
    primarySafetyWarning: 'Les interlocks PrintOps sont des contrôles secondaires. Conservez une protection physique indépendante.',
    failure: {
      auto: 'Panne : automatique',
      fail_open: 'Panne : autoriser l’impression',
      fail_closed: 'Panne : suspendre l’impression',
    },
    override: {
      unavailable: 'Interlock fail-closed indisponible : {{sensors}}',
      open: 'Déroger temporairement',
      reasonLabel: 'Motif de la dérogation temporaire',
      confirm: 'Confirmer la dérogation',
      clear: 'Rétablir l’interlock',
      active: 'Dérogation active par {{user}} : {{reason}}',
      unknownUser: 'utilisateur inconnu',
      error: 'La dérogation de l’interlock n’a pas pu être modifiée.',
    },
    toast: {
  ...
  smartPlugs: {
    ...
    linkTarget: 'Cible de liaison',
    noTarget: 'Aucune cible (contrôle manuel uniquement)',
    targetPrinter: 'Imprimante',
    targetDryer: 'Sécheur de filament',
    selectPrinter: 'Sélectionner une imprimante',
    selectDryer: 'Sélectionner un sécheur de filament',
    ...
    restEnergyTotalPath: 'Chemin JSON énergie totale',
    restEnergyTotalMultiplier: 'Multiplicateur énergie totale',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      bark: 'Notifications push iOS sans compte via Bark',
    ...
    priority: 'Priorité',
    pushoverRetry: 'Rappel d\'urgence (s)',
    pushoverExpire: 'Expiration d\'urgence (s)',
    botToken: 'Jeton du bot',
    chatId: 'ID du chat',
    telegramThreadId: 'ID du sujet du forum',
    telegramThreadIdInvalid: 'L\'ID du sujet du forum doit être un nombre',
    barkDeviceKey: 'Clé de l\'appareil',
    barkGroup: 'Groupe',
    barkSound: 'Son',
    barkLevel: 'Niveau d\'interruption',
    barkLevelDefault: 'Par défaut',
    barkLevelPassive: 'Passif',
    barkLevelActive: 'Actif',
    barkLevelTimeSensitive: 'Urgent',
    barkLevelCritical: 'Critique',
  ...
  externalLinks: {
    ...
    childPageOf: 'Sous-page de {{parent}}',
    hiddenByParent: 'Masqué via {{parent}}',
    showParentFirst: 'Afficher {{parent}} d\'abord',
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      backendUrl: 'URL du backend PrintOps',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'PrintOps fonctionne en réseau Docker bridge. La découverte d\'imprimantes et l\'imprimante virtuelle nécessitent le mode réseau host — recréez le conteneur avec "network_mode: host".',
        skip: 'Ne fonctionne pas dans Docker — non applicable.',
      },
      subnet: {
        title: 'Sous-réseau',
        pass: 'L\'imprimante et PrintOps sont sur le même sous-réseau.',
        warn: 'L\'imprimante ({{printer_ip}}) et PrintOps ({{host_ip}}) sont sur des sous-réseaux différents. Ils peuvent ne pas se joindre, sauf si un routage entre les sous-réseaux est configuré.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Recopiez le code d\'accès depuis l\'écran de l\'imprimante (paramètres LAN) et mettez-le à jour dans les paramètres de l\'imprimante dans PrintOps.',
      },
      'ftp-connection-timeout': {
        name: 'Délai de connexion de transfert de fichiers dépassé',
        cause: 'PrintOps n\'a pas pu atteindre le port de transfert de fichiers de l\'imprimante (FTPS 990). Le port est bloqué, ou l\'imprimante est éteinte ou sur un autre sous-réseau.',
        fix: 'Assurez-vous que rien ne bloque le port 990 entre PrintOps et l\'imprimante, et que les deux sont sur le même réseau.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Faites passer PrintOps à une base de données PostgreSQL externe. Consultez le guide PostgreSQL dans la documentation.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'L\'imprimante virtuelle est activée mais ses services ne sont pas en cours d\'exécution. Consultez le journal PrintOps — un conflit d\'IP de liaison ou une erreur de permission les arrête généralement.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificat prêt. Assurez-vous que le certificat CA PrintOps (ci-dessus) est importé dans le magasin de confiance de votre slicer.',
        fail: 'Le certificat TLS de cette imprimante virtuelle est manquant. Vérifiez que le répertoire de données PrintOps est accessible en écriture.',
      },
    },
  },
  ...
  bugReport: {
    ...
    manualReportTitle: 'Signaler via GitHub',
    manualReportDescription: 'PrintOps utilise le formulaire public GitHub Issue pour les rapports de bug. Cela évite une configuration de relais par installation et vous gardez le contrôle des informations envoyées.',
    openIssueForm: 'Ouvrir une issue GitHub',
  ...
  failureDetection: {
    ...
    mlToken: 'Jeton API ML (facultatif)',
    mlTokenPlaceholder: 'Laissez vide si le serveur fonctionne sans ML_API_TOKEN',
    mlTokenHint: 'Doit correspondre à la variable ML_API_TOKEN de votre conteneur Obico ml_api. Laissez vide si le conteneur n\'en utilise pas.',
    test: 'Tester',
    testSuccess: 'API ML accessible et fonctionnelle.',
    testSuccessTokenUnknown: 'L\'API ML est joignable et saine. Le jeton n\'a pas pu être vérifié.',
    ...
    externalUrlHint: 'L\'API ML récupère la capture caméra par URL. Définissez l\'URL externe dans les paramètres généraux pour que le conteneur API ML puisse atteindre PrintOps.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Collez une URL de modèle MakerWorld pour l\'importer et l\'imprimer directement depuis PrintOps — sans passer par l\'application Bambu Handy.',
    ...
    disclaimer: 'L\'intégration MakerWorld utilise des points de terminaison API documentés par la communauté. PrintOps n\'est ni affilié ni approuvé par MakerWorld ou Bambu Lab.',
  ...
  libraryPurge: {
    ...
    effect4: 'Les fichiers dans les dossiers externes (liés) sont ignorés — PrintOps ne supprime jamais d\'octets qu\'il ne possède pas.',    previewLoading: 'Vérification du nombre de fichiers concernés…',
