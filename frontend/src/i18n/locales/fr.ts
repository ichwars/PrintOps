export default {
  ...
  bugReport: {
    ...
    manualFallbackTitle: "L'envoi automatique n'est pas configuré",
    manualFallbackDescription: 'Cette installation ne peut pas envoyer les rapports de bug directement à GitHub. Ouvrez le formulaire GitHub Issue et collez-y votre description.',
