export default {
  orderUiNotFound: 'Record non trovato.',
  ...
  orderMessages: { addressKind: 'Address kind', addressKinds: { registered: 'Registered', billing: 'Billing', shipping: 'Shipping', other: 'Other' }, addressLabel: 'Address label', additional: 'Additional', street2: 'Street 2', region: 'Region', taxCountry: 'Tax country', validFrom: 'Valid from', validUntil: 'Valid until', taxValidationStatus: { unchecked: 'Unchecked', valid: 'Valid', invalid: 'Invalid' }, validation: { required: 'Required', maxCharacters: 'Must be at most {{count}} characters.', customerKind: 'Choose a valid customer kind.', customerStatus: 'Choose a valid customer status.', accountRequired: 'At least one account is required.', businessProfile: 'Choose a valid business profile.', duplicateAccountProfile: 'Only one account is allowed per business profile.', currency: 'Enter a valid ISO 4217 currency code.', range: 'Must be between {{min}} and {{max}}.', twoDecimalPlaces: 'Use no more than two decimal places.', addressKind: 'Choose a valid address kind.', country: 'Enter a valid ISO 3166-1 alpha-2 country code.', duplicateDefaultAddress: 'Only one default address is allowed per kind.', taxValidationStatus: 'Choose a valid validation status.', duplicateTaxIdentifier: 'Duplicate tax identifiers are not allowed.', maxTags: 'Must contain no more than 50 tags.', normalizedTag: 'Normalized tag name must be at most 512 UTF-8 bytes.', invalidField: 'This field is invalid.', failed: 'Validation failed.' }, errors: { conflict: 'This record was changed by another user.', business_profile_in_use: 'This business profile is still used by customer accounts.', business_profile_referenced: 'This business profile is still referenced and cannot be changed.', business_profile_version_conflict: 'This business profile was changed by another user.', customer_number_conflict: 'This customer number is already in use for this business profile.', customer_account_number_conflict: 'This customer number is already in use for this business profile.', customer_version_conflict: 'This customer was changed by another user.' } },
  // Navigation
  nav: {
    printers: 'Stampanti',
    archives: 'Archivi',
    ...
    installAppSuccess: 'PrintOps è stato installato',
  },
  ...
  printers: {
    ...
    camWall: {
      ...
      page: {
        tokenRejected: 'Questo token del muro telecamere è stato rifiutato o è scaduto.',
        loadFailed: 'Impossibile caricare il muro telecamere.',
      },
    },
    // Controls
    ...
    maintenance: {
      ...
      editFieldHelp: 'Quando attivata, questa stampante è in pausa da MQTT, dispatch della coda e notifiche — utile per riparazioni, installazioni PrintOps parallele o sospensione temporanea.',
    },
    // Chamber light
    ...
    drying: {
      ...
      toastStopped: 'Essiccazione arrestata',
    ...
    expectedSlot: {
      ...
      label: '{{ams}} · Alloggiamento {{slot}}',
      title: 'La stampa in pausa attende il filamento qui',
      ariaLabel: 'Slot sostitutivo atteso {{n}}',
    },
    // Filaments section
    filaments: 'Filamenti',
    // Camera
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedNotice: 'Impossibile accodare {{runs}} delle {{owed}} stampe dovute: non resta alcuna esecuzione da cui copiare le impostazioni. Accoda la piastra dal file oppure annulla il lotto.',
    ...
    cancelBatchConfirmMessage: 'Chiudere questo lotto? Le stampe in coda saranno annullate e le quantità non prodotte verranno scartate.',
    batch: {
      defaultName: 'Lotto',
    ...
    toast: {
      ...
      keptForOrder: 'Non rimosso: “{{name}}” necessita ancora di questa stampa come unica configurazione riutilizzabile della piastra',
      historyKeptForOrders: 'Conservate {{kept}} configurazioni ancora necessarie ai lotti aperti.',
  ...
  stats: {
    ...
    energySource: {
      smartPlugLive: 'Totale live della presa smart',
      smartPlugSnapshots: 'Snapshot della presa smart',
      printLogs: 'Log di stampa',
    },
  ...
  settings: {
    ...
    tabs: {
      general: 'Generale',
      usersSecurity: 'Utenti e sicurezza',
      printersProduction: 'Stampanti e produzione',
      projectsFiles: 'Progetti e file',
      warehouseMaterial: 'Magazzino e materiali',
      ordersCalculation: 'Ordini e calcolo',
    ...
    ldap: {
      ...
      feature3: 'I gruppi LDAP vengono mappati ai gruppi PrintOps al login',
      ...
      autoProvisionHint: 'Crea automaticamente un account PrintOps al primo accesso LDAP',
      ...
      groupMappingHint: 'Mappa i DN dei gruppi LDAP ai gruppi PrintOps. Gruppi disponibili: ',
    ...
    localLogin: {
      ...
      disableHint: 'Quando attivato, solo i provider SSO possono accedere. LDAP non è interessato. Imposta PRINTOPS_LOCAL_LOGIN=true sul server per mantenere un percorso di ripristino.',
    },
    // Queue
    ...
    preheatFilamentTargetsHint: 'PrintOps sceglie il target più alto tra gli slot AMS caricati; le stampe solo PLA derivano 0 e saltano la fase camera automaticamente.',
    ...
    authDisabledMessage: 'Abilita autenticazione per creare account, gestire permessi e proteggere la tua istanza PrintOps.',
    ...
    disableAuthenticationMessage: 'Sei sicuro di voler disabilitare l\'autenticazione? Questo renderà la tua istanza PrintOps accessibile senza login. Tutti gli utenti resteranno nel database ma l\'autenticazione sarà disabilitata.',
    disableAuthentication: 'Disabilita autenticazione',
    // Additional settings
    configurePrintOps: 'Configura PrintOps',
    ...
    noticePreferences: 'Avvisi',
    showDeveloperLanWarning: 'Mostra avviso Developer LAN',
    showDeveloperLanWarningDesc: 'Avvisa in alto nella app quando una stampante collegata non ha la modalita Developer LAN attiva.',
    showSponsorPrompts: 'Mostra avvisi sostenitori',
    showSponsorPromptsDesc: 'Mostra avvisi occasionali su sostenitori e finanziamento comunitario di PrintOps.',
    ...
    progressInTitle: 'Mostra avanzamento stampa nella scheda',
    progressInTitleHint: 'Quando una stampante è in esecuzione, titolo della scheda e favicon mostrano la percentuale attiva.',
    ...
    cameraUrlBuilderToggle: 'Genera URL da host, porta e percorso',
    cameraUrlBuilderHost: 'Host o IP',
    cameraUrlBuilderPort: 'Porta',
    cameraUrlBuilderPath: 'Percorso (es. /stream)',
    cameraUrlBuilderUsername: 'Nome utente (opzionale)',
    cameraUrlBuilderPassword: 'Password (opzionale)',
    cameraUrlBuilderHelp: 'Compila il campo URL fotocamera sopra. Viene comunque convalidata e testata come un URL inserito manualmente.',
    ...
    printopsSoftware: 'Software PrintOps',
    ...
    updateViaHomeAssistant: 'Gli aggiornamenti sono gestiti dal Supervisor di Home Assistant. Apri Impostazioni → Add-on → PrintOps in Home Assistant per installare la nuova versione.',
    ...
    externalUrlDescription: 'L\'URL esterno dove PrintOps è accessibile. Usato per immagini di notifica e integrazioni esterne.',
    printopsUrl: 'URL PrintOps',
    ...
    mqttDescription: 'Pubblica eventi PrintOps su un broker MQTT esterno per l\'integrazione con Node-RED, Home Assistant e altri sistemi di automazione.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'I segreti TOTP e i client_secrets OIDC sono memorizzati in chiaro. Imposta MFA_ENCRYPTION_KEY o riavvia PrintOps con una directory dati scrivibile per generarne uno automaticamente.',
      ...
      migrationErrorWarning: "{{count}} riga/righe legacy non sono state ricifrate all'avvio. Controlla i log del server e riavvia PrintOps per riprovare.",
    },
    ...
    documents: {
      ...
      status: { draft: 'Draft', scheduled: 'Scheduled', active: 'Active', superseded: 'Superseded', missingDraft: 'Nessuna bozza' },
  ...
  hmsErrors: {
    ...
    runoutExpectedSlot: 'Il filamento è terminato in {{ranOut}}. La stampa ora attende il filamento in {{expected}}.',
    runoutExpectedSlotOnly: 'Il filamento è terminato. La stampa ora attende il filamento in {{expected}}.',
    runoutSlotUnknown: 'Il filamento è terminato. Controlla sulla stampante quale slot AMS è atteso.',
  ...
  login: {
    ...
    resetStep1: 'Contatta il tuo amministratore PrintOps',
    ...
    twoFA: {
      ...
      instructionsTotp: "Apri la tua app di autenticazione e inserisci il codice a 6 cifre per PrintOps.",
  ...
  // Setup page
  setup: {
    title: 'Configurazione PrintOps',
    subtitle: 'Configura autenticazione per la tua istanza PrintOps',
  ...
  camera: {
    ...
    diagnose: {
      ...
      info: {
        title: 'Dettagli dello streaming live',
        pipeline: 'Pipeline',
        codec: 'Codec video',
        resolution: 'Risoluzione',
        fps: 'FPS (target / misurati)',
        bitrate: 'Velocità in bit',
        uptime: 'Tempo di attività dello stream',
        tlsProxy: 'Proxy TLS',
        go2rtcStream: 'Stream go2rtc',
        notActive: 'Nessuno stream è attualmente attivo per questa stampante.',
        pipelineName: {
          go2rtc: 'go2rtc (sorgente RTSP, fornisce MSE + MJPEG)',
          go2rtc_chamber_bridge: 'go2rtc (bridge immagine camera, solo MJPEG)',
          chamber_binary: 'Protocollo immagine camera (binario proprietario)',
          external_mjpeg: 'Telecamera esterna (MJPEG, tramite go2rtc)',
          external_rtsp: 'Telecamera esterna (RTSP, tramite go2rtc)',
          external_snapshot: 'Telecamera esterna (snapshot HTTP, tramite go2rtc)',
          external_usb: 'Telecamera esterna (USB/v4l2, diretta)',
        },
        player: 'Lettore',
        playerName: {
          mse: 'MSE (H.264, senza ricodifica)',
          mjpeg: 'MJPEG (riserva)',
  ...
  users: {
    ...
    subtitle: 'Gestisci utenti e accesso alla tua istanza PrintOps',
    backToSettings: 'Torna a Impostazioni',
    createUser: 'Crea utente',
    noPermission: 'Non hai il permesso di accedere a questa pagina.',
    admin: 'Amministratore',
    ...
    form: {
      ...
      groups: 'Gruppi',
      printerScope: 'Accesso alle stampanti',
      allPrinters: 'Tutte le stampanti',
      printerScopeCount: '{{count}} stampanti',
      optional: 'opzionale',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Accedi al tuo account Orca Cloud per sincronizzare i profili dello slicer in PrintOps.',
      },
      device: {
        title: 'Approva PrintOps in Orca Cloud',
        instruction: 'Apri Orca Cloud e approva questo codice. PrintOps si connette automaticamente non appena approvi.',
    ...
    connectedAs: 'Connesso come',
    signInExpired: 'L\'accesso a Bambu Cloud è scaduto. Accedi di nuovo per usare i preset cloud.',
    logout: 'Esci',
    noLogoutPermission: 'Non hai il permesso di disconnetterti',
  ...
  sponsors: {
    ...
    tagline: 'PrintOps è gratuito e resta tale perché qualcuno sceglie di sostenerlo. Niente VC, niente lock-in cloud.',
    viewSupporters: 'Vedi i sostenitori',
    toastPrints: 'Hai completato {{count}} stampe con PrintOps. PrintOps resta gratuito grazie a chi lo sostiene.',
    toastCost: 'Hai monitorato {{total}} di filamento con PrintOps. Scopri chi mantiene il progetto indipendente.',
    toastArchives: '{{count}} stampe archiviate con PrintOps. Scopri chi lo mantiene indipendente.',
    toastAnniversary: 'Un anno con PrintOps! Scopri chi mantiene il progetto indipendente.',
    toastVersionUpdate: 'Aggiornato a v{{version}}. PrintOps resta gratuito grazie a chi lo sostiene.',
  },
...
useEmbeddedHint: 'Esegue lo slicing come impostato dal designer (pareti, riempimento, filamento) invece dei profili sopra. Disponibile perché la stampante corrisponde al file.',
  ...
  inventory: {
    ...
    bulk: {
      ...
      mergeTargetPrompt: 'ID bobina di destinazione tra gli ID selezionati ({{ids}})',
      mergeInvalidTarget: 'Scegli uno degli ID bobina selezionati come destinazione',
      mergeSuccess: '{{count}} bobine duplicate unite',
    ...
    refill: 'Ricarica',
    refillPrompt: 'Peso ricaricato in grammi per la bobina #{{id}}',
    refillInvalidWeight: 'Inserisci un peso maggiore di 0 g',
    refillSuccess: 'Ricarica bobina registrata',
    refillFailed: 'Ricarica bobina non riuscita',
    spoolmanMixedContentTitle: 'Spoolman non può essere caricato tramite HTTPS — contenuto misto bloccato dal browser',
    spoolmanMixedContentBody: 'PrintOps viene servito tramite HTTPS (dietro il tuo reverse proxy), ma l\'URL di Spoolman è ancora HTTP. I browser bloccano il contenuto misto per motivi di sicurezza, quindi l\'interfaccia Spoolman incorporata non può essere visualizzata. Anche Spoolman deve essere raggiungibile via HTTPS.',
    spoolmanMixedContentFixReverseProxy: 'Metti Spoolman dietro lo stesso reverse proxy di PrintOps (Traefik / Nginx / Caddy) in HTTPS, poi aggiorna l\'URL di Spoolman nelle Impostazioni con il nuovo indirizzo HTTPS.',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'Il repository è PUBBLICO. I backup di PrintOps includono credenziali MQTT, token di Home Assistant, token di Prometheus, la tua e-mail Bambu Cloud e i codici di accesso alle stampanti tramite K-profile. Il salvataggio è bloccato finché non rendi privato il repository nelle impostazioni del tuo provider.',
    repoVisibilityUnknown: 'Impossibile determinare la visibilità del repository. PrintOps rifiuta di eseguire backup su qualsiasi target non confermato come privato; il salvataggio sarà bloccato.',
    ...
    appSettingsDescription: 'Configurazione PrintOps (database completo)',
    ...
    localBackupDescription: 'Crea un backup completo dei tuoi dati PrintOps includendo database, archivi, upload e tutti i file.',
    ...
    backupRestoredRestart: 'Backup ripristinato. Riavvia PrintOps.',
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Le note sono salvate in PrintOps, non sulla stampante',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visibile come "PrintOps" nella ricerca slicer',
    ...
    remoteInterface: {
      ...
      hint: 'Sovrascrive l\'indirizzo IP pubblicizzato via SSDP e usato nel certificato TLS. Utile quando PrintOps ha piu interfacce di rete.',
    },
    mode: {
      title: 'Modalita',
      archive: 'Archivio',
    ...
    howItWorks: {
      ...
      step2: 'In modalità Archivio, Revisione e Coda, usa il pulsante "Invia" nel tuo slicer per caricare file 3MF su PrintOps. Lo slicer mostrerà "Stampa riuscita" — il file viene salvato, non stampato.',
    ...
    caCert: {
      ...
      description: 'Le stampanti virtuali usano un certificato TLS firmato dalla CA di PrintOps. Importa questo certificato CA nell\'archivio attendibile del tuo slicer una sola volta affinché accetti la connessione — senza doverlo copiare dalla riga di comando.',
      copy: 'Copia',
      copied: 'Copiato',
      download: 'Scarica',
      fingerprint: 'SHA-256',
  ...
  haSensors: {
    ...
    blockPrintHint: 'I lavori restano in coda finché il sensore rientra. Se Home Assistant non è raggiungibile, si applica la strategia di guasto scelta.',
    safeState: 'Stato sicuro: {{state}}',
    failureStrategyLabel: 'Quando Home Assistant non è disponibile',
    failureAuto: 'Automatico (i sensori critici bloccano)',
    failureOpen: 'Consenti la stampa (fail-open)',
    failureClosed: 'Trattieni la stampa (fail-closed)',
    failureStrategyHint: 'I sensori di sicurezza critici trattengono la coda senza una lettura recente.',
    primarySafetyWarning: 'Gli interlock PrintOps sono controlli secondari. Mantieni una protezione fisica indipendente.',
    failure: {
      auto: 'Guasto: automatico',
      fail_open: 'Guasto: consenti stampa',
      fail_closed: 'Guasto: trattieni stampa',
    },
    override: {
      unavailable: 'Interlock fail-closed non disponibile: {{sensors}}',
      open: 'Ignora temporaneamente',
      reasonLabel: 'Motivo dell’override temporaneo',
      confirm: 'Conferma override',
      clear: 'Ripristina interlock',
      active: 'Override attivo da {{user}}: {{reason}}',
      unknownUser: 'utente sconosciuto',
      error: 'Impossibile modificare l’override dell’interlock.',
    },
    toast: {
  ...
  smartPlugs: {
    ...
    linkTarget: 'Destinazione collegamento',
    noTarget: 'Nessuna destinazione (solo controllo manuale)',
    targetPrinter: 'Stampante',
    targetDryer: 'Essiccatore filamento',
    selectPrinter: 'Seleziona stampante',
    selectDryer: 'Seleziona essiccatore filamento',
    ...
    restEnergyTotalPath: 'Percorso JSON energia totale',
    restEnergyTotalMultiplier: 'Moltiplicatore energia totale',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      bark: 'Notifiche push iOS senza account tramite Bark',
    ...
    chatId: 'ID chat',
    telegramThreadId: 'ID argomento del forum',
    telegramThreadIdInvalid: 'L\'ID argomento del forum deve essere un numero',
    barkDeviceKey: 'Chiave dispositivo',
    barkGroup: 'Gruppo',
    barkSound: 'Suono',
    barkLevel: 'Livello di interruzione',
    barkLevelDefault: 'Predefinito',
    barkLevelPassive: 'Passivo',
    barkLevelActive: 'Attivo',
    barkLevelTimeSensitive: 'Sensibile al tempo',
    barkLevelCritical: 'Critico',
  ...
  externalLinks: {
    ...
    childPageOf: 'Sottopagina di {{parent}}',
    hiddenByParent: 'Nascosto tramite {{parent}}',
    showParentFirst: 'Mostra prima {{parent}}',
    ...
    deleteConfirm: 'Sei sicuro di voler eliminare "{{name}}"? Questa azione non puo essere annullata.',
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      backendUrl: 'URL backend PrintOps',
      apiToken: 'Token API',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'PrintOps è in esecuzione con la rete Docker bridge. Il rilevamento delle stampanti e la stampante virtuale richiedono la modalità di rete host — ricrea il container con "network_mode: host".',
        skip: 'Non in esecuzione in Docker — non applicabile.',
      },
      subnet: {
        title: 'Sottorete',
        pass: 'La stampante e PrintOps sono nella stessa sottorete.',
        warn: 'La stampante ({{printer_ip}}) e PrintOps ({{host_ip}}) sono in sottoreti diverse. Potrebbero non raggiungersi a meno che non sia configurato il routing tra le sottoreti.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Ricopia il codice di accesso dallo schermo della stampante (impostazioni LAN) e aggiornalo nelle impostazioni della stampante in PrintOps.',
      },
      'ftp-connection-timeout': {
        name: 'Timeout della connessione di trasferimento file',
        cause: 'PrintOps non è riuscito a raggiungere la porta di trasferimento file della stampante (FTPS 990). La porta è bloccata, oppure la stampante è spenta o in un\'altra sottorete.',
        fix: 'Assicurati che nulla blocchi la porta 990 tra PrintOps e la stampante e che entrambi siano sulla stessa rete.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Passa PrintOps a un database PostgreSQL esterno. Consulta la guida PostgreSQL nella documentazione.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'La stampante virtuale è abilitata ma i suoi servizi non sono in esecuzione. Controlla il log di PrintOps — di solito li ferma un conflitto di IP di binding o un errore di permessi.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificato pronto. Assicurati che il certificato CA di PrintOps (sopra) sia importato nell\'archivio attendibile del tuo slicer.',
        fail: 'Il certificato TLS per questa stampante virtuale è mancante. Verifica che la directory dei dati di PrintOps sia scrivibile.',
      },
    },
  },
  ...
  bugReport: {
    ...
    manualReportTitle: 'Segnala tramite GitHub',
    manualReportDescription: 'PrintOps usa il modulo pubblico delle issue GitHub per le segnalazioni di bug. In questo modo non serve configurare un relay per ogni installazione e mantieni il controllo dei dati inviati.',
    openIssueForm: 'Apri issue GitHub',
  ...
  failureDetection: {
    ...
    mlToken: 'Token API ML (opzionale)',
    mlTokenPlaceholder: 'Lascia vuoto se il server funziona senza ML_API_TOKEN',
    mlTokenHint: 'Deve corrispondere alla variabile ML_API_TOKEN del contenitore Obico ml_api. Lascia vuoto se il contenitore non ne usa uno.',
    test: 'Prova',
    testSuccess: 'API ML raggiungibile e funzionante.',
    testSuccessTokenUnknown: 'API ML raggiungibile e funzionante. Impossibile verificare il token.',
    ...
    externalUrlHint: 'L\'API ML recupera l\'istantanea della telecamera tramite URL. Imposta l\'URL esterno nelle impostazioni generali in modo che il container API ML possa raggiungere PrintOps.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Incolla un URL di un modello MakerWorld per importarlo e stamparlo direttamente da PrintOps — senza passare dall\'app Bambu Handy.',
    ...
    disclaimer: 'L\'integrazione MakerWorld utilizza endpoint API documentati dalla community. PrintOps non è affiliato né approvato da MakerWorld o Bambu Lab.',
  ...
  libraryPurge: {
    ...
    effect4: 'I file in cartelle esterne (collegate) vengono saltati — PrintOps non elimina mai dati che non possiede.',    previewLoading: 'Verifica quanti file corrispondono…',
  ...
  forecast: {
    ...
    expandSku: 'Espandi {{label}}',
    collapseSku: 'Riduci {{label}}',
    procurementTitle: 'Approvvigionamento',
    procurementLoadingOffers: 'Caricamento fonti di approvvigionamento …',
    procurementOffersLoadError: 'Impossibile caricare le fonti di approvvigionamento.',
    procurementRetryOffers: 'Riprova fonti di approvvigionamento',
    procurementSuppliersLoadError: 'Impossibile caricare i fornitori.',
    procurementRetrySuppliers: 'Riprova fornitori',
    procurementSave: 'Salva fonti di approvvigionamento',
    procurementSaved: 'Fonti di approvvigionamento salvate',
    procurementSaveFailed: 'Impossibile salvare le fonti di approvvigionamento',
    sku: 'SKU',
    // Table headers
    material: 'Materiale',
    stock: 'Scorte',
  ...
  suppliers: { navTitle: 'Fornitori', title: 'Fornitori', subtitle: 'Gestisci i contatti e le condizioni di acquisto.', createTitle: 'Aggiungi fornitore', editTitle: 'Modifica fornitore', searchLabel: 'Cerca fornitori', searchPlaceholder: 'Azienda, referente, e-mail, numero cliente …', activeFilter: 'Stato', loading: 'Caricamento fornitori …', empty: 'Nessun fornitore corrispondente.', noContact: 'Nessun dato di contatto', leadTime: '{{count}} giorni di tempo di consegna standard', sections: { masterData: 'Dati anagrafici', contactAddress: 'Contatti e indirizzo', procurement: 'Approvvigionamento', internalNotes: 'Nota interna' }, fields: { name: 'Azienda', customerNumber: 'Numero cliente', active: 'Fornitore attivo', contactName: 'Referente', email: 'E-mail', phone: 'Telefono', website: 'Sito web', addressLine1: 'Riga indirizzo 1', addressLine2: 'Riga indirizzo 2', postalCode: 'CAP', city: 'Città', countryCode: 'Codice paese', paymentTerms: 'Condizioni di pagamento', defaultLeadTime: 'Tempo di consegna standard', internalNotes: 'Note interne' }, filters: { active: 'Attivi', inactive: 'Inattivi', all: 'Tutti i fornitori' }, actions: { create: 'Aggiungi fornitore', save: 'Salva fornitore', edit: 'Modifica {{name}}', delete: 'Elimina fornitore' }, validation: { nameRequired: 'Il nome dell’azienda è obbligatorio.' }, errors: { load: 'Impossibile caricare i fornitori.', save: 'Impossibile salvare il fornitore.', delete: 'Impossibile eliminare il fornitore.', noReadPermission: 'Non hai il permesso di visualizzare i fornitori.' } },
};
