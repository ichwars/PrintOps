export default {
  ...
  bugReport: {
    ...
    manualFallbackTitle: 'Invio automatico non configurato',
    manualFallbackDescription: 'Questa installazione non può inviare segnalazioni di bug direttamente a GitHub. Apri il modulo issue di GitHub e incolla lì la descrizione.',
