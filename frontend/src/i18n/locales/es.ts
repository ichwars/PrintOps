export default {
  orderUiNotFound: 'No se encontró el registro.',
  orderUi: { operationBlocked: "The operation cannot be completed in the record's current state.", duplicateRecord: 'A record with the same unique values already exists.', singlePrimaryContact: 'Only one primary contact is allowed.', billingModes: { internal: 'Internal', external: 'External', hybrid: 'Hybrid' } },
  orderMessages: {
    addressKind: 'Address kind', addressKinds: { registered: 'Registered', billing: 'Billing', shipping: 'Shipping', other: 'Other' },
    addressLabel: 'Address label', additional: 'Additional', street2: 'Street 2', region: 'Region', taxCountry: 'Tax country', validFrom: 'Valid from', validUntil: 'Valid until',
    taxValidationStatus: { unchecked: 'Unchecked', valid: 'Valid', invalid: 'Invalid' },
    validation: { required: 'Required', maxCharacters: 'Must be at most {{count}} characters.', customerKind: 'Choose a valid customer kind.', customerStatus: 'Choose a valid customer status.', accountRequired: 'At least one account is required.', businessProfile: 'Choose a valid business profile.', duplicateAccountProfile: 'Only one account is allowed per business profile.', currency: 'Enter a valid ISO 4217 currency code.', range: 'Must be between {{min}} and {{max}}.', twoDecimalPlaces: 'Use no more than two decimal places.', addressKind: 'Choose a valid address kind.', country: 'Enter a valid ISO 3166-1 alpha-2 country code.', duplicateDefaultAddress: 'Only one default address is allowed per kind.', taxValidationStatus: 'Choose a valid validation status.', duplicateTaxIdentifier: 'Duplicate tax identifiers are not allowed.', maxTags: 'Must contain no more than 50 tags.', normalizedTag: 'Normalized tag name must be at most 512 UTF-8 bytes.', invalidField: 'This field is invalid.', failed: 'Validation failed.' },
    errors: { conflict: 'This record was changed by another user.', business_profile_in_use: 'This business profile is still used by customer accounts.', business_profile_referenced: 'This business profile is still referenced and cannot be changed.', business_profile_version_conflict: 'This business profile was changed by another user.', customer_number_conflict: 'This customer number is already in use for this business profile.', customer_account_number_conflict: 'This customer number is already in use for this business profile.', customer_version_conflict: 'This customer was changed by another user.' },
  },
  // Navigation
  nav: {
    printers: 'Impresoras',
    ...
    installAppSuccess: 'PrintOps se ha instalado',
  },
  ...
  orders: {
    default: 'Default',
    businessProfile: { title: 'Business Profile', loading: 'Loading business profiles...', error: 'Unable to load business profiles.', empty: 'No business profiles yet.', permissionDenied: 'You do not have permission to view business profiles.', add: 'Add business profile', includeInactive: 'Include inactive profiles', profile: 'Profile', country: 'Country', currency: 'Currency', timezone: 'Timezone', billingMode: 'Billing mode', status: 'Status', actions: 'Actions', active: 'Active', inactive: 'Inactive', edit: 'Edit {{name}}', setDefault: 'Set {{name}} as default', activate: 'Activate {{name}}', deactivate: 'Deactivate {{name}}', delete: 'Delete {{name}}', deleteConfirm: 'Delete {{name}}? This cannot be undone.', dismiss: 'Dismiss', createTitle: 'Add business profile', editTitle: 'Edit business profile', identity: 'Identity', address: 'Address', taxAndBank: 'Tax and bank', localeSection: 'Locale', profileName: 'Profile name', legalName: 'Legal name', tradingName: 'Trading name', profileCountry: 'Profile country', street: 'Street', city: 'City', postalCode: 'Postal code', addAddress: 'Add address', removeAddress: 'Remove address {{number}}', defaultAddress: 'Default address {{number}}', taxIdKind: 'Tax ID kind', taxIdValue: 'Tax ID value', addTaxId: 'Add tax ID', removeTaxId: 'Remove tax ID {{number}}', primaryTaxId: 'Primary tax ID {{number}}', bankAccountLabel: 'Bank account label', accountHolder: 'Account holder', bankName: 'Bank name', bankCountry: 'Bank country', bankCurrency: 'Bank currency', iban: 'IBAN', bic: 'BIC', accountNumber: 'Account number', routingNumber: 'Routing number', defaultBankAccount: 'Default bank account {{number}}', addBankAccount: 'Add bank account', removeBankAccount: 'Remove bank account {{number}}', locale: 'Locale', save: 'Save business profile' },
    customers: { title: 'Customers', subtitle: 'Customer master data for the selected business profile.', businessProfile: 'Business profile', loading: 'Loading customers...', error: 'Unable to load customers.', noBusinessProfile: 'No active business profile is available.', empty: 'No customers yet.', customer: 'Customer', discount: 'Discount', permissionDenied: 'You do not have permission to view customers.', configureProfiles: 'Configure business profiles', add: 'Add customer', search: 'Search customers', statusFilter: 'Customer status', kindFilter: 'Customer kind', emptyFiltered: 'No customers match the current filters.', number: 'Number', name: 'Name', primaryContact: 'Primary contact', billingAddress: 'Billing address', actions: 'Actions', view: 'View details', viewAria: 'View {{name}}', editCustomer: 'Edit customer', editAria: 'Edit {{name}}', deleteCustomer: 'Delete customer', deleteAria: 'Delete {{name}}', deleteTitle: 'Delete {{name}}?', deleteConfirm: 'This customer will be permanently deleted.', pagination: '{{start}}-{{end}} of {{total}}', previous: 'Previous page', next: 'Next page' },
    customerEditor: { title: 'Customer editor', loading: 'Cargando editor de clientes', loadError: 'Unable to load the customer editor.', createTitle: 'Add customer', editTitle: 'Edit customer', kind: 'Customer kind', company: 'Company', person: 'Person', identity: 'Identity', displayName: 'Display name', companyName: 'Company name', firstName: 'First name', lastName: 'Last name', accounts: 'Profile accounts', addAccount: 'Add account', removeAccount: 'Remove account {{number}}', accountProfile: 'Account profile', customerNumber: 'Customer number', currency: 'Currency', paymentDays: 'Payment days', deliveryTerms: 'Delivery terms', discount: 'Discount', activeAccount: 'Active account', contacts: 'Contacts', addContact: 'Add contact', removeContact: 'Remove contact {{number}}', salutation: 'Salutation', contactFirstName: 'Contact first name', contactLastName: 'Contact last name', contactRole: 'Contact role', contactEmail: 'Contact email', contactPhone: 'Contact phone', primaryContact: 'Primary contact', includeContact: 'Include contact', onDocuments: 'on documents', includeDocuments: 'Include on documents', addresses: 'Addresses', addAddress: 'Add address', removeAddress: 'Remove address {{number}}', addressKindLabel: 'Address kind', addressKind: { billing: 'Billing', delivery: 'Delivery', other: 'Other' }, addressLabel: 'Address label', additional: 'Additional', street: 'Street', street2: 'Street 2', postalCode: 'Postal code', city: 'City', region: 'Region', country: 'Country', defaultAddress: 'Default address', taxIdentifiers: 'Tax identifiers', addTax: 'Add tax identifier', removeTax: 'Remove tax identifier {{number}}', taxKind: 'Tax identifier kind', taxValue: 'Tax identifier value', taxCountry: 'Tax country', validationStatus: 'Validation status', preferences: 'Preferences', locale: 'Locale', tags: 'Tags', notes: 'Notes', required: 'Required', reload: 'Reload current data', save: 'Save customer' },
    customerDetails: { title: 'Customer details', loading: 'Cargando detalles del cliente', loadError: 'Unable to load customer details.', paymentDays: '{{count}} payment days', created: 'Created {{date}}', updated: 'Updated {{date}}' },
  ...
  printers: {
    ...
    camWall: {
      ...
      page: {
        tokenRejected: 'Este token del muro de cámaras fue rechazado o ha caducado.',
        loadFailed: 'No se pudo cargar el muro de cámaras.',
      },
    },
    // Controls
    ...
    maintenance: {
      ...
      editFieldHelp: 'Cuando está activado, esta impresora se pausa de MQTT, despacho de cola y notificaciones — útil para reparaciones, instalaciones paralelas de PrintOps o suspensión temporal.',
    },
    // Chamber light
    ...
    expectedSlot: {
      ...
      label: '{{ams}} · Ranura {{slot}}',
      title: 'La impresión pausada espera filamento aquí',
      ariaLabel: 'Slot de reemplazo esperado {{n}}',
    },
    // Filaments section
    ...
    localControlUnavailable: 'Local control is unavailable. Enable Developer LAN mode on the printer and check the IP address and access code.',
    localControlBadge: 'LAN control off',
    localControlBadgeTitle: 'Local printer control is disabled. PrintOps can show status data, but local control commands are blocked.',
    localControlUnavailableCloudCandidate: '{{action}} will be sent through Bambu Cloud when LAN control is unavailable.',
    localControlUnavailableCloudNotImplemented: '{{action}} is generally possible through Bambu Cloud, but PrintOps has not implemented it as cloud control yet. Enable Developer LAN mode on the printer.',
    localControlUnavailableCloudUncertain: '{{action}} currently requires local control in PrintOps. Cloud support for this function has not been confirmed well enough yet.',
    localControlUnavailableLocalOnly: '{{action}} requires local control. Enable Developer LAN mode on the printer and check the IP address and access code.',
    cloudControlActionTitle: '{{action}} will be sent through Bambu Cloud because local LAN control is unavailable.',
    cloudControlConfigured: 'Cloud ready',
    cloudControlConfiguredTitle: 'Bambu Cloud is configured and can be used for supported fallback actions.',
    controlPathTitle: 'Active control path: {{path}}',
    controlPath: {
      local: 'Local',
      cloud: 'Cloud',
      none: 'no control',
    ...
    controlMatrix: {
      ...
      status: 'Status',
      statusOnly: 'Status',
      localCloudFallback: 'LAN + cloud fallback',
      cloudNotImplemented: 'Cloud possible, PrintOps local',
      localOnly: 'LAN only',
      available: 'possible',
      uncertain: 'uncertain',
    },
  ...
  archives: {
    ...
    no3mfBanner: {
      ...
      body: 'El slicer no dejó el archivo .gcode.3mf en la tarjeta SD de la impresora, así que PrintOps no pudo recuperar ni la miniatura ni los metadatos del slicer. Esto suele deberse a que "Almacenar archivos enviados en almacenamiento externo" está desactivado en el slicer (pestaña Dispositivo de Bambu Studio / OrcaSlicer).',
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedNotice: 'No se pueden encolar {{runs}} de las {{owed}} impresiones pendientes: esa placa ya no tiene una impresión de la que copiar los ajustes. Encola la placa desde el archivo o cancela el lote.',
    ...
    cancelBatchConfirmMessage: '¿Cerrar este lote? Las impresiones en cola se cancelarán y se descartarán las cantidades no producidas.',
    batch: {
      defaultName: 'Lote',
    ...
    toast: {
      ...
      keptForOrder: 'No eliminado: «{{name}}» aún necesita esta impresión como única plantilla reutilizable de la placa',
      historyKeptForOrders: 'Se conservaron {{kept}} plantillas que aún necesitan los lotes abiertos.',
  ...
  stats: {
    ...
    energySource: {
      smartPlugLive: 'Total en vivo del enchufe inteligente',
      smartPlugSnapshots: 'Instantáneas del enchufe inteligente',
      printLogs: 'Registros de impresión',
    },
  ...
  settings: {
    ...
    tabs: {
      general: 'General',
      usersSecurity: 'Usuarios y seguridad',
      printersProduction: 'Impresoras y producción',
      projectsFiles: 'Proyectos y archivos',
      warehouseMaterial: 'Almacén y material',
      ordersCalculation: 'Pedidos y cálculo',
      ...
      orderManagementFormatPreview: 'Format & Preview',
      filament: 'Filamento',
      network: 'Red',
      apiKeys: 'Claves API',
    ...
    orderManagementSubTabDescriptions: {
      formatPreview: 'Design versioned PDF layouts, verify real previews, and control publishing readiness.',
    ...
    documentLayout: {
      ...
      description: 'Design versioned PDF layouts, inspect real documents, and publish only validated configurations.',
      loadingDescription: 'The versioned layout workspace is loading its catalog, permissions, and document context.',
      context: {
        title: 'Layout context', profile: 'Business profile', scope: 'Scope', profileDefault: 'Profile default',
        documentType: 'Document type', language: 'Language', version: 'Version', sample: 'Preview source',
        sampleData: 'Sample data', realDocument: 'Real document', realDocumentHint: 'Only the document ID is sent; each preview is audited.',
      },
      access: {
        readOnly: 'Read-only access', readOnlyHint: 'You may inspect layouts and previews, but only administrators can change or publish them.',
        unavailable: 'Layout settings are not available because read permission is missing.',
      },
      statuses: {
        draft: 'Draft', scheduled: 'Scheduled', active: 'Active', superseded: 'Superseded', withdrawn: 'Withdrawn',
        saved: 'Saved', saving: 'Saving...', pending: 'Changes pending', failed: 'Save failed',
        ready: 'Ready', warnings: 'Warnings', blocked: 'Blocked', checking: 'Checking',
      },
      actions: {
        retry: 'Retry', refresh: 'Refresh', download: 'Download', clone: 'Clone layout', publish: 'Publish',
        schedule: 'Schedule publication', withdraw: 'Withdraw publication', history: 'History', close: 'Close',
        save: 'Save', cancel: 'Cancel', confirm: 'Confirm', removeOverride: 'Remove override',
        upload: 'Upload asset', replace: 'Replace', delete: 'Delete', previousPage: 'Previous page', nextPage: 'Next page',
      },
      lifecycle: {
        title: 'Lifecycle', autosave: 'Autosave', preview: 'Preview', readiness: 'Publication readiness',
        pdfa: 'PDF/A', einvoice: 'E-invoice', unchecked: 'Not checked', current: 'Current', updating: 'Updating',
        publishBlocked: 'Publication remains disabled until the latest saved version is checked and has no blockers.',
        scheduledFor: 'Scheduled for {{date}}', effectiveSince: 'Effective since {{date}}',
      },
      sections: {
        basic: 'Basic layout', page: 'Page and margins', typography: 'Typography and colors',
        header: 'Header and table', title: 'Title and metadata', positions: 'Positions and technical data',
        totals: 'Totals, tax and payment', notes: 'Document notes and text blocks', footer: 'Footer',
        assets: 'Assets and fonts', compliance: 'PDF/A and e-invoice', changed: '{{count}} changed values',
        inherited: 'Inherited', blockers: '{{count}} blockers', warnings: '{{count}} warnings',
      },
      templates: {
        label: 'Template', classic: 'Classic', modern: 'Modern', compact: 'Compact',
        classicHint: 'Traditional business layout with a compact table.',
        modernHint: 'Generous layout with a clear typographic hierarchy.',
        compactHint: 'Space-saving layout for documents with many positions.',
      },
      page: {
        format: 'Paper format', orientation: 'Orientation', portrait: 'Portrait',
        marginTop: 'Top margin', marginRight: 'Right margin', marginBottom: 'Bottom margin', marginLeft: 'Left margin',
        firstPageTop: 'Content start on first page', followingPageTop: 'Content start on following pages',
        firstLetterhead: 'Use letterhead on first page', followingLetterhead: 'Use letterhead on following pages',
        reuseFirstLetterhead: 'Reuse first-page letterhead', marginHint: 'Printable page margin in millimetres.',
        letterheadHint: 'Letterhead assets remain separate for first and following pages.',
      },
      typography: {
        fontFamily: 'Font family', baseSize: 'Base font size', tableSize: 'Table font size',
        metadataSize: 'Metadata font size', headingScale: 'Heading scale', lineHeight: 'Line height',
        paragraphSpacing: 'Paragraph spacing', accentColor: 'Accent color', textColor: 'Text color',
        mutedColor: 'Muted text color', embeddingHint: 'Only fonts with confirmed embedding rights can be published.',
      },
      header: {
        showLogo: 'Show logo', logoWidth: 'Logo width', logoAlignment: 'Logo alignment',
        showCompanyDetails: 'Show company details', showSenderLine: 'Sender line above recipient',
        recipientWindow: 'Recipient window', recipientTop: 'Recipient position from top',
        left: 'Left', center: 'Center', right: 'Right',
      },
      titleBlock: {
        showTitle: 'Show document title', showDocumentNumber: 'Show document number',
        showIssueDate: 'Show issue date', showServiceDate: 'Show service date', showDueDate: 'Show due date',
        showCustomerNumber: 'Show customer number', metadataAlignment: 'Metadata alignment',
        titleSpacing: 'Spacing below title',
      },
      positions: {
        tableStyle: 'Table density', compact: 'Compact', standard: 'Standard', spacious: 'Spacious',
        showPositionNumber: 'Position number', showDescription: 'Description', showQuantity: 'Quantity',
        showUnit: 'Unit', showUnitPrice: 'Unit price', showNetAmount: 'Net amount', showTaxRate: 'Tax rate',
        showTotal: 'Line total', showSecondaryDescription: 'Secondary description', repeatHeader: 'Repeat table header',
      },
      technical: {
        enabled: 'Show technical print data', showPrinter: 'Printer', showPlate: 'Plate', showMaterial: 'Material',
        showPrintTime: 'Print time', showWeight: 'Weight', showFileName: 'File name', placement: 'Placement',
        atPosition: 'At the position', inNotes: 'In the notes section',
      },
      totals: {
        showSubtotal: 'Subtotal', showDiscount: 'Discount', showTaxBreakdown: 'Tax breakdown',
        showGrossTotal: 'Gross total', showPrepayments: 'Prepayments', showPaymentTerms: 'Payment terms',
        showBankDetails: 'Bank details', alignment: 'Totals alignment',
      },
      notes: {
        showIntro: 'Introduction text', showOutro: 'Closing text', showPaymentNote: 'Payment note',
        showLegalNote: 'Legal and tax note', introPlacement: 'Introduction placement',
        beforeTitle: 'Before title', beforePositions: 'Before positions', outroPlacement: 'Closing placement',
        afterPositions: 'After positions', afterTotals: 'After totals', keepWithNext: 'Keep heading with following content',
      },
      footer: {
        enabled: 'Use footer', columnLayout: 'Footer layout', oneColumn: 'One column', twoColumns: 'Two columns',
        threeColumns: 'Three columns', showCompanyData: 'Company data', showTaxData: 'Tax details',
        showBankData: 'Bank details', showAlternativePayment: 'Alternative payment details',
        showAdditionalNotes: 'Additional notes', showPageNumbers: 'Page numbers', pageNumberFormat: 'Page-number format',
        pageNumberHint: 'Use {page} and {pages} as placeholders.',
      },
      inheritance: {
      ...
      assets: {
        ...
        logo: 'Logo', letterheadFirst: 'First-page letterhead', letterheadFollowing: 'Following-page letterhead',
        fontRegular: 'Body font', fontBold: 'Bold font', fontItalic: 'Italic font', fontBoldItalic: 'Bold italic font',
        allowed: 'SVG, PNG, JPEG, PDF letterhead, WOFF2 or TTF; maximum 10 MiB.',
        uploading: 'Uploading {{percent}}%', sha: 'SHA-256 {{hash}}', usedBy: 'Used as {{role}}',
        deleteBlocked: 'This asset is still assigned and cannot be deleted.',
        preflight: { pending: 'Preflight pending', valid: 'Preflight passed', invalid: 'Preflight failed', details: 'Preflight details' },
      },
      preview: {
        title: 'PDF preview', empty: 'Select or create a draft to generate a preview.',
        unchecked: 'Save and check the current draft before generating a preview.',
        loading: 'Generating PDF preview...', updating: 'Preview is being updated; the previous version remains visible.',
        failed: 'The PDF preview could not be generated.', page: 'Page {{page}} of {{pages}}', zoom: 'Zoom',
        fit: 'Fit page', download: 'Download preview PDF', paper: '{{format}} portrait',
        directDownload: 'Canvas display failed. The authorized PDF download is still available.',
      },
      findings: {
        title: 'Findings', none: 'No findings for the latest saved version.', blocker: 'Blocker', warning: 'Warning',
        info: 'Information', field: 'Affected field', rule: 'External rule', correction: 'Correction',
        goToField: 'Go to field', stale: 'The findings belong to an older draft and must be refreshed.',
      },
      compliance: {
        title: 'Compliance evidence', pdfa: 'PDF/A-3u', pdfaValid: 'PDF/A validation passed',
        pdfaInvalid: 'PDF/A validation failed', renderer: 'Renderer {{version}}', validator: 'Validator {{version}}',
        einvoice: 'Electronic invoice', zugferd: 'ZUGFeRD / Factur-X', xrechnung: 'XRechnung',
        pdfOriginal: 'The PDF is the original; validated invoice XML is embedded.',
        xmlOriginal: 'The XML is the original; the PDF is a separate visual copy.',
        xmlProfile: 'XML profile {{profile}}', xmlHash: 'XML SHA-256 {{hash}}',
        notApplicable: 'Not applicable to this document type.',
      },
      history: {
        title: 'Layout history', version: 'Version {{version}}', validFrom: 'Effective from',
        validUntil: 'Effective until', actor: 'Changed by', reason: 'Reason', session: 'Edit session',
        changedFields: 'Changed fields', auditRestricted: 'Detailed audit data requires order-audit permission.',
        empty: 'No layout versions exist for this scope.',
      },
      dialogs: {
        cloneTitle: 'Clone layout', cloneReason: 'Reason for the new draft',
        publishTitle: 'Publish layout', publishReason: 'Publication reason', effectiveFrom: 'Effective from',
        publishNow: 'Publish now', publishLater: 'Schedule publication', withdrawTitle: 'Withdraw publication',
        withdrawReason: 'Reason for withdrawal', reasonRequired: 'Enter a reason with at least three characters.',
        dateRequired: 'Select a future publication date.',
      },
      mobile: {
        previewFirst: 'Preview first', controlsAfterPreview: 'Layout controls follow the preview.',
        openControls: 'Open layout controls', closeControls: 'Close layout controls',
      },
      errors: {
        load: 'The layout workspace could not be loaded.', save: 'The draft could not be saved.',
        conflict: 'This draft was changed in another session.', reload: 'Reload latest version',
        preview: 'Preview generation failed.', readiness: 'Readiness could not be checked.',
        permission: 'You do not have permission for this action.', unknown: 'An unexpected layout error occurred.',
      },
    },
    documents: {
      ...
      status: { draft: 'Draft', scheduled: 'Scheduled', active: 'Active', superseded: 'Superseded', missingDraft: 'Sin borrador' },
      ...
      readOnlyHint: 'You have read-only access. Editing actions are disabled.',
      permissionDenied: 'You do not have permission to view document settings.',
      loading: 'Loading document configuration...',
      loadError: 'Document settings could not be loaded.',
      actions: { create: 'Create draft', check: 'Check readiness', save: 'Save draft', publish: 'Publish', withdraw: 'Withdraw schedule', clone: 'Create new version' },
      messages: { createSuccess: 'Draft created.', saveSuccess: 'Draft saved.', checkSuccess: 'Readiness refreshed.', publishSuccess: 'Configuration published.', cloneSuccess: 'New draft version created.', withdrawSuccess: 'Scheduled publication withdrawn.', actionFailed: 'The action failed.' },
      policy: { title: 'Configuration', hint: 'The policy sections below are saved as a versioned draft. Published versions remain immutable.' },
      inheritance: { system: 'System default', businessProfile: 'Business profile', customer: 'Inherited from customer', configuration: 'Configuration', document: 'Document override', reset: 'Restore default' },
      basic: { title: 'Document rules', description: 'Dates, references, successors, rounding and technical content.', subject: 'Subject', validityDays: 'Validity in days', dateRule: 'Relevant date', dates: { issue: 'Issue date', service: 'Service date', delivery: 'Delivery date' }, rounding: 'Rounding', roundingModes: { commercial: 'Commercial', bankers: 'Banker’s rounding', down: 'Always down' }, references: 'Required references', reference: { customer_reference: 'Customer reference', order_reference: 'Order reference', service_period: 'Service period' }, successors: 'Allowed follow-up documents', technicalContent: 'Technical content', includeCalculation: 'Include calculation and print data', content: { print_time: 'Print time', material: 'Material', plate_notes: 'Plate notes' } },
      payment: { title: 'Payment and dunning', description: 'Due dates, discounts, installments, bank assignment and escalation stages.', termDays: 'Payment term in days', currency: 'Currency', dueBasis: 'Due date based on', bankAccount: 'Bank account ID', discountDays: 'Cash discount period', discountPercent: 'Cash discount', prepayment: 'Advance payment', methods: { bank_transfer: 'Bank transfer', cash: 'Cash', card: 'Card', direct_debit: 'Direct debit', paypal: 'PayPal' }, useTermInText: 'Use payment term in invoice text', installments: 'Installment plan', installmentPercent: 'Share', installmentDue: 'Due after days', removeInstallment: 'Remove installment', installmentTotalError: 'Installments must add up to 100%.', addInstallment: 'Add installment', dunningEnabled: 'Enable dunning', interest: 'Annual default interest', flatFee: 'Default fee', stage: 'Stage {{level}}', removeStage: 'Remove stage', waitDays: 'Wait days', stageFee: 'Stage fee', newDueDays: 'New payment term', stageText: 'Dunning text', chargeInterest: 'Charge interest', addStage: 'Add dunning stage' },
      textBlocks: { title: 'Text blocks', description: 'Reusable wording with document-specific placeholders.', insertPlaceholder: 'Insert placeholder', choosePlaceholder: 'Choose placeholder', purposes: { intro: 'Introduction', closing: 'Closing', payment_terms: 'Payment terms', delivery_terms: 'Delivery terms', tax_note: 'Tax note', footer: 'Footer', dunning_notice: 'Dunning notice' } },
      placeholders: { company_name: 'Company name', company_address: 'Company address', company_tax_id: 'Tax number', company_vat_id: 'VAT ID', customer_name: 'Customer name', customer_number: 'Customer number', customer_address: 'Customer address', customer_email: 'Customer email', customer_vat_id: 'Customer VAT ID', document_number: 'Document number', document_issue_date: 'Issue date', document_due_date: 'Due date', document_service_date: 'Delivery date', document_currency: 'Currency', payment_term_days: 'Payment term', payment_discount_deadline: 'Cash discount deadline', payment_discount_percent: 'Cash discount rate', dunning_stage: 'Dunning stage', dunning_fee: 'Dunning fee', dunning_new_due_date: 'New due date', DOCUMENT_NUMBER: 'Document number', VALID_UNTIL: 'Valid until', ORDER_REFERENCE: 'Order reference', DUE_DATE: 'Due date', SERVICE_DATE: 'Service date', ORIGINAL_DOCUMENT_NUMBER: 'Original document number', OPEN_AMOUNT: 'Open amount', CURRENCY: 'Currency', DUNNING_LEVEL: 'Dunning level' },
      tax: { title: 'Tax determination', description: 'Permitted tax outcomes and governed manual deviations.', ruleVersion: 'Tax rules {{version}}', allowedCases: 'Permitted tax cases', allowOverride: 'Permit reasoned tax overrides on documents', recordedOverride: 'Recorded manual override', manualOverride: 'Set a manual tax deviation', treatment: 'Tax treatment', taxCountry: 'Tax country', placeOfSupply: 'Place of supply', category: 'VAT category', rate: 'Tax rate', legalReasonCode: 'Legal reason code', legalReasonText: 'Legal reason', sellerVatId: 'Seller VAT ID', buyerVatId: 'Buyer VAT ID', evidence: 'Validation evidence', overrideReason: 'Reason', applyOverride: 'Apply deviation', cases: { domestic_standard: 'Domestic standard rate', small_business_exempt: 'Small-business exemption', intra_community_supply: 'Intra-community supply', eu_reverse_charge: 'EU reverse charge', eu_b2c_oss: 'EU B2C / OSS', third_country: 'Third country', explicit_exemption: 'Explicit exemption' } },
      einvoice: { title: 'E-invoice', description: 'EN 16931, XRechnung and ZUGFeRD delivery policy.', requirement: 'Requirement', optional: 'Optional', ruleRequired: 'Required according to rules', syntax: 'Syntax', pinned: 'Pinned by the installed validator', zugferdProfile: 'ZUGFeRD profile', processId: 'Business process ID', sellerEndpoint: 'Seller electronic address', endpointScheme: 'Electronic address scheme', buyerEndpoint: 'Buyer electronic address', buyerReference: 'Buyer reference / Leitweg-ID', defaultPaymentMethod: 'Default payment method', bankAccount: 'Bank account ID', validationLayers: 'Validation layers', layers: { xsd: 'XML Schema (XSD)', en16931: 'EN 16931 business rules', cius: 'CIUS / XRechnung' }, validationStatus: 'Validation', downloadXml: 'Download XML', downloadReport: 'Download validation report', findingCount: '{{count}} findings' },
      empty: { title: 'No configuration for this context', description: 'Create a draft from the system defaults, then review it before publication.' },
      history: { title: 'Version history', empty: 'No versions exist for this context yet.', version: 'Version', status: 'Status', effectiveFrom: 'Effective from', reason: 'Change reason', actor: 'Created / published by', rules: 'Rule versions', publishedAt: 'Published', auditTitle: 'Audit trail', auditEmpty: 'No audit events recorded yet.', correlation: 'Correlation ID', actions: { create: 'Draft created', update: 'Draft updated', clone: 'Version cloned', publication: 'Version published', withdraw: 'Publication withdrawn' } },
      unsaved: { title: 'Unsaved changes', message: 'Changing the document context would discard the current changes.', discard: 'Discard changes' },
      publish: { title: 'Publish configuration', description: 'The published version becomes immutable and applies from the selected date.', effectiveFrom: 'Effective from', reason: 'Reason: {{reason}}' },
      documentTypes: { quotation: 'Quotation', order_confirmation: 'Order confirmation', delivery_note: 'Delivery note', advance_invoice: 'Advance invoice', progress_invoice: 'Progress invoice', final_invoice: 'Final invoice', invoice: 'Invoice', cancellation_invoice: 'Cancellation invoice', invoice_correction: 'Invoice correction', commercial_credit_note: 'Commercial credit note', payment_reminder: 'Payment reminder', dunning_notice: 'Dunning notice', self_billing: 'Self-billing invoice' },
    },
    spoolbuddy: {
    ...
    ldap: {
      ...
      feature3: 'Los grupos LDAP se asignan a los grupos de PrintOps al iniciar sesión',
      ...
      autoProvisionHint: 'Crear automáticamente una cuenta de PrintOps en el primer inicio de sesión LDAP',
      ...
      groupMappingHint: 'Asignar los DN de grupos LDAP a los grupos de PrintOps. Grupos disponibles: ',
    ...
    localLogin: {
      ...
      disableHint: 'Cuando se habilita, solo los proveedores SSO pueden iniciar sesión. LDAP no se ve afectado. Defina PRINTOPS_LOCAL_LOGIN=true en el servidor para mantener una vía de recuperación.',
    },
    // Queue
    ...
    preheatFilamentTargetsHint: 'PrintOps elige el objetivo más alto entre los slots AMS cargados; las impresiones solo PLA derivan 0 y omiten la fase de cámara automáticamente.',
    ...
    authDisabledMessage: 'Active la autenticación para crear cuentas de usuario, gestionar permisos y proteger su instancia de PrintOps.',
    ...
    disableAuthenticationMessage: '¿Está seguro de que desea desactivar la autenticación? Esto hará que su instancia de PrintOps sea accesible sin iniciar sesión. Todos los usuarios permanecerán en la base de datos, pero la autenticación se desactivará.',
    disableAuthentication: 'Desactivar la autenticación',
    // Additional settings
    configurePrintOps: 'Configurar PrintOps',
    ...
    noticePreferences: 'Avisos',
    showDeveloperLanWarning: 'Mostrar aviso de Developer LAN',
    showDeveloperLanWarningDesc: 'Avisar arriba en la app cuando una impresora conectada no tenga activado el modo Developer LAN.',
    showSponsorPrompts: 'Mostrar avisos de apoyo',
    showSponsorPromptsDesc: 'Mostrar avisos ocasionales sobre colaboradores y financiacion comunitaria de PrintOps.',
    ...
    progressInTitle: 'Mostrar progreso de impresión en la pestaña',
    progressInTitleHint: 'Cuando una impresora está imprimiendo, el título y el favicon muestran el porcentaje activo.',
    // Archive
    ...
    captureFinishPhotoDescription: 'Tomar una foto desde la cámara de la impresora cuando se completa la impresión. PrintOps graba un breve timelapse durante la impresión para que la foto pueda obtenerse del momento previo al descenso de la cama; el archivo del timelapse se conserva si activaste el timelapse para esta impresión, de lo contrario se elimina automáticamente tras capturar la foto.',
    ...
    cameraUrlBuilderToggle: 'Crear URL a partir de host, puerto y ruta',
    cameraUrlBuilderHost: 'Host o IP',
    cameraUrlBuilderPort: 'Puerto',
    cameraUrlBuilderPath: 'Ruta (p. ej. /stream)',
    cameraUrlBuilderUsername: 'Usuario (opcional)',
    cameraUrlBuilderPassword: 'Contraseña (opcional)',
    cameraUrlBuilderHelp: 'Completa el campo de URL de la cámara de arriba. Se valida y prueba igual que una URL introducida manualmente.',
    ...
    printopsSoftware: 'Software de PrintOps',
    ...
    updateViaHomeAssistant: 'Las actualizaciones las gestiona el Supervisor de Home Assistant. Abra Ajustes → Complementos → PrintOps en Home Assistant para instalar la nueva versión.',
    ...
    externalUrlDescription: 'La URL externa donde PrintOps es accesible. Se usa para las imágenes de notificación y las integraciones externas.',
    printopsUrl: 'URL de PrintOps',
    ...
    mqttDescription: 'Publique los eventos de PrintOps en un broker MQTT externo para la integración con Node-RED, Home Assistant y otros sistemas de automatización.',
    ...
    oidc: {
      ...
      form: {
        ...
        enabled: 'Activado',
        allowPrivateNetwork: 'Permitir IdP en red privada',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'Los secretos TOTP y los client_secrets de OIDC se almacenan en texto plano. Establezca MFA_ENCRYPTION_KEY o reinicie PrintOps con un directorio de datos con permisos de escritura para generar una automáticamente.',
      ...
      migrationErrorWarning: '{{count}} fila(s) heredada(s) no se pudieron volver a cifrar al iniciar. Revise los registros del servidor y reinicie PrintOps para reintentarlo.',
    },
  ...
  hmsErrors: {
    ...
    runoutExpectedSlot: 'El filamento se agotó en {{ranOut}}. La impresión ahora espera filamento en {{expected}}.',
    runoutExpectedSlotOnly: 'El filamento se agotó. La impresión ahora espera filamento en {{expected}}.',
    runoutSlotUnknown: 'El filamento se agotó. Compruebe en la impresora qué slot AMS se espera.',
  ...
  // Login page
  login: {
    title: 'Inicio de sesión en PrintOps',
    ...
    resetStep1: 'Póngase en contacto con su administrador de PrintOps',
    ...
    twoFA: {
      ...
      instructionsTotp: 'Abra su aplicación de autenticación e introduzca el código de 6 dígitos para PrintOps.',
  ...
  // Setup page
  setup: {
    title: 'Configuración de PrintOps',
    subtitle: 'Configure la autenticación para su instancia de PrintOps',
  ...
  camera: {
    ...
    diagnose: {
      ...
      info: {
        title: 'Detalles de la transmisión en vivo',
        pipeline: 'Flujo de procesamiento',
        codec: 'Códec',
        resolution: 'Resolución',
        fps: 'FPS (objetivo / medido)',
        bitrate: 'Tasa de bits',
        uptime: 'Tiempo activo de la transmisión',
        tlsProxy: 'Proxy TLS',
        go2rtcStream: 'Transmisión go2rtc',
        notActive: 'No hay ninguna transmisión activa para esta impresora en este momento.',
        pipelineName: {
          go2rtc: 'go2rtc (fuente RTSP, sirve MSE + MJPEG)',
          go2rtc_chamber_bridge: 'go2rtc (puente de imagen de cámara, solo MJPEG)',
          chamber_binary: 'Protocolo de imagen de cámara (binario propietario)',
          external_mjpeg: 'Cámara externa (MJPEG, vía go2rtc)',
          external_rtsp: 'Cámara externa (RTSP, vía go2rtc)',
          external_snapshot: 'Cámara externa (instantánea HTTP, vía go2rtc)',
          external_usb: 'Cámara externa (USB/v4l2, directa)',
        },
        player: 'Reproductor',
        playerName: {
          mse: 'MSE (H.264, sin recodificación)',
          mjpeg: 'MJPEG (alternativa)',
  ...
  users: {
    ...
    subtitle: 'Gestione los usuarios y su acceso a su instancia de PrintOps',
    backToSettings: 'Volver a Ajustes',
    createUser: 'Crear usuario',
    noPermission: 'No tiene permiso para acceder a esta página.',
    admin: 'Administrador',
    ...
    form: {
      ...
      groups: 'Grupos',
      printerScope: 'Acceso a impresoras',
      allPrinters: 'Todas las impresoras',
      printerScopeCount: '{{count}} impresoras',
      optional: 'opcional',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Inicia sesión en tu cuenta Orca Cloud para sincronizar tus perfiles de slicer en PrintOps.',
      },
      device: {
        title: 'Aprueba PrintOps en Orca Cloud',
        instruction: 'Abre Orca Cloud y aprueba este código. PrintOps se conecta automáticamente en cuanto lo apruebes.',
    ...
    connectedAs: 'Conectado como',
    signInExpired: 'Tu inicio de sesión de Bambu Cloud ha caducado. Inicia sesión de nuevo para usar los preajustes en la nube.',
    logout: 'Cerrar sesión',
  ...
  sponsors: {
    ...
    tagline: 'PrintOps es gratuito y seguirá siéndolo porque hay quien decide apoyarlo. Sin VC, sin dependencia de la nube.',
    viewSupporters: 'Ver patrocinadores',
    toastPrints: 'Has completado {{count}} impresiones con PrintOps. PrintOps sigue siendo gratuito gracias a quienes lo apoyan.',
    toastCost: 'Has rastreado {{total}} de filamento con PrintOps. Mira quién mantiene el proyecto independiente.',
    toastArchives: '{{count}} impresiones archivadas con PrintOps. Mira quién lo mantiene independiente.',
    toastAnniversary: '¡Un año con PrintOps! Mira quién mantiene el proyecto independiente.',
    toastVersionUpdate: 'Actualizado a v{{version}}. PrintOps sigue siendo gratuito gracias a quienes lo apoyan.',
  },
...
useEmbedded: 'Usar los ajustes integrados del archivo',
    useEmbeddedHint: 'Lamina como lo configuró el diseñador (paredes, relleno, filamento) en lugar de los perfiles de arriba. Disponible porque tu impresora coincide con el archivo.',
  ...
  inventory: {
    ...
    bulk: {
      ...
      mergeTargetPrompt: 'ID de bobina destino entre los ID seleccionados ({{ids}})',
      mergeInvalidTarget: 'Elige uno de los ID de bobina seleccionados como destino',
      mergeSuccess: '{{count}} bobinas duplicadas combinadas',
      mergeFailed: 'No se pudo combinar',
      invalidHex: 'Introduzca 6 caracteres hex (RRGGBB) u 8 (RRGGBBAA). De lo contrario el campo no se aplicará.',
    },
    refill: 'Rellenar',
    refillPrompt: 'Peso rellenado en gramos para la bobina #{{id}}',
    refillInvalidWeight: 'Introduce un peso mayor que 0 g',
    refillSuccess: 'Relleno de bobina registrado',
    refillFailed: 'No se pudo registrar el relleno de bobina',
    spoolmanMixedContentTitle: 'Spoolman no se puede cargar por HTTPS — contenido mixto bloqueado por su navegador',
    spoolmanMixedContentBody: 'PrintOps se sirve por HTTPS (mediante su proxy inverso), pero su URL de Spoolman sigue siendo HTTP sin cifrar. Los navegadores bloquean el contenido mixto por seguridad, por lo que la interfaz integrada de Spoolman no se puede mostrar. Spoolman debe ser accesible por HTTPS para que esto funcione.',
    spoolmanMixedContentFixReverseProxy: 'Ponga Spoolman tras el mismo proxy inverso que PrintOps (Traefik / Nginx / Caddy) con HTTPS y luego actualice la URL de Spoolman en Ajustes a la nueva dirección HTTPS.',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'El repositorio es PÚBLICO. Las copias de seguridad de PrintOps incluyen credenciales de MQTT, tokens de Home Assistant, tokens de Prometheus, su correo de Bambu Cloud y los códigos de acceso de las impresoras mediante los perfiles K. El guardado está bloqueado hasta que haga el repositorio privado en los ajustes de su proveedor.',
    repoVisibilityUnknown: 'No se pudo determinar la visibilidad del repositorio. PrintOps se niega a hacer copias de seguridad en cualquier cosa que no se confirme como privada; el guardado se bloqueará.',
    ...
    appSettingsDescription: 'Configuración de PrintOps (base de datos completa)',
    ...
    localBackupDescription: 'Cree una copia de seguridad completa de sus datos de PrintOps, incluida la base de datos, los archivos, las subidas y todos los archivos.',
    ...
    backupRestoredRestart: 'Copia de seguridad restaurada. Reinicie PrintOps.',
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Las notas se guardan en PrintOps, no en la impresora',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visible como "PrintOps" en la detección del laminador',
    ...
    remoteInterface: {
      ...
      hint: 'Anula la dirección IP anunciada mediante SSDP y usada en el certificado TLS. Útil cuando PrintOps tiene varias interfaces de red.',
    },
    mode: {
      title: 'Modo',
      archive: 'Archivar',
    ...
    caCert: {
      ...
      description: 'Las impresoras virtuales usan un certificado TLS firmado por la CA de PrintOps. Importe este certificado de CA en el almacén de confianza de su laminador una sola vez para que acepte la conexión — sin necesidad de copiarlo desde la línea de comandos.',
      copy: 'Copiar',
      copied: 'Copiado',
      download: 'Descargar',
      fingerprint: 'SHA-256',
    ...
    howItWorks: {
      ...
      step2: 'En los modos Archivar, Revisar y Encolar, use el botón «Enviar» de su laminador para subir archivos 3MF a PrintOps. El laminador mostrará «Impresión correcta» — el archivo se almacena, no se imprime.',
  ...
  haSensors: {
    ...
    blockPrintHint: 'Los trabajos siguen en cola hasta que el sensor se despeja. Si Home Assistant no está accesible, se aplica la estrategia de fallo elegida.',
    safeState: 'Estado seguro: {{state}}',
    failureStrategyLabel: 'Cuando Home Assistant no está disponible',
    failureAuto: 'Automático (los sensores críticos bloquean)',
    failureOpen: 'Permitir la impresión (fail-open)',
    failureClosed: 'Retener la impresión (fail-closed)',
    failureStrategyHint: 'Los sensores de seguridad críticos retienen la cola si no hay una lectura reciente.',
    primarySafetyWarning: 'Los interlocks de PrintOps son controles secundarios. Mantén una protección física independiente.',
    failure: {
      auto: 'Fallo: automático',
      fail_open: 'Fallo: permitir impresión',
      fail_closed: 'Fallo: retener impresión',
    },
    override: {
      unavailable: 'Interlock fail-closed no disponible: {{sensors}}',
      open: 'Anular temporalmente',
      reasonLabel: 'Motivo de la anulación temporal',
      confirm: 'Confirmar anulación',
      clear: 'Restaurar interlock',
      active: 'Anulación activa por {{user}}: {{reason}}',
      unknownUser: 'usuario desconocido',
      error: 'No se pudo cambiar la anulación del interlock.',
    },
    toast: {
  ...
  smartPlugs: {
    ...
    linkTarget: 'Destino de vinculación',
    noTarget: 'Sin destino (solo control manual)',
    targetPrinter: 'Impresora',
    targetDryer: 'Secador de filamento',
    selectPrinter: 'Seleccionar impresora',
    selectDryer: 'Seleccionar secador de filamento',
    ...
    restEnergyTotalPath: 'Ruta JSON de energía total',
    restEnergyTotalMultiplier: 'Multiplicador de energía total',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      bark: 'Notificaciones push iOS sin cuenta mediante Bark',
    ...
    pushoverExpire: 'Caducidad de emergencia (s)',
    botToken: 'Token del bot',
    chatId: 'ID del chat',
    telegramThreadId: 'ID del tema del foro',
    telegramThreadIdInvalid: 'El ID del tema del foro debe ser un número',
    barkDeviceKey: 'Clave del dispositivo',
    barkGroup: 'Grupo',
    barkSound: 'Sonido',
    barkLevel: 'Nivel de interrupción',
    barkLevelDefault: 'Predeterminado',
    barkLevelPassive: 'Pasivo',
    barkLevelActive: 'Activo',
    barkLevelTimeSensitive: 'Sensible al tiempo',
    barkLevelCritical: 'Crítico',
  ...
  externalLinks: {
    ...
    systemPages: 'Páginas de PrintOps',
    ...
    childPageOf: 'Subpágina de {{parent}}',
    hiddenByParent: 'Oculto por {{parent}}',
    showParentFirst: 'Mostrar primero {{parent}}',
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      backendUrl: 'URL del backend de PrintOps',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'PrintOps se está ejecutando en red de tipo bridge de Docker. La detección de impresoras y la impresora virtual necesitan el modo de red de host — vuelva a crear el contenedor con "network_mode: host".',
        skip: 'No se está ejecutando en Docker — no aplicable.',
      },
      subnet: {
        title: 'Subred de la red',
        pass: 'La impresora y PrintOps están en la misma subred.',
        warn: 'La impresora ({{printer_ip}}) y PrintOps ({{host_ip}}) están en subredes distintas. Es posible que no se alcancen entre sí a menos que se configure el enrutamiento entre las subredes.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Vuelve a copiar el código de acceso desde la pantalla de la impresora (ajustes de LAN) y actualízalo en los ajustes de la impresora en PrintOps.',
      },
      'ftp-connection-timeout': {
        name: 'Se agotó el tiempo de la conexión de transferencia de archivos',
        cause: 'PrintOps no pudo alcanzar el puerto de transferencia de archivos de la impresora (FTPS 990). El puerto está bloqueado, o la impresora está apagada o en otra subred.',
        fix: 'Asegúrate de que nada bloquee el puerto 990 entre PrintOps y la impresora, y de que ambos estén en la misma red.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Cambia PrintOps a una base de datos PostgreSQL externa. Consulta la guía de PostgreSQL en la documentación.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'La impresora virtual está habilitada pero sus servicios no se están ejecutando. Revise el registro de PrintOps — normalmente los detiene un conflicto de IP de enlace o un error de permisos.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificado listo. Asegúrese de que el certificado de CA de PrintOps (arriba) esté importado en el almacén de confianza de su laminador.',
        fail: 'Falta el certificado TLS de esta impresora virtual. Compruebe que el directorio de datos de PrintOps tenga permisos de escritura.',
      },
    },
  },
  ...
  bugReport: {
    ...
    manualReportTitle: 'Informar mediante GitHub',
    manualReportDescription: 'PrintOps usa el formulario público de issues de GitHub para los informes de errores. Así no hace falta configurar un relay por instalación y mantienes el control de los datos enviados.',
    openIssueForm: 'Abrir issue de GitHub',
  ...
  failureDetection: {
    ...
    mlToken: 'Token de API ML (opcional)',
    mlTokenPlaceholder: 'Déjelo vacío si el servidor funciona sin ML_API_TOKEN',
    mlTokenHint: 'Debe coincidir con la variable ML_API_TOKEN del contenedor ml_api de Obico. Déjelo vacío si el contenedor no usa token.',
    test: 'Probar',
    testSuccess: 'API de ML accesible y correcta.',
    testSuccessTokenUnknown: 'La API ML está accesible y sana. No se pudo comprobar el token.',
    ...
    externalUrlHint: 'La API de ML obtiene la captura de la cámara por URL. Establezca la URL externa en los ajustes generales para que el contenedor de la API de ML pueda alcanzar PrintOps.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Pegue la URL de un modelo de MakerWorld para importarlo e imprimirlo directamente desde PrintOps — sin tener que salir a la aplicación Bambu Handy.',
    ...
    disclaimer: 'La integración con MakerWorld usa puntos de conexión de API documentados por la comunidad. PrintOps no está afiliado a MakerWorld ni a Bambu Lab ni cuenta con su respaldo.',
  ...
  libraryPurge: {
    ...
    effect4: 'Los archivos de carpetas externas (vinculadas) se omiten — PrintOps nunca elimina bytes que no le pertenecen.',
  ...
  forecast: {
    ...
    collapseSku: 'Contraer {{label}}',
    procurementTitle: 'Compras',
    procurementLoadingOffers: 'Cargando fuentes de suministro …',
    procurementOffersLoadError: 'No se pudieron cargar las fuentes de suministro.',
    procurementRetryOffers: 'Reintentar fuentes de suministro',
    procurementSuppliersLoadError: 'No se pudieron cargar los proveedores.',
    procurementRetrySuppliers: 'Reintentar proveedores',
    procurementSave: 'Guardar fuentes de suministro',
    procurementSaved: 'Fuentes de suministro guardadas',
    procurementSaveFailed: 'No se pudieron guardar las fuentes de suministro',
    // Table headers
    sku: 'SKU',
    material: 'Material',
    stock: 'Existencias',
  ...
  suppliers: { navTitle: 'Proveedores', title: 'Proveedores', subtitle: 'Gestiona los contactos y las condiciones de compra.', createTitle: 'Añadir proveedor', editTitle: 'Editar proveedor', searchLabel: 'Buscar proveedores', searchPlaceholder: 'Empresa, contacto, correo electrónico, número de cliente …', activeFilter: 'Estado', loading: 'Cargando proveedores …', empty: 'Aún no hay proveedores que coincidan.', noContact: 'Sin datos de contacto', leadTime: '{{count}} días de plazo de entrega estándar', sections: { masterData: 'Datos maestros', contactAddress: 'Contacto y dirección', procurement: 'Compras', internalNotes: 'Nota interna' }, fields: { name: 'Empresa', customerNumber: 'Número de cliente', active: 'Proveedor activo', contactName: 'Persona de contacto', email: 'Correo electrónico', phone: 'Teléfono', website: 'Sitio web', addressLine1: 'Línea de dirección 1', addressLine2: 'Línea de dirección 2', postalCode: 'Código postal', city: 'Ciudad', countryCode: 'Código de país', paymentTerms: 'Condiciones de pago', defaultLeadTime: 'Plazo de entrega estándar', internalNotes: 'Notas internas' }, filters: { active: 'Activos', inactive: 'Inactivos', all: 'Todos los proveedores' }, actions: { create: 'Añadir proveedor', save: 'Guardar proveedor', edit: 'Editar {{name}}', delete: 'Eliminar proveedor' }, validation: { nameRequired: 'La empresa es obligatoria.' }, errors: { load: 'No se pudieron cargar los proveedores.', save: 'No se pudo guardar el proveedor.', delete: 'No se pudo eliminar el proveedor.', noReadPermission: 'No tienes permiso para ver los proveedores.' } },
};
