export default {
  ...
  bugReport: {
    ...
    manualFallbackTitle: 'El envío automático no está configurado',
    manualFallbackDescription: 'Esta instalación no puede enviar informes de errores directamente a GitHub. Abre el formulario de issues de GitHub y pega allí tu descripción.',
