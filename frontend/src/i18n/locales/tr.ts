export default {
  orderUiNotFound: 'Kayıt bulunamadı.',
  ...
  printers: {
    ...
    camWall: {
      ...
      page: {
        tokenRejected: 'Bu kamera duvarı belirteci reddedildi veya süresi doldu.',
        loadFailed: 'Kamera duvarı yüklenemedi.',
      },
    },
    // Kontroller
    ...
    expectedSlot: {
      ...
      label: '{{ams}} · Yuva {{slot}}',
      title: 'Duraklatılan baskı burada filament bekliyor',
      ariaLabel: 'Beklenen yedek slot {{n}}',
    },
    // Filamentler bölümü
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedNotice: 'Beklenen {{owed}} çalışmanın {{runs}} tanesi kuyruğa alınamıyor: ayarların kopyalanacağı bir çalışma kalmadı. Plakayı dosyadan kuyruğa alın veya yığını iptal edin.',
    ...
    cancelBatchConfirmMessage: 'Bu yığın kapatılsın mı? Kuyruktaki çalışmalar iptal edilir ve üretilmeyen miktarlar silinir.',
    batch: {
      defaultName: 'Yığın',
      label: '{{count}} öğe',
    ...
    toast: {
      ...
      keptForOrder: 'Kaldırılmadı: “{{name}}” bu çalışmayı plakanın yeniden kullanılabilir tek ayarı olarak hâlâ gerektiriyor',
      historyKeptForOrders: 'Açık yığınların ihtiyaç duyduğu {{kept}} ayar korundu.',
  ...
  stats: {
    ...
    energySource: {
      smartPlugLive: 'Akıllı priz canlı toplamı',
      smartPlugSnapshots: 'Akıllı priz anlık kayıtları',
      printLogs: 'Baskı günlükleri',
    },
  ...
  settings: {
    ...
    documents: {
      ...
      status: { draft: 'Draft', scheduled: 'Scheduled', active: 'Active', superseded: 'Superseded', missingDraft: 'Taslak yok' },
    ...
    noticePreferences: 'Bildirimler',
    showDeveloperLanWarning: 'Developer LAN uyarisini goster',
    showDeveloperLanWarningDesc: 'Bagli bir yazicida Developer LAN modu etkin degilse uygulamanin ust kisminda uyari goster.',
    showSponsorPrompts: 'Destekci bildirimlerini goster',
    showSponsorPromptsDesc: 'Destekciler ve PrintOps topluluk finansmani hakkinda ara sira bildirim goster.',
    ...
    progressInTitle: 'Tarayıcı sekmesinde baskı ilerlemesini göster',
    progressInTitleHint: 'Bir yazıcı çalışırken sekme başlığı ve favicon aktif baskı yüzdesini gösterir.',
    // Arşiv
    ...
    cameraUrlBuilderToggle: 'Ana bilgisayar, port ve yoldan URL oluştur',
    cameraUrlBuilderHost: 'Ana bilgisayar veya IP',
    cameraUrlBuilderPort: 'Port',
    cameraUrlBuilderPath: 'Yol (örn. /stream)',
    cameraUrlBuilderUsername: 'Kullanıcı adı (isteğe bağlı)',
    cameraUrlBuilderPassword: 'Parola (isteğe bağlı)',
    cameraUrlBuilderHelp: 'Yukarıdaki kamera URL alanını doldurur. Manuel girilen bir URL ile aynı şekilde doğrulanır ve test edilir.',
  ...
  hmsErrors: {
    ...
    runoutExpectedSlot: 'Filament {{ranOut}} içinde bitti. Baskı şimdi {{expected}} içinde filament bekliyor.',
    runoutExpectedSlotOnly: 'Filament bitti. Baskı şimdi {{expected}} içinde filament bekliyor.',
    runoutSlotUnknown: 'Filament bitti. Hangi AMS slotunun beklendiğini yazıcıdan kontrol edin.',
  ...
  camera: {
    ...
    diagnose: {
      ...
      info: {
        title: 'Canlı yayın ayrıntıları',
        pipeline: 'Boru hattı',
        codec: 'Kodek',
        resolution: 'Çözünürlük',
        fps: 'FPS (hedef / ölçülen)',
        bitrate: 'Bit hızı',
        uptime: 'Yayın çalışma süresi',
        tlsProxy: 'TLS proksi',
        go2rtcStream: 'go2rtc yayını',
        notActive: 'Bu yazıcı için şu anda etkin bir yayın yok.',
        pipelineName: {
          go2rtc: 'go2rtc (RTSP kaynağı, MSE + MJPEG sağlar)',
          go2rtc_chamber_bridge: 'go2rtc (hazne görüntü köprüsü, yalnızca MJPEG)',
          chamber_binary: 'Hazne görüntü protokolü (özel ikili)',
          external_mjpeg: 'Harici kamera (MJPEG, go2rtc üzerinden)',
          external_rtsp: 'Harici kamera (RTSP, go2rtc üzerinden)',
          external_snapshot: 'Harici kamera (HTTP anlık görüntü, go2rtc üzerinden)',
          external_usb: 'Harici kamera (USB/v4l2, doğrudan)',
        },
        player: 'Oynatıcı',
        playerName: {
          mse: 'MSE (H.264, yeniden kodlama yok)',
          mjpeg: 'MJPEG (yedek)',
  ...
  users: {
    ...
    form: {
      ...
      groups: 'Gruplar',
      printerScope: 'Yazıcı erişimi',
      allPrinters: 'Tüm yazıcılar',
      printerScopeCount: '{{count}} yazıcı',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      device: {
        title: 'Orca Cloud\'da PrintOps\'yi onayla',
        instruction: 'Orca Cloud\'u açın ve bu kodu onaylayın. Onayladığınızda PrintOps otomatik olarak bağlanır.',
    ...
    connectedAs: 'Bağlı kullanıcı',
    signInExpired: 'Bambu Cloud oturumunuzun süresi doldu. Bulut ön ayarlarını kullanmak için tekrar giriş yapın.',
    logout: 'Çıkış',
...
useEmbeddedHint: 'Yukarıdaki profiller yerine tasarımcının ayarlarıyla (duvarlar, dolgu, filament) dilimle. Yazıcınız dosyayla eşleştiği için sunulur.',
  ...
  inventory: {
    ...
    bulk: {
      ...
      mergeTargetPrompt: 'Seçili IDler içinden hedef makara IDsi ({{ids}})',
      mergeInvalidTarget: 'Seçili makara IDlerinden birini hedef olarak seçin',
      mergeSuccess: '{{count}} yinelenen makara birleştirildi',
      mergeFailed: 'Birleştirme başarısız',
      invalidHex: '6 hex karakter (RRGGBB) veya 8 (RRGGBBAA) girin. Aksi takdirde alan uygulanmaz.',
    },
    refill: 'Yeniden doldur',
    refillPrompt: '#{{id}} makarası için eklenen dolum ağırlığı gram olarak',
    refillInvalidWeight: '0 g üzerinde bir ağırlık girin',
    refillSuccess: 'Makara dolumu kaydedildi',
    refillFailed: 'Makara dolumu başarısız',
  ...
  haSensors: {
    ...
    blockPrintHint: 'İşler sensör normale dönene kadar kuyrukta kalır. Home Assistant\'a ulaşılamazsa seçilen arıza stratejisi uygulanır.',
    safeState: 'Güvenli durum: {{state}}',
    failureStrategyLabel: 'Home Assistant kullanılamadığında',
    failureAuto: 'Otomatik (kritik sensörler engeller)',
    failureOpen: 'Yazdırmaya izin ver (fail-open)',
    failureClosed: 'Yazdırmayı beklet (fail-closed)',
    failureStrategyHint: 'Kritik güvenlik sensörleri güncel okuma yoksa kuyruğu bekletir.',
    primarySafetyWarning: 'PrintOps interlockları ikincil denetimlerdir. Bağımsız fiziksel korumayı sürdürün.',
    failure: {
      auto: 'Arıza: otomatik',
      fail_open: 'Arıza: yazdırmaya izin ver',
      fail_closed: 'Arıza: yazdırmayı beklet',
    },
    override: {
      unavailable: 'Fail-closed interlock kullanılamıyor: {{sensors}}',
      open: 'Geçici olarak geçersiz kıl',
      reasonLabel: 'Geçici geçersiz kılma nedeni',
      confirm: 'Geçersiz kılmayı onayla',
      clear: 'Interlocku geri yükle',
      active: '{{user}} tarafından geçersiz kılma etkin: {{reason}}',
      unknownUser: 'bilinmeyen kullanıcı',
      error: 'Interlock geçersiz kılması değiştirilemedi.',
    },
    toast: {
  ...
  smartPlugs: {
    ...
    noTarget: 'Hedef yok (yalnızca manuel kontrol)',
    targetPrinter: 'Yazıcı',
    targetDryer: 'Filament kurutucu',
    selectPrinter: 'Yazıcı seç',
    selectDryer: 'Filament kurutucu seç',
    ...
    restEnergyTotalPath: 'Toplam Enerji JSON Yolu',
    restEnergyTotalMultiplier: 'Toplam Enerji Çarpanı',
  ...
  notifications: {
    ...
    providerDescriptions: {
      ...
      bark: 'Bark ile hesapsız iOS push bildirimleri',
    ...
    priority: 'Öncelik',
    pushoverRetry: 'Acil tekrar (sn)',
    pushoverExpire: 'Acil süre sonu (sn)',
    botToken: 'Bot Belirteci',
    chatId: 'Sohbet ID',
    telegramThreadId: 'Forum konu ID',
    telegramThreadIdInvalid: 'Forum konu ID bir sayı olmalı',
    barkDeviceKey: 'Cihaz anahtarı',
    barkGroup: 'Grup',
    barkSound: 'Ses',
    barkLevel: 'Kesinti düzeyi',
    barkLevelDefault: 'Varsayılan',
    barkLevelPassive: 'Pasif',
    barkLevelActive: 'Aktif',
    barkLevelTimeSensitive: 'Zamana duyarlı',
    barkLevelCritical: 'Kritik',
  ...
  bugReport: {
    ...
    manualReportTitle: 'GitHub üzerinden bildir',
    manualReportDescription: 'PrintOps hata raporları için herkese açık GitHub issue formunu kullanır. Böylece her kurulum için relay yapılandırması gerekmez ve gönderilen bilgiler sizin kontrolünüzde kalır.',
    openIssueForm: 'GitHub issue aç',
  ...
  failureDetection: {
    ...
    mlTokenHint: 'Obico ml_api konteynerinizin ML_API_TOKEN ortam değişkeniyle eşleşmelidir. Konteyner token olmadan çalışıyorsa boş bırakın.',
    test: 'Test',
    testSuccess: 'ML API erişilebilir ve sağlıklı.',
    testSuccessTokenUnknown: 'ML API erişilebilir ve sağlıklı. Token denetlenemedi.',
  ...
  forecast: {
    ...
    expandSku: '{{label}} satırını genişlet',
    collapseSku: '{{label}} satırını daralt',
    procurementTitle: 'Tedarik',
    procurementLoadingOffers: 'Tedarik kaynakları yükleniyor …',
    procurementOffersLoadError: 'Tedarik kaynakları yüklenemedi.',
    procurementRetryOffers: 'Tedarik kaynaklarını yeniden dene',
    procurementSuppliersLoadError: 'Tedarikçiler yüklenemedi.',
    procurementRetrySuppliers: 'Tedarikçileri yeniden dene',
    procurementSave: 'Tedarik kaynaklarını kaydet',
    procurementSaved: 'Tedarik kaynakları kaydedildi',
    procurementSaveFailed: 'Tedarik kaynakları kaydedilemedi',
    sku: 'SKU',
    material: 'Malzeme',
    stock: 'Stok',
    dailyRate: 'Oran',
  ...
  suppliers: { navTitle: 'Tedarikçiler', title: 'Tedarikçiler', subtitle: 'Satın alma kişilerini ve satın alma koşullarını yönetin.', createTitle: 'Tedarikçi ekle', editTitle: 'Tedarikçiyi düzenle', searchLabel: 'Tedarikçi ara', searchPlaceholder: 'Şirket, ilgili kişi, e-posta, müşteri numarası …', activeFilter: 'Durum', loading: 'Tedarikçiler yükleniyor …', empty: 'Eşleşen tedarikçi bulunamadı.', noContact: 'İletişim bilgisi yok', leadTime: 'Varsayılan teslim süresi: {{count}} gün', sections: { masterData: 'Ana bilgiler', contactAddress: 'İletişim ve adres', procurement: 'Satın alma', internalNotes: 'Dahili not' }, fields: { name: 'Şirket', customerNumber: 'Müşteri numarası', active: 'Aktif tedarikçi', contactName: 'İlgili kişi', email: 'E-posta', phone: 'Telefon', website: 'Web sitesi', addressLine1: 'Adres satırı 1', addressLine2: 'Adres satırı 2', postalCode: 'Posta kodu', city: 'Şehir', countryCode: 'Ülke kodu', paymentTerms: 'Ödeme koşulları', defaultLeadTime: 'Varsayılan teslim süresi', internalNotes: 'Dahili notlar' }, filters: { active: 'Aktif', inactive: 'Pasif', all: 'Tüm tedarikçiler' }, actions: { create: 'Tedarikçi ekle', save: 'Tedarikçiyi kaydet', edit: '{{name}} tedarikçisini düzenle', delete: 'Tedarikçiyi sil' }, validation: { nameRequired: 'Şirket adı zorunludur.' }, errors: { load: 'Tedarikçiler yüklenemedi.', save: 'Tedarikçi kaydedilemedi.', delete: 'Tedarikçi silinemedi.', noReadPermission: 'Tedarikçileri görüntüleme izniniz yok.' } },
};
