export default {
  ...
  bugReport: {
    ...
    manualFallbackTitle: 'Otomatik bildirim yapılandırılmamış',
    manualFallbackDescription: 'Bu kurulum hata raporlarını doğrudan GitHub’a gönderemiyor. Bunun yerine GitHub issue formunu açıp açıklamanızı oraya yapıştırın.',
