...
export function ConfirmModal({
  ...
  const { dialogRef, onKeyDown } = useModalFocusLifecycle<HTMLDivElement>({
    onClose: onCancel,
    canClose: !isLoading,
  ...
  return (
    ...
    >
      ...
      >
      <Card className={`w-full ${cardClassName ?? ''}`} onClick={(e: React.MouseEvent) => e.stopPropagation()}>
        <CardContent className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p id={descriptionId} className="text-bambu-gray text-sm whitespace-pre-line">{message}</p>
