...
export function TypographyControls(props: LayoutSectionProps<TypographyRules>) {
  ...
  return <div className="grid gap-3 sm:grid-cols-2">
    ...
    <NumberField field="table_size_pt" label={t('settings.documentLayout.typography.tableSize', 'Table font size')} unit="pt" min={6} max={14} step={0.5} props={props} />
    <NumberField field="metadata_size_pt" label={t('settings.documentLayout.typography.metadataSize', 'Metadata font size')} unit="pt" min={6} max={14} step={0.5} props={props} />
    <NumberField field="heading_scale" label={t('settings.documentLayout.typography.headingScale', 'Heading scale')} min={1} max={3} step={0.1} props={props} />
    ...
    <NumberField field="paragraph_spacing_mm" label={t('settings.documentLayout.typography.paragraphSpacing', 'Paragraph spacing')} unit="mm" min={0} max={20} step={0.5} props={props} />
