...
export function HeaderControls(props: LayoutSectionProps<HeaderRules>) {
  ...
  return <div className="grid gap-3">
    ...
    <div className="grid gap-3 sm:grid-cols-2">
      <NumberField field="logo_width_mm" label={t('settings.documentLayout.header.logoWidth', 'Logo width')} unit="mm" min={5} max={80} props={props} />
    ...
    <div className="grid gap-3 sm:grid-cols-2">
      ...
      <NumberField field="recipient_top_mm" label={t('settings.documentLayout.header.recipientTop', 'Recipient top')} unit="mm" min={20} max={100} props={props} />
    </div>
  </div>;
}
