...
export function PageControls(props: LayoutSectionProps<PageRules>) {
  ...
  return <div className="grid gap-3">
    ...
    <div className="grid gap-3 sm:grid-cols-2">
      ...
      <NumberField field="margin_top_mm" label={t('settings.documentLayout.page.marginTop', 'Top margin')} unit="mm" min={5} max={60} props={props} />
      <NumberField field="margin_right_mm" label={t('settings.documentLayout.page.marginRight', 'Right margin')} unit="mm" min={5} max={60} props={props} />
      <NumberField field="margin_bottom_mm" label={t('settings.documentLayout.page.marginBottom', 'Bottom margin')} unit="mm" min={5} max={60} props={props} />
      <NumberField field="margin_left_mm" label={t('settings.documentLayout.page.marginLeft', 'Left margin')} unit="mm" min={5} max={60} props={props} />
      <NumberField field="first_page_content_top_mm" label={t('settings.documentLayout.page.firstPageTop', 'First page content top')} unit="mm" min={5} max={120} props={props} />
      <NumberField field="following_page_content_top_mm" label={t('settings.documentLayout.page.followingPageTop', 'Following page content top')} unit="mm" min={5} max={120} props={props} />
    </div>
