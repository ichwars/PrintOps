  ...
  return (
    <section className="rounded-xl border border-bambu-dark-tertiary bg-bambu-dark-secondary p-4" aria-labelledby="document-einvoice-policy-heading">
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <NumberField label={t('settings.documents.einvoice.bankAccount', 'Bank account ID')} value={policy.bank_account_id ?? ''} disabled={disabled} onValueChange={(value) => onChange('einvoice.bank_account_id', value ? Number(value) : null)} />
      </div>
