"""MQTT Relay Service for publishing PrintOps events to external MQTT brokers.
...
class MQTTRelayService:
    """Publishes PrintOps events to an external MQTT broker."""
    ...
    async def configure(self, settings: dict) -> bool:
        ...
        self.topic_prefix = settings.get("mqtt_topic_prefix", "printops")
    ...
    def _publish_status(self, status: str):
        """Publish PrintOps status (online/offline)."""
        self._publish(
