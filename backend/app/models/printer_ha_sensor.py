...
class PrinterHASensor(Base):
    ...
    # Behaviour when HA cannot provide a fresh reading. "auto" fails closed
    # for physical safety classes and open for ordinary readiness sensors.
    failure_strategy: Mapped[str] = mapped_column(String(16), default="auto", server_default="auto")
